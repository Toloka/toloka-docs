...
- Find out how changes in the [instructions](/docs-new/guide/instruction), [interface](/docs-new/template-builder/quickstart#interface), [filters](/docs-new/glossary#filters), or in the [quality control rules](/docs-new/glossary#quality-control-rule) affect the Tolokers responses.

- Launch the [pools](/docs-new/glossary#pool) or the [projects](/docs-new/glossary#project) with different settings for independent groups of Tolokers.
...
- Each Toloker has an `id` number ranging from 1 to 100 (100 independent groups of Tolokers). Parameter is set to a Toloker like a [skill](/docs-new/glossary#skill) and Tolokers will always be placed into the the same group.
