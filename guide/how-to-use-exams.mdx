...
date: "2023-02-15T15:15:16.091246"
author: ["Toloka Team"]
...
An exam is a [pool](/docs-new/glossary#pool) that contains only [control tasks](/docs-new/glossary#control-task). A combination of [training tasks](/docs-new/glossary#training), an exam, and the main pool ensures the required level of quality. Assign [skills](/docs-new/glossary#skill) to Tolokers based on the exam results.
...
Use the exam if your tasks are difficult and you want to check how Tolokers cope with them after completing the [training](/docs-new/glossary#training-pool).
...
1. Link the training to the exam pool. In the **Quality control** section, specify the name of the training and the level required. This way, you only let Tolokers take the exam if they passed the training pool.
   ...
   <Image withBackground imageId="1675426772852" alt="" />
...
1. To assign a skill based on the percentage of accepted responses, go to the **Quality control** section and add a [Control tasks](/docs-new/guide/goldenset) rule.

    <Cut title="Example">

    <Image withBackground imageId="1675426767530" alt="" />
...
<Image withBackground imageId="1675426761587" alt="" />
...
<Image withBackground imageId="1675426759334" alt="" />
...
<Image withBackground imageId="1675426776435" alt="" />

## Retry {#rehab}

If the Toloker doesn't cope with the general tasks after passing the exam, they're banned. However, you can create a [retry pool](/docs-new/glossary#retry-pool) for them. When a Toloker becomes good at retry tasks, you can give them access to the general tasks.
...
<Image withBackground imageId="1675426774183" alt="" />
...
<Image withBackground imageId="1675426779659" alt="" />
