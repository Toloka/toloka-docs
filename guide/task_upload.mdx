...
To upload [file with tasks](/docs-new/glossary#tsv) to a [pool](/docs-new/guide/pool-main):
...
1. Choose a way to put tasks into suites and specify the number of tasks per suite. For more information, see [Ways to group tasks in suites](/docs-new/guide/distribute-tasks-by-pages).
...
**Overview**|**How to fix**
----- | -----
**Extra tabs.**<br/><br/>If the uploaded file contains more `\t` column separators after the data or the link than the number of columns set in the [input data](/docs-new/glossary#input-output-data), you get an error message.<br/><br/>For example, if 1 column is set in the input data, and two more `\t\t` tabs are added in the file after the link, you get 3 columns, 2 of which are excessive. | Remove extra column separators in the above example — both `\t\t` characters.
...
**Overview**|**How to fix**
----- | -----
**Unpaired quotation mark in a string.** | Check that all quotation marks are [escaped](/docs-new/guide/pool_csv#string).

</Cut>

## What's next {#what_next}

- Learn more about [ways to group tasks in suites](/docs-new/guide/distribute-tasks-by-pages).

- Check the project settings and tasks with the help of [special labeling mode](/docs-new/guide/self-labeling) before you send them to real Tolokers.

- If you haven't labeled your [control](/docs-new/glossary#control-task) and [training](/docs-new/glossary#training-task) tasks in the file, [edit the tasks in the interface](/docs-new/guide/task_markup).

## See also {#see-also}

- [Where to store files](/docs-new/guide/cloud-storage)
- [Amazon S3](/docs-new/guide/amazon-cloud-storage)
- [Azure Blob Storage](/docs-new/guide/azure-cloud-storage)
- [Google Cloud Storage](/docs-new/guide/google-cloud-storage)
- [Yandex Object Storage](/docs-new/guide/use-object-storage)

## For developers {#for-developers}

- [Toloka API: Tasks](/docs-new/api/tasks)
- [Toloka-Kit recipe: Upload tasks](/docs-new/toloka-kit/recipes/upload-tasks)
