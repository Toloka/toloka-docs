...
Gets the GPS coordinates of the Toloker, if they are available. In the [TaskSuite](/docs-new/guide/tasksuite) and [Task](/docs-new/guide/task) classes, it is available via `this.geolocation`.
...
Storing data on the client. In the [TaskSuite](/docs-new/guide/tasksuite) and [Task](/docs-new/guide/task) classes, it is available via `this.storage`.
...
[Task interface](/docs-new/glossary#task-interface). In the [TaskSuite](/docs-new/guide/tasksuite) and [Task](/docs-new/guide/task) classes, it is available via `this.taskInterface`.

Methods:

### showInstructionPopup() {#showinstructionpopup}

Opens the [instructions](/docs-new/guide/instruction).
...
Lets you subscribe to pressed keys. In the [TaskSuite](/docs-new/guide/tasksuite) and [Task](/docs-new/guide/task) classes, it is available via `this.hotkey`.
...
Gets information about the device on which tasks are performed. In the [TaskSuite](/docs-new/guide/tasksuite) and [Task](/docs-new/guide/task) classes, it is available via `this.clientInfo`.
