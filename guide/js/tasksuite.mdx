...
“Wrapper class” for [task suites](/docs-new/glossary#task-suite) creates instances of task classes. You can redefine this class (for example, if you need to display a shared element on the page with tasks or get more control over tasks, like custom keyboard shortcuts).
...
- `options.task` — Array of [Task](/docs-new/guide/spec-advanced#obj-task) models.

- `options.specs` — Parameters for [input and output data](/docs-new/glossary#input-output-data) and the task interface.
...
- `options.solutions` — Array of responses [Solution](/docs-new/guide/spec-advanced#obj-solution). Can be empty.
...
Returns a link to an [Assignment](/docs-new/guide/assignment) instance. After that, you can use all the properties and methods of that class instance.
...
Returns a complete URL to access the data on the [proxy server](/docs-new/guide/prepare-data). Parameter:

- `path` — the relative path to the file.

## getSolutions() {#getsolutions}

Returns an array of [Solution](/docs-new/guide/spec-advanced#obj-solution) responses.
...
Returns an array of [Task](/docs-new/guide/spec-advanced#obj-task) initialized task models.
...
Returns tasks indexed by their IDs: `<taskId>`: [Task](/docs-new/guide/spec-advanced#obj-task), …
...
- `errors` — Array of errors [SolutionValidationError](/docs-new/guide/spec-advanced#obj-solutionvalidationerror).
...
Creates a DOM representation of the task suite: renders all tasks in the task suite. Calls [render()](/docs-new/guide/task#render) in the Task class for each task. Calls [onRender()](#onrender). Returns `this`.

## validate(solutions) {#validate}

Validates responses according to output data parameters. Returns a `promise` object with an array of [SolutionValidationError](/docs-new/guide/spec-advanced#obj-solutionvalidationerror) errors if the responses are incorrect, or `null`. Parameter:
