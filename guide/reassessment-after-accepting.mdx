...
date: "2023-02-15T15:15:27.453005"
author: ["Toloka Team"]
...
You can enable the [manual review](/docs-new/guide/offline-accept) option to [reject or accept](/docs-new/guide/accept) assignments that Tolokers completed. Assignments are rejected and accepted on a page-by-page basis.
...
- Resend rejected assignments for re-completion to other Tolokers.
    ...
    If you rejected an assignment, you may want it to be completed by another Toloker instead of the one whose response you rejected. To do this, you can increase the [overlap](/docs-new/glossary#overlap) for this assignment only. This is especially helpful if you have the overlap value set to 1.
