...
People who are granted full access won't be able to use the Toloka API, connect to Yandex.Disk, top up the balance, or move tasks from the [sandbox](/docs-new/glossary#sandbox) to the main version of Toloka.
