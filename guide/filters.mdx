...
To select Tolokers for the [pool](/docs-new/glossary#pool), click **Add filter** at the **Select the audience for your task** step of creating a pool or on the pool editing page.
...
To learn more, see [Using A/B experiments](/docs-new/guide/ab-experiment).
...
Make sure to add the **Languages** filter and specify the language of the [instructions](/docs-new/glossary#instructions) and text in the task.
...
You can select Tolokers with or without a [skill](/docs-new/glossary#skill) and filter them by skill value.

You can use [global skills](/docs-new/guide/nav-cross-project) as a filter to recruit Tolokers who are good at certain types of tasks. Do that by selecting **Add filter → Skills → Choose global skill**, and then set a skill limit in the filter.
...
- Learn more about how to set up a pool:
    ...
    - [Selective majority vote check](/docs-new/guide/selective-mvote).
    - [Speed/quality balance](/docs-new/guide/adjust).
    - [Setting up quality control](/docs-new/guide/qa-pool-settings).
    - [Manual review](/docs-new/guide/offline-accept).

## See also {#see-also}

- [Efficiency indicators: Project availability](/docs-new/guide/efficiency-metrics/available-performers)

## For developers {#for-developers}

- [Toloka API: Filtering by profile data](/docs-new/api/filter-profile)
- [Toloka API: Filtering by computed data](/docs-new/api/filter-computed)
- [Toloka API: Filtering by skills](/docs-new/api/filter-skill)
- [Toloka-Kit recipe: Filter Tolokers](/docs-new/toloka-kit/recipes/filter-tolokers)
