...
date: "2023-02-15T15:15:16.831744"
author: ["Toloka Team"]
...
You can turn a general task into a [control task](/docs-new/glossary#control-task) by adding the correct answer, or into a [training task](/docs-new/glossary#training-task) by adding the correct answer and a hint.
...
1. Select the responses that should be checked. (The list of the [output data fields](/docs-new/guide/incoming) is on the right.)
...
<Image withBackground imageId="1675426690739" alt="" />
...
If you set the overlap to 0 [via the API](/docs-new/api/set-min-task-overlap), the task won't be visible to Tolokers, and you won't have to delete it.
