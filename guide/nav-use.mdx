...
When setting up a pool, you can use skills in [filters](/docs-new/guide/filters) to:
...
For [global skills](/docs-new/guide/nav-cross-project), the restrictions of the `skill >80`type are used to select “Tolokers who completed similar projects 80% better on average than other Tolokers”.

## Extra rewards {#awarding}

To select Tolokers by skill and give them [rewards](/docs-new/glossary#reward):

1. Go to the [Tolokers](https://platform.toloka.ai/requester/workers) page.

1. Select Tolokers using the skill filter. To do this, use [filters](/docs-new/glossary#filters):
...
To select Tolokers for [sending messages](/docs-new/guide/qa-assign) about changes in the project or new tasks:
