...
You can publish any tasks that require analyzing or creating content (see [Tips for designing tasks](/docs-new/guide/faq)). Toloka **isn't intended** for tasks that could harm Tolokers. Your account might be blocked if tasks:
...
- [Register in Toloka as a requester](/docs-new/guide/access)
