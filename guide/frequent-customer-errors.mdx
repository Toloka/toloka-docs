...
Using crowdsourcing can be challenging. It's difficult to get it right when launching [your first project](/docs-new/guide/first-project). In this section, you will learn what mistakes requesters make most often and how to avoid or fix them.

Depending on the stage of using Toloka, requester mistakes can be related to: [project architecture](/docs-new/guide/solution-architecture), [task interface](/docs-new/glossary#task-interface), uploading [tasks](/docs-new/glossary#task), or setting up [quality control](/docs-new/glossary#quality-control).

## Project architecture {#mistakes-architecture}

- No [decomposition](/docs-new/glossary#decomposition): the requester creates a large task without dividing it into projects and expects Tolokers to infer final conclusions.

- The project [instructions](/docs-new/glossary#instructions) are long and complicated.

- High entry threshold: at the beginning of the project, there is complex [training](/docs-new/glossary#training-pool) and strict selection of Tolokers.
...
- Horizontal decomposition: use [manual review](/docs-new/glossary#assignment-review) with verification by other Tolokers.
...
- For greater efficiency, combine both methods.
  ...
  [Learn more](/docs-new/guide/solution-architecture) about decomposition.
...
[Learn more](/docs-new/guide/instruction) about how to write clear instructions.
...
You can create a task interface in the [Template Builder](/docs-new/template-builder/) or in the [HTML/JS/CSS editor](/docs-new/guide/spec).
...
- The Toloker's actions are not checked: Tolokers can submit incorrectly filled or empty [output data fields](/docs-new/guide/incoming) for verification or they can submit a response with no video or audio in media content tasks.

<Cut title="Solutions">

Check the tasks before launching your project:

- Create tasks in the [Sandbox](/docs-new/glossary#sandbox) and try to do them yourself.
...
- Add [keyboard shortcuts](/docs-new/guide/t-components/image-annotation#hotkeys). For example, you can assign them for playing or pausing a video.

- If you launch tasks that need to be performed in mobile apps, adapt the interface to them.

    [Learn more](/docs-new/guide/mobile) about adapting tasks for mobile devices.

Configure checking the Toloker's actions and data format:

- To do this, use [validation](/docs-new/guide/incoming#manual-setting). For example, make sure that the Toloker started playing media content or played it to the end.
...
- Minimize user interaction with external resources.
    ...
    There are [restrictions](/docs-new/guide/unwanted) on tasks that link to external websites.
...
Common mistakes related to [uploading tasks](/docs-new/guide/task_upload):
...
- Incorrect distribution of [control tasks](/docs-new/glossary#control-task).

<Cut title="Solutions">

- Use the correct [file](/docs-new/glossary#tsv) format and UTF8 encoding.
...
- Use [smart mixing](/docs-new/glossary#smart-mixing). The algorithm will distribute training, control tasks, and general tasks across the page on its own.
...
- There are no Toloker [filters](/docs-new/glossary#filters) and tasks are available even to Tolokers who can't complete them.

- [Quality control rules](/docs-new/glossary#quality-control-rule) are not used, or they are configured incorrectly.
...
[Learn more](/docs-new/guide/filters) about filters.

Set the quality control rules:

- Consider what type of acceptance you'll use:

    For tasks with auto acceptance, the best quality control rules are [control tasks](/docs-new/guide/goldenset), [majority vote](/docs-new/guide/mvote), [fast responses](/docs-new/guide/quick-answers), and [recompletion of assignments from banned Tolokers](/docs-new/guide/restore-task-overlap).

    For tasks with [manual review](/docs-new/guide/offline-accept), the best methods are fast responses and review results.

    [Learn more](/docs-new/guide/control) about quality control rules.

- Choose and combine the rules depending on the content of your project. See examples of how to choose quality control rules in the [tutorials for popular tasks](/docs-new/tutorials/usecases).

- Specify the reason for [banning Tolokers](/docs-new/glossary#banning-tolokers) (it is only visible to you) and the reason for rejecting tasks (the Tolokers will see it).
...
- Check whether the rule works as you intended. To do this, run a small pool with sample data or practice in the [Sandbox](/docs-new/glossary#sandbox).

- See examples of settings on the pages from the [list](/docs-new/guide/control) of quality control rules.
...
Reason: the project has a pool that can only be accessed through [training](/docs-new/guide/train), but the training itself is closed.
...
- When labeling has stopped for the project and you are no longer selecting Tolokers for the [exam pool](/docs-new/glossary#exam), just close it.
...
- Tasks don't match the [requirements](/docs-new/guide/unwanted), and Tolokers refuse to complete them.
