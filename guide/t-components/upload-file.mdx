...
The task interface configuration guide describes the features of the HTML/JS/CSS editor. You can also try creating a button for uploading files in [Template Builder](/docs-new/template-builder/reference/field.media-file).
...
In the [output data](/docs-new/glossary#input-output-data) description, add one of the fields:
