...
The task interface configuration guide describes the features of the HTML/JS/CSS editor. You can also try creating a text input field in [Template Builder](/docs-new/template-builder/reference/field.textarea).
