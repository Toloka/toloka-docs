...
The task interface configuration guide describes the features of the HTML/JS/CSS editor. You can also try creating a button for recording and uploading a video file in [Template Builder](/docs-new/template-builder/reference/field.media-file).
...
In the [output data](/docs-new/guide/incoming) description, add one of the fields:
...
Run tasks with a video recording button on mobile devices, since they have a built-in camera. Set the **Client = Mobile Toloka** [filter](/docs-new/guide/filters) in the [pool](/docs-new/glossary#pool).
