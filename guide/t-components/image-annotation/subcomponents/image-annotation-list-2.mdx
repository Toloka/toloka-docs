...
1. Add the following in the [input data](/docs-new/guide/incoming):
...
1. [Escape](/docs-new/guide/pool_csv#json) JSON with point coordinates and add it to the [file with tasks](/docs-new/glossary#tsv).
