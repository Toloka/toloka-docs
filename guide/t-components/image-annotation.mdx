...
This section describes how to add an area selection editor to an image using the HTML/JS/CSS tools. You can also try creating an [area selection](/docs-new/template-builder/operations/select-areas) editor in Template Builder.
...
Don't add [training or control tasks](/docs-new/guide/pool) to a [project](/docs-new/glossary#project) that features an image area selection editor.
...
Tell Tolokers about keyboard shortcuts in the [instructions](/docs-new/glossary#instructions) to speed up task completion.

## Selection tools {#selection_tools}

By default, the polygon tool is added to the [task interface](/docs-new/glossary#task-interface).
