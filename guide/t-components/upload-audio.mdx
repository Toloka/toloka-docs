...
The task interface configuration guide describes the features of the HTML/JS/CSS editor. You can also try creating a button for recording and uploading audio files in [Template Builder](/docs-new/template-builder/reference/field.audio).
...
Add a field with the `file` type in the [output data description](/docs-new/guide/incoming). Example:
...
Create tasks for mobile devices if you want to use the button for recording and uploading audio files, because these devices have a built-in voice recorder. Set the **Client = Mobile Toloka** [filter](/docs-new/guide/filters) in the [pool](/docs-new/glossary#pool).
