...
The task interface configuration guide describes the features of the HTML/JS/CSS editor. You can also try creating a text segmentation editor in [Template Builder](/docs-new/template-builder/reference/field.text-annotation).
...
Think about [decomposing the task](/docs-new/guide/solution-architecture). The more tags, the more complex the instruction and the response review process.
...
When you [mark up](/docs-new/guide/task_markup) control and training tasks in the Toloka interface, select all the output data fields. Otherwise, the words marked with tags won't be displayed in it.
