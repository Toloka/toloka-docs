...
<img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675425182261/1675425182261_original_svg.svg" alt="Toloka workflow" />
...
<img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675425181143/1675425181143_original_svg.svg" alt="Toloka three main entities" />
...
To learn about projects and settings, see [Project](/docs-new/guide/project).
...
To learn about pools and their settings, see [Pool](/docs-new/guide/pool-main).
...
To learn about tasks, supported task files, and their structure, see [Task](/docs-new/guide/pool_csv).
...
To learn about task suites and how to use them, see [Task suite](/docs-new/guide/distribute-tasks-by-pages).
...
To learn more, see [How Tolokers see pools](/docs-new/guide/pool-main).

## Toloka API and SDK {#api}

If you need to post similar tasks on a regular basis, you can automate working with Toloka by using the [Toloka API](/docs-new/api/) and [Python SDK](/docs-new/toloka-kit/python-sdk).
...
- [What tasks can't be placed in Toloka?](/docs-new/guide/unwanted)
- [Common mistakes made by requesters](/docs-new/guide/frequent-customer-errors)
- [Where to store media files](/docs-new/guide/cloud-storage)
