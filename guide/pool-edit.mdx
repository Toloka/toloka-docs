...
You can choose how often [captchas](/docs/glossary#captcha) are shown to Tolokers:
...
To show the captcha to Tolokers, set [the quality control rule](/docs/guide/captcha).
