...
After you [uploaded the files](/docs-new/guide/task_upload) with the tasks to the pool, complete the tasks as a Toloker. This way you can find if the project contains any errors, or might be too difficult or ambiguous for the Tolokers to complete.
...
<Image withBackground imageId="1675425607481" alt="Check the project before you start labeling" />
...
- If you haven't labeled your control and training tasks in the file, [edit the tasks in the interface](/docs-new/guide/task_markup).
- [Top up](/docs-new/guide/refill) your account.
- Launch the [pool labeling](/docs-new/guide/pool-run-and-stop).
