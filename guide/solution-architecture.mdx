...
Before you start creating a [project](/docs-new/glossary#project), consider dividing it into several smaller projects. This is called _decomposition_.

For example, in the [Business information (example with decomposition)](/docs-new/tutorials/data-collection) section, the task can be divided into four projects:

- [Project 1. Does the photo contain a particular item?](/docs-new/tutorials/contain_item) — This is data preparation (filtering).

- [Project 2. Find a similar item in the online store](/docs-new/tutorials/find_an_item_in_store) — This is the original task.

- [Project 3. Does the item found look similar to the original?](/docs-new/tutorials/item_look_similar) — Checking the responses.

- [Project 4. Which of the found items is most similar to the original?](/docs-new/tutorials/item_more_similar) — Choosing the best response.
...
- The result from one project can be the [input](/docs-new/glossary#input-output-data) for another project.

- You can assign a skill to Tolokers in one project and filter Tolokers by this [skill](/docs-new/glossary#skill) in another project.
...
- It is easier to set up shortcuts in the [task interface](/docs-new/glossary#task-interface), which also speeds up the work of Tolokers.

- Task [instructions](/docs-new/glossary#instructions) will be shorter, clearer, and more Toloker-friendly.
...
- You can set up a separate project where other Tolokers check responses in submitted assignments. For example, if you want to create a project titled “Find similar products”, enable [manual review](/docs-new/glossary#assignment-review) in this project and create a separate project with the “Are these items similar?” task to review responses, reject incorrect responses, and avoid paying for them.

    <Note mode="restriction" title="Alert">

    In the assignments review, specify the [review period](/docs-new/glossary#review-period) after which the tasks are accepted automatically. You need to make sure that this timeframe allows enough time to complete the project for checking responses and then reject tasks in the general task project.
...
- [Business information (example with decomposition)](/docs-new/tutorials/data-collection)
- [Object recognition and area selection (example with decomposition)](/docs-new/tutorials/image-segmentation-overview)

## What's next {#what_next}

- [Create a new project](/docs-new/guide/project) to post your task.
