...
date: "2023-02-15T15:15:26.797027"
author: ["Toloka Team"]
...
Use [decomposition](/docs-new/guide/solution-architecture). Simpler tasks cost less. If a task is complex, you won't get good results immediately. Instead, you'll have to resend tasks to the pool so that other Tolokers can redo them.

## Use dynamic overlap {#din-price}

[Dynamic overlap](/docs-new/guide/dynamic-overlap) (incremental relabeling, IRL) lets you change overlap depending on:
...
[Manual review](/docs-new/guide/offline-accept) allows you to check responses so you don't have to pay for poorly completed tasks.
...
You can set up a [random majority vote check](/docs-new/guide/selective-mvote) for the general tasks. This helps you save money and speed up pool completion. You can set the period during which tasks with increased overlap will be displayed to the Toloker, depending on the number of completed tasks.
...
[Dynamic pricing](/docs-new/guide/dynamic-pricing) lets you increase the price per task suite for Tolokers with a higher skill level. This way you can encourage Tolokers to do a better job.
...
Use the [Smart mixing](/docs-new/guide/distribute-tasks-by-pages#smart-mixing) and **Assign partial page** options. This way you can save money on paying for incomplete task suites.
...
<Image withBackground imageId="1675426535487" alt="" />
...
[Learn more](/docs-new/api/create-pool)
...
[Learn more](/docs-new/api/create-task)
...
- [Template Builder: Configure keyboard shortcuts](/docs-new/template-builder/best-practices/hotkeys)
