...
date: "2023-02-15T15:15:26.679604"
author: ["Toloka Team"]
...
You started a pool with [manual review](/docs-new/guide/offline-accept), and the Tolokers completed all your tasks. What next?
...
Note that you can't change the task status if the task pool was [archived](/docs-new/guide/pool-archive).
...
Within 7 days after the review, the Toloker can challenge the result by [filing an appeal](https://toloka.ai/tolokers/docs/web/priemka.html?lang=en#priemka__appeal).
...
- [Processing rejected and accepted assignments](/docs-new/guide/reassessment-after-accepting)
- [Results of assignment review](/docs-new/guide/reviewing-assignments)
- [Rejected tasks](/docs-new/guide/efficiency-metrics/rejected-tasks)

## For developers {#for-developers}

- [Toloka API: Checking completed tasks](/docs-new/api/accept)
- [Toloka-Kit recipe: Accept responses](/docs-new/toloka-kit/recipes/accept-responses)
- [Toloka-Kit recipe: Reject responses](/docs-new/toloka-kit/recipes/reject-responses)
