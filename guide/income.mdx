...
If you want to have a large number of Tolokers in a project, limit the daily earnings in the [project](/docs-new/glossary#project).

Ban by earnings works for the [pool](/docs-new/glossary#pool). If you set up a blocking rule for the project, the earnings are calculated separately for each pool.
...
- Get responses from as many Tolokers as possible. For this purpose, you might want to set the maximum amount of earnings equal to the price for a single [task suite](/docs-new/glossary#task-suite).
...
- [Toloka API: Compensation amount](/docs-new/api/earn_limit)
- [Toloka-Kit: Income collector class](/docs-new/toloka-kit/reference/toloka.client.collectors.Income)
