...
All changes made to the [project](/docs-new/glossary#project) are saved in the version history. You can view previous versions or return to any of them.

The version number (for example, **1.2**) consists of two numbers:

1. The major version (the first number) appears when you change a [required field](/docs-new/guide/incoming#required) in the input or output data:
...
Changes to the major version of the project don't affect existing [pools](/docs-new/glossary#pool).
