...
If you specified 2 tasks per page when uploading the [TSV file](/docs-new/glossary#tsv) with image links to the pool, the system can generate them as follows:
