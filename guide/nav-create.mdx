...
To better motivate Tolokers, make the skill public and set [dynamic pricing](/docs-new/glossary#dynamic-pricing) based on this skill. In the task instructions, write what affects the skill value. Tolokers will know how the skill affects the price, and try to perform the tasks well.

</Note>

## What's next {#what-next}

[Assign a skill](/docs-new/guide/nav-assign) either manually or automatically.
...
- [Toloka API: Creating skill](/docs-new/api/create-skill)
- [Toloka-Kit recipe: Create skill](/docs-new/toloka-kit/recipes/create-skill)
