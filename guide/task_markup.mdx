...
Task markup is available only for [training pools](/docs-new/guide/train) and pools uploaded with [“smart mixing”](/docs-new/guide/distribute-tasks-by-pages#smart-mixing).

</Note>

Using markup, you can add correct responses and hints to tasks, as well as change task types. You can turn a general task into a [control task](/docs-new/glossary#control-task) by adding the correct answer, or into a [training task](/docs-new/glossary#training-task) by adding the correct answer and a hint.
...
- [Manual markup](/docs-new/guide/task-markup-by-yourself), which allows you to create both control tasks and training tasks.
...
- Markup is only available for [control tasks](/docs-new/glossary#control-task).
...
- For other types of projects, you can request this feature by contacting [support](/docs-new/guide/troubleshooting/support).
...
- [Efficiency indicators: Control tasks](/docs-new/guide/efficiency-metrics/control-tasks-share)
- [Efficiency indicators: Control task balance](/docs-new/guide/efficiency-metrics/control-tasks-balance)
