The total number of completed [task suites](/docs-new/glossary#task-suite) (taking [overlap](/docs-new/glossary#overlap) into account).

There may be few completed tasks if your tasks are only available to a small number of Tolokers. This could be due to incorrectly configured [filters](/docs-new/guide/filters) or [skills](/docs-new/guide/nav). In this case, some Tolokers don't see your tasks.
