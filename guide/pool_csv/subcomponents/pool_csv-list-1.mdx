...
- `HINT:text` — hints for [training tasks](/docs-new/glossary#training-task). The Toloker will see the hint text at the top of the task (on a red background) if their response to the control task is different from the correct one.

- Point coordinates for [field tasks](/docs-new/tutorials/walk):
...
See examples for the different tasks types and different [data types](/docs-new/guide/incoming#data-types).
...
To create a [general task](/docs-new/glossary#general-task), fill in the columns with the `INPUT` header.

<Cut title="Example with a simple object ([string](/docs-new/guide/incoming#string), [link](/docs-new/guide/incoming#url), and so on)">
...
You can also add responses when creating a pool in [task markup mode](/docs-new/guide/task_markup) (you need to use [“smart mixing”](/docs-new/guide/distribute-tasks-by-pages#smart-mixing) when uploading tasks).
...
For training tasks, it is convenient to create a [separate pool](/docs-new/guide/train).

<Note mode="note" title="Note">

You can also add responses and hints when creating a pool in [task markup mode](/docs-new/guide/task_markup) (you need to use ["smart mixing"](/docs-new/guide/distribute-tasks-by-pages#smart-mixing) when uploading tasks).
...
The <Term term="array"><TolokaRequesterSourceArray/></Term> of the [JSON](/docs-new/glossary#json-format) objects is similar to the <Term term="string"><TolokaRequesterSourceString/></Term>.
...
The <Term term="array"><TolokaRequesterSourceArray/></Term> of the [JSON](/docs-new/glossary#json-format) objects is similar to the string.
...
The columns with [required input data fields](/docs-new/guide/incoming) must be filled. The other columns can be deleted if they are empty.
