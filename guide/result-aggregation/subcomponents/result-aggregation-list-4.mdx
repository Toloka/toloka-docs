...
1. You set a skill that defines the level of confidence in the Toloker's responses. We recommend to use a skill calculated as the percentage of [correct responses in control tasks](/docs-new/guide/goldenset).

1. The [output data fields](/docs-new/guide/incoming) have allowed values.
...
1. The tasks were uploaded in the pool with [“smart mixing”](/docs-new/guide/distribute-tasks-by-pages#smart-mixing).
