...
This may signify a number of issues. Please contact our [support service](/docs-new/tolokers/web/troubleshooting/support#contact) so that we can look into the matter in more detail.

</Cut>

<Cut title="I didn't receive the payment for the task. Why?">

Task reward should be received in 24 hours. If you face any difficulties with rewards please contact our [support service](/docs-new/tolokers/web/troubleshooting/support#contact).
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs-new/tolokers/web/troubleshooting/support#contact">Contact support</Button>