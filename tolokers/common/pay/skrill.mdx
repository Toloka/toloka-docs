---
title: "Skrill | Tolokers documentation"
date: "2023-02-15T11:48:10.975058"
author: ["Toloka Team"]
...
<Cut title="Only certain countries"><br/><br/>You can check whether Skrill operates in your country on the [website](https://www.skrill.com/en/footer/terms-conditions/non-serviced-countries/).<br/><br/></Cut>
|
<Cut title="From 4.99 to 8.5%"><br/><br/>Fees:
- From Toloka — 1% of the amount.
- To Mastercard — 4.99%. To Visa — 7.5%.
- To a bank account — EUR 5.5.
- When converting to another currency — 3.99%.<br/><br/>Learn more on the [Skrill website](https://www.skrill.com/en/siteinformation/fees/).<br/><br/></Cut>
|
<Cut title="From $1 to $5"><br/><br/>$1 for one withdrawal per week or less. Subsequent withdrawals within a week — $5.<br/><br/></Cut>
|
...
- To a bank account: 5.5 euro per transaction.<br/><br/>Learn more on the [Skrill website](https://www.skrill.com/en/siteinformation/fees/).
...
1. According to the [Skrill account terms of use](https://www.skrill.com/en/footer/terms-conditions/skrillaccounttermsofuse/), you must be at least 18 years old to register.
1. When asked how you intend to use your Skrill account, select "for private purposes".

</Note>

1. On the main page of the [Skrill](https://www.skrill.com/en/) official website, click  in the upper-right corner.
...
1. In the **Deposit** section, select your preferred deposit method and click **Deposit now**.
    ...
    - An SMS with a PIN code will be sent to the phone number you specified. To confirm, send a reply SMS with the text "Y" within the next 24 hours.
    - After the transaction is completed, you'll see a message in your Skrill account.
...
1. In the **Verify your Account** section, click <Image withBackground imageId="1676448921110" alt="" />.
...
1. Confirm your address. There are two ways to do this:
    ...
    - Upload the document confirming your address, select the document type, and click **Continue**. You can find the document requirements [here](https://www.skrill.com/en/support#/path/ACCOUNT/Verifications/1416726312/What-address-verification-documents-do-you-accept.htm).
...
1. Download the **Skrill** mobile app in [Google Play](https://play.google.com/store/apps/details?id=com.moneybookers.skrillpayments&hl=en) or [Apple App Store](https://apps.apple.com/us/app/skrill/id718248239).
...
<Cut title="How to withdraw money to a bank account">
...
<Cut title="How to withdraw money to a credit or debit card">
