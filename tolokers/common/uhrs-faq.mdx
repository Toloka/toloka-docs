...
date: "2023-02-15T11:47:54.585092"
author: ["Toloka Team"]
...
<Cut title="How are tasks from UHRS structured? Will there be any problems in Toloka due to the fact that I am switching to another platform?">
...
<Cut title="Why don't I see any tasks on UHRS?">
...
This may signify a number of issues. Please contact our [support service](/docs-new/tolokers/troubleshooting/support#contact) so that we can look into the matter in more detail.

</Cut>

<Cut title="I didn't receive the payment for the task. Why?">

Task reward should be received in 24 hours. If you face any difficulties with rewards please contact our [support service](/docs-new/tolokers/troubleshooting/support#contact).

</Cut>

<Cut title="My tasks are different in cost from my friend's tasks.">
...
<Image withBackground imageId="1676448831879" alt="" />

</Cut>

<Cut title="How can I see the amount earned while completing the task?">
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs-new/tolokers/troubleshooting/support#contact">Contact support</Button>