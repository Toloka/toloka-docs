...
1. <TutorialsAddNameDescription/>
    ...
    <Image withBackground imageId="1675425705530" alt="Create a project. Step 1" />
...
1. In the **Task interface** section, set up what your tasks will look like.
    ...
    1. Copy the code of the [example](https://ya.cc/t/Fz_--ktr3ttAX9) and paste it to the **Config** section of your project. This code has validation and task layout pre-configured.
        ...
        <Image withBackground imageId="1675425721249" alt="Create a project. Config section" />
    ...
    1. You can edit the code. For example, to configure the text above the **Take photo** section, replace the sample text with your value in the `label` property.
        ...
        <Image withBackground imageId="1675425733522" alt="Create a project. Config text" />
...
1. <TolokaRequesterSourceAudienceSettings/>
    ...
    1. <TolokaRequesterSourceFilters/>
        ...
        <Image withBackground imageId="1675425714909" alt="Create a pool. Languages filter" />
...
1. <TutorialsQualityControl/>
    ...
    1. Click **Add a quality control rule → Results of assignment review**, and enter the following values:
        ...
        <Image withBackground imageId="1675425736966" alt="Create a pool. Results of assignment review rule" />
    ...
    1. Add the **Processing rejected and accepted assignments** rule. When the overlap value is **1**, you should resend assignments to the pool for other Tolokers to redo them.
        ...
        <Image withBackground imageId="1675425717056" alt="Create a pool. Processing rejected and accepted assignments rule" />
...
1. <TolokaRequesterSourceStartButton/>
    ...
    <Image withBackground imageId="1675425709465" alt="Start labeling" />
...
1. Go to the pool, and click **Review assignments**.
    ...
    <Image withBackground imageId="1675425707615" alt="See the results. Review assignments" />
...
1. After checking all the assignments, click **Download results**.
    ...
    <Image withBackground imageId="1675425718934" alt="See the results. Download results" />
