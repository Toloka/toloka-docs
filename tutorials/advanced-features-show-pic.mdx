...
The easiest way to do this is to use the standard Toloka component described in the [Image](https://toloka.ai/en/docs/guide/concepts/t-components/img) section.
