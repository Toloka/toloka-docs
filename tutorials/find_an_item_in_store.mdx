...
date: "2023-02-14T11:23:03.849318"
author: ["Toloka Team"]
...
In this [project](https://toloka.ai/en/docs/glossary#project), Tolokers will search an online store for shoes that are similar to the ones shown in the task. Use the results from [project 1](/docs-new/tutorials/contain_item#get_results) as source images.
...
1. <TutorialsQualityControl/>
    ...
    <Image withBackground imageId="1675426029309" alt="" />
    ...
    <Image withBackground imageId="1675426066696" alt="" />
    ...
    [Control tasks](https://toloka.ai/en/docs/glossary#control-task) and [majority vote](https://toloka.ai/en/docs/glossary#majority-vote) aren't used in this type of project, because links submitted by Tolokers must match, which is practically impossible. Learn more in [Quality control](https://toloka.ai/en/docs/guide/concepts/control).

1. <TutorialsUploadTasks/>

    1. In the text or spreadsheet editor, open the file that you received after aggregating the results in [project 1](/docs-new/tutorials/contain_item#get_results).
    ...
    1. Upload the resulting [file](https://toloka.ai/en/docs/glossary#tsv).
...
- Create [Project 3](/docs-new/tutorials/item_look_similar) to compare the original image with the results from Project 2.
