...
In this [project](/docs-new/glossary#project), Tolokers will search an online store for shoes that are similar to the ones shown in the task. Use the results from [project 1](/docs-new/tutorials/contain_item#get_results) as source images.
...
1. <TutorialsQualityControl/>
    ...
    [Control tasks](/docs-new/glossary#control-task) and [majority vote](/docs-new/glossary#majority-vote) aren't used in this type of project, because links submitted by Tolokers must match, which is practically impossible. Learn more in [Quality control](/docs-new/guide/control).
...
1. <TutorialsUploadTasks/>
    ...
    1. Upload the resulting [file](/docs-new/glossary#tsv).
