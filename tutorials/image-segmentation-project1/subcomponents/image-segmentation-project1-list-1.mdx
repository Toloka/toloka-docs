1. The task interface describes how the elements should be arranged in the task.
    ...
    - [Setting up conditions](/docs/template-builder/best-practices/conditions).
    - [Image classification](/docs/template-builder/templates/image-classification) template.
