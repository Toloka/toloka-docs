1. You can use it for this project with pre-configured validation and task layout.
    ...
    For more information about the template and its settings, see [Object selection in an image](/docs-new/template-builder/operations/select-areas) in the Template Builder Help.
