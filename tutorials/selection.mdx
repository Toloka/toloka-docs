...
date: "2023-02-14T11:23:04.806412"
author: ["Toloka Team"]
...
1. <TutorialsAddNameDescription/>
    ...
    <Image withBackground imageId="1675425755091" alt="Create a project. Step 1" />
...
1. In the **Task interface** section, set up what your tasks will look like. This preset has a task template with validation, keyboard shortcuts, and task layout pre-configured.
    ...
    1. Using the **Visual editor**, set up your task in the **Config** section:
        ...
        <Image withBackground imageId="1675425769941" alt="Create a project. Visual editor" />
...
1. <TolokaRequesterSourceInstructions/>
    ...
    <Image withBackground imageId="1675425758507" alt="Create a project. Selection instructions" />
...
1. <TolokaRequesterSourceAudienceSettings/>
    ...
    1. <TolokaRequesterSourceFilters/>
        ...
        <Image withBackground imageId="1675425752838" alt="Create a pool. Step 3.2" />
...
1. <TutorialsQualityControl/>
    ...
    1. Click **Add a quality control rule → Results of assignment review**, and enter the following values:
        ...
        <Image withBackground imageId="1675425749459" alt="Create a pool. Selection results rule" />
...
1. <TutorialsUploadTasks/>
    ...
    1. <TolokaRequesterSourceTaskSuits/>
        ...
        <Image withBackground imageId="1675425766644" alt="Create a pool. Step 3" />
...
1. <TolokaRequesterSourceStartButton/>
    ...
    <Image withBackground imageId="1675425747514" alt="Start labeling. Step 2" />
...
1. Go to the pool, and click **Review assignments**.
    ...
    <Image withBackground imageId="1675425742598" alt="See results. Step 1" />
...
1. After checking all the assignments, click **Download results**.
    ...
    <Image withBackground imageId="1675425745263" alt="See results. Step 4" />
...
You can customize the shortcuts using the properties of the [plugin.field.image-annotation.hotkeys](/docs-new/template-builder/reference/plugin.field.image-annotation.hotkeys) component.
...
1. Sorting images containing an object.
    ...
    1. [Create a task](/docs-new/tutorials/image-classification) using the **Image classification** preset.
...
1. Selecting objects in images.
    ...
    1. Use the quality control rules: fast responses, manual review, and post-review re-assessment. [Description of rules with examples](https://toloka.ai/en/docs/guide/concepts/control).
...
Base your task on the **Object recognition & detection** preset. See the step-by-step guide for creating this type of project in the [tutorial](/docs-new/tutorials/selection).
...
You can't also use [training](https://toloka.ai/en/docs/glossary#training-pool) and the main pool with the **Training** type in an area selection project due to the same reason.
...
- [Template Builder: Object recognition](/docs-new/template-builder/templates/object-recognition)
