...
In this [project](/docs-new/glossary#project), Tolokers compare images of shoes with the original image and decide which pair of images is most similar. To make a comparison in the project, add the results from the [second project](/docs-new/tutorials/find_an_item_in_store). To learn how, see **Prepare and upload a [file](/docs-new/glossary#tsv) with tasks**.
