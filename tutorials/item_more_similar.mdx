...
date: "2023-02-14T11:23:10.095990"
author: ["Toloka Team"]
...
In this [project](https://toloka.ai/en/docs/glossary#project), Tolokers compare images of shoes with the original image and decide which pair of images is most similar. To make a comparison in the project, add the results from the [second project](/docs-new/tutorials/find_an_item_in_store). To learn how, see **Prepare and upload a [file](https://toloka.ai/en/docs/glossary#tsv) with tasks**.
...
1. <TutorialsQualityControl/>
    ...
    1. Set a rule for fast responses: if the **number of fast responses is more than 3**, then **restrict the Toloker's access** to **the project for 10 days**. Specify **Fast responses** as the reason for ban.
        ...
        <Image withBackground imageId="1675426062542" alt="" />
...
1. <TutorialsUploadTasks/>
    ...
    1. Download the file received in the [third project](/docs-new/tutorials/item_look_similar).
