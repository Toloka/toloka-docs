...
date: "2023-02-14T10:55:02.528183"
author: ["Toloka Team"]
...
1. <TutorialsAddNameDescription/>
    ...
    <Image withBackground imageId="1675425855087" alt="Create a project. Step 1" />
...
1. At the **Setup quality control** step, the **Image classification** preset has preconfigured quality control rules for more accurate results. In most cases, you can keep them as is:
    ...
    1. To filter out Tolokers who often make mistakes in the control tasks, click **Add a quality control rule → Control tasks**. Enter the following values:
        ...
        <Image withBackground imageId="1675425873569" alt="Create a pool. Control rule" />
...
1. <TutorialsUploadTasks/>
    ...
    1. <TolokaRequesterSourceTaskSuits/>
        ...
        <Image withBackground imageId="1675425859502" alt="Upload your file. Step 3" />
...
1. <TolokaRequesterSourceStartButton/>
    ...
    <Image withBackground imageId="1675425838511" alt="Start labeling. Step 2" />
...
1. <TolokaRequesterSourceLabelingProgress/>
    ...
    <Image withBackground imageId="1675425845432" alt="See the results. Step 1" />
...
1. When the labeling is complete, click the arrow next to the **Download results** button and choose **Run Dawid-Skene model** from the drop-down menu. Click **Yes** in the pop-up window.
    ...
    <Image withBackground imageId="1675425852304" alt="See the results. Step 2" />
...
- [Template Builder: Image classification](/docs-new/template-builder/templates/image-classification)
