...
1. To check if the link and image submitted by the Toloker are valid, go to line 5 in the **JS** block and replace the following code:
    ...
    Be careful when changing the code. If you have issues with the preview, contact **support** or compare your code with the code sample in the [Appendix](/docs-new/tutorials/appendix-expanded-code).
...
1. Edit the [input and output data](https://toloka.ai/en/docs/glossary#input-output-data) in the **Data specification** block.
    ...
    1. In the **Output data** field, enter:
        ...
        Learn more about the **Specification** parameters in [Input and output data](https://toloka.ai/en/docs/guide/concepts/incoming).
