...
date: "2023-02-14T11:23:08.024860"
author: ["Toloka Team"]
...
In this [project](https://toloka.ai/en/docs/glossary#project), Tolokers will compare shoes from the original image (shown in project 1) with shoes found in project 2.

<Note mode="warning" title="Warning">

Since the **Assignment review** option is enabled in the [pool](https://toloka.ai/en/docs/glossary#pool) settings for project 2, you should complete all the steps and check the Tolokers' responses within the time limit set in the **Review period** field.
...
1. In **Instructions for Tolokers**, enter the [instructions](https://toloka.ai/en/docs/glossary#instructions).
...
1. <TutorialsQualityControl/>
    ...
    1. Set a rule for [control tasks](https://toloka.ai/en/docs/glossary#control-task): If the **number of responses** to control questions **is greater than or equal to 3** and the **percentage of correct responses** to control questions **is less than 60**, then **restrict the Toloker's access** to the **project for 10 days**. Specify the **Control task** as a reason.

        <Image withBackground imageId="1675426046741" alt="" />
    ...
    1. Set a rule for fast responses: if the **number of fast responses is more than 1**, then **restrict the Toloker's access** to **the project for 10 days**. Specify **Fast responses** as the reason.
        ...
        <Image withBackground imageId="1675426043351" alt="" />
...
1. <TutorialsUploadTasks/>
    ...
    1. Open the pool page from [project 2](/docs-new/tutorials/find_an_item_in_store).
    ...
    1. Prepare a [file](https://toloka.ai/en/docs/glossary#tsv) with tasks.
...
1. <TolokaRequesterSourceAddControlTasks/>
    ...
    1. Click **Are these shoes similar to each other?** to exit [task markup](https://toloka.ai/en/docs/glossary#task-markup) mode.

        <Note mode="note" title="Note">

        In small pools, [control tasks](../troubleshooting/troubleshooting#how-many-control-tasks) should be 5–10% of all tasks. Include different versions of correct responses in equal amounts. See the distribution of responses on the **Edit tasks** page, **Control tasks** tab.
...
1. Choose the **Dawid-Skene aggregation model**. Learn more about [Result aggregation based on the Dawid-Skene model](https://toloka.ai/en/docs/guide/concepts/result-aggregation#dawid-skene).
...
1. Use the file with the results from [project 2](/docs-new/tutorials/find_an_item_in_store#upload_file).
...
To review the [submitted assignments](https://toloka.ai/en/docs/glossary#completed-tasks):
...
1. In the **Status** column, you'll see the buttons for accepting (<img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675425175810/1675425175810_original_svg.svg" alt="" />) or rejecting (<img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675425174274/1675425174274_original_svg.svg" alt="" />) the completed assignment. If you reject the assignment, enter a comment in the window that opens and click **Done**.

## What's next {#what-next}

- Create [Project 4](/docs-new/tutorials/item_more_similar) to compare matching images.
