...
You may need additional projects for your task, such as dataset pre-check or checking Tolokers' responses. Learn more about this in [Decomposition of the task](/docs-new/guide/solution-architecture).
...
1. Check the responses, and click **Accept** or **Decline**. For rejected responses, enter a comment to specify the reason.
    ...
    To learn about other ways of review, see the [Reviewing Tolokers' responses](/docs-new/guide/accept) section.
...
You can also use the mobile version of the sandbox. [Write to support](/docs-new/guide/troubleshooting/support#support-work-toloka) to get access to it.
