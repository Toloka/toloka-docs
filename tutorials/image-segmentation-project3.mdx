...
date: "2023-02-14T11:23:05.497729"
author: ["Toloka Team"]
...
In this [project](https://toloka.ai/en/docs/glossary#project), Tolokers will determine if traffic signs were selected correctly on the images in [project 1](/docs-new/tutorials/image-segmentation-project1), and submit the responses in [project 2](/docs-new/tutorials/image-segmentation-project2).
...
1. Edit the task interface. The output data format depends on the interface editor, so choose the same editor as in [Project 2](/docs-new/tutorials/image-segmentation-project2#interface-tb-html).
...
1. <TutorialsQualityControl/>
    ...
    1. Set the rule: if **number of responses** **≥ 10** and **correct responses (%)** **< 50**, then **ban** the Toloker **on project** for **10 days**. Specify the reason **Doesn't match the majority**.
        ...
        The rule takes effect when the number of responses for the task is equal to the [overlap](https://toloka.ai/en/docs/glossary#overlap).
...
1. <TutorialsUploadTasks/>
    ...
    1. Prepare a [file](https://toloka.ai/en/docs/glossary#tsv) with tasks.
        ...
        1. In the text or spreadsheet editor, open the file that you received after aggregating the results in [project 2](/docs-new/tutorials/image-segmentation-project2).
...
Since the [manual review](/docs-new/tutorials/image-segmentation-project2) option is enabled in the pool settings for **project 2**, you should check the Tolokers' responses within the time limit set in the **Review period** field.
