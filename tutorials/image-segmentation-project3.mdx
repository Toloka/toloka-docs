...
1. Edit the task interface. The output data format depends on the interface editor, so choose the same editor as in [Project 2](/docs/tutorials/image-segmentation-project2#interface-tb-html).
