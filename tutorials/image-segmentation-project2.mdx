...
In this [project](/docs-new/glossary#project), Tolokers will select image areas that contain a traffic sign. Use the results from [project 1](/docs-new/tutorials/image-segmentation-project1) as source images.
...
1. <TutorialsQualityControl/>
    ...
    1. Turn on the **Review task responses manually** option.
        ...
        The [manual review](/docs-new/guide/offline-accept) option allows you to review [completed assignments](/docs-new/glossary#completed-tasks) before accepting them and paying for them. If the Toloker didn't follow instructions, you can reject the assignment. The maximum allowed period for the review is set in the **Deadline** field.
    ...
    1. Add the following quality control rules:
        ...
        - **Fast responses** —Filters out Tolokers who respond too quickly.
            ...
            1. Set a rule for a fast response: if the **number of fast responses** **≥ 1**, then **ban** **on requester** for **10 days**. In the **Reason** field, enter **Fast responses**.
                ...
                This means that a user who completes a [task suite](/docs-new/glossary#task-suite) in less than 20 seconds will be suspended for 10 days and won't be able to access your tasks.
        ...
        [Control tasks](/docs-new/glossary#control-task) and [majority vote](/docs-new/glossary#majority-vote) aren't used for this project type, since the area markup provided by the Tolokers must match (which is almost impossible). Learn more in [Quality control](/docs-new/guide/control).
