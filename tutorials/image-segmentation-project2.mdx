...
date: "2023-02-14T11:23:02.772994"
author: ["Toloka Team"]
...
In this [project](https://toloka.ai/en/docs/glossary#project), Tolokers will select image areas that contain a traffic sign. Use the results from [project 1](/docs-new/tutorials/image-segmentation-project1) as source images.
...
1. Write instructions for Tolokers:
    ...
    Click <img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675426051746/1675426051746_original_png.png" /> and draw a rectangle around all traffic signs in the image.
...
1. <TutorialsQualityControl/>
    ...
    1. Turn on the **Review task responses manually** option.
        ...
        The [manual review](https://toloka.ai/en/docs/guide/concepts/offline-accept) option allows you to review [completed assignments](https://toloka.ai/en/docs/glossary#completed-tasks) before accepting them and paying for them. If the Toloker didn't follow instructions, you can reject the assignment. The maximum allowed period for the review is set in the **Deadline** field.
    ...
    1. Add the following quality control rules:
        ...
        - **Fast responses** —Filters out Tolokers who respond too quickly.
            ...
            1. Set a rule for a fast response: if the **number of fast responses** **≥ 1**, then **ban** **on requester** for **10 days**. In the **Reason** field, enter **Fast responses**.
                ...
                This means that a user who completes a [task suite](https://toloka.ai/en/docs/glossary#task-suite) in less than 20 seconds will be suspended for 10 days and won't be able to access your tasks.
        ...
        [Control tasks](https://toloka.ai/en/docs/glossary#control-task) and [majority vote](https://toloka.ai/en/docs/glossary#majority-vote) aren't used for this project type, since the area markup provided by the Tolokers must match (which is almost impossible). Learn more in [Quality control](https://toloka.ai/en/docs/guide/concepts/control).
...
1. <TutorialsUploadTasks/>
    ...
    1. Prepare a [file](https://toloka.ai/en/docs/glossary#tsv) with tasks.
        ...
        1. In the text or spreadsheet editor, open the file that you received after aggregating the results in [project 1](/docs-new/tutorials/image-segmentation-project1).
...
1. Use the results file in [project 3](/docs-new/tutorials/image-segmentation-project3).

## What's next {#what-next}

- Create [Project 3](/docs-new/tutorials/image-segmentation-project3) to review assignments.
