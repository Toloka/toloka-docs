...
The template uses a special component to simplify development. Learn more in [String input field](https://toloka.ai/en/docs/guide/concepts/t-components/string).
