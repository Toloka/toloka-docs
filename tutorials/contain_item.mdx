...
In this [project](/docs-new/glossary#project), you will ask Tolokers if there are shoes in the photo.
...
1. In the **Instructions for Tolokers** field, enter the [instructions](/docs-new/glossary#instructions) and add an image.
...
To create a [pool](/docs-new/glossary#pool):
...
1. <TolokaRequesterSourceAddControlTasks/>
    ...
    1. Click **Are there shoes in the photo?** to exit the [task markup](/docs-new/glossary#task-markup) mode.

        <Note mode="note" title="Note">

        In small pools, [control tasks](/docs-new/glossary#control-task) should be 10-20% of all tasks. Include different versions of correct responses in equal amounts. See the distribution of responses on the **Edit tasks** page, **Control tasks** tab.
...
1. Choose the **Dawid-Skene aggregation model**. Learn more about [Result aggregation based on the Dawid-Skene model](/docs-new/guide/result-aggregation).
