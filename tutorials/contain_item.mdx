...
date: "2023-02-14T11:23:08.255955"
author: ["Toloka Team"]
...
In this [project](https://toloka.ai/en/docs/glossary#project), you will ask Tolokers if there are shoes in the photo.
...
To create a [pool](https://toloka.ai/en/docs/glossary#pool):
...
1. <TolokaRequesterSourceAddControlTasks/>
    ...
    1. Click **Are there shoes in the photo?** to exit the [task markup](https://toloka.ai/en/docs/glossary#task-markup) mode.

        <Note mode="note" title="Note">

        In small pools, [control tasks](https://toloka.ai/en/docs/glossary#control-task) should be 10-20% of all tasks. Include different versions of correct responses in equal amounts. See the distribution of responses on the **Edit tasks** page, **Control tasks** tab.
...
1. Choose the **Dawid-Skene aggregation model**. Learn more about [Result aggregation based on the Dawid-Skene model](https://toloka.ai/en/docs/guide/concepts/result-aggregation).
...
1. Use the file with the results in [project 2](/docs-new/tutorials/find_an_item_in_store).

## What's next {#what-next}

- Create [Project 2](/docs-new/tutorials/find_an_item_in_store) to search for similar items in an online store.
