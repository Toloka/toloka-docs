...
1. When setting up a pool in the [second project](/docs-new/tutorials/image-segmentation-project2) you turned on the **Recompletion of the rejected tasks** option.
