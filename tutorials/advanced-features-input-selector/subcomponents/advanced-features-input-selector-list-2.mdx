The template uses a special component to simplify development. Learn more in [Radio button](https://toloka.ai/en/docs/guide/concepts/t-components/radiobuttons).
