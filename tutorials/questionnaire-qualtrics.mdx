...
- How to run a survey using other external platforms — [Survey on third-party platform](/docs-new/tutorials/questionnaire-other).

- How to create a survey form in Toloka instead of using a third-party platform — [Survey with Toloka template](/docs-new/tutorials/questionnaire-toloka).

The comparison of all the three kinds of the survey presets is provided in the [Overview](/docs-new/tutorials/questionnaire-overview) section.
...
- See the [What tasks can't be placed in Toloka?](https://toloka.ai/en/docs/guide/concepts/unwanted#requirements-for-survey) section.
