...
- See the [What tasks can't be placed in Toloka?](/docs-new/guide/unwanted#requirements-for-survey) section. Remember that both Tolokers and requesters are anonymous.
...
- You can conduct a survey in two stages. For example, it can be useful when the general filters of the **Audience** section are not enough to select Tolokers you need. Use skills:
    ...
    - In the first survey, [assign the skill](/docs-new/guide/nav-assign) to the relevant Tolokers.
    ...
    You can notify Tolokers about the second survey using [messages](/docs-new/guide/messaging) to those of them who have the necessary skill.
