...
If the text is specified in the task interface, then clone the project. To limit a Toloker to doing only one task in your project, use the [Submitted responses](/docs-new/guide/submitted-answers) rule. You can assign a skill or ban the Toloker after they submit one response.
