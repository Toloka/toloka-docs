If there are several possible answers, use the [field.checkbox-group](/docs-new/template-builder/reference/field.checkbox-group) component.
...
"validation": {
  ...
  <Button themeColor="light" view="default" size="l" type="link" url="https://ya.cc/t/swfEubVh3ttCg3">View example</Button>
