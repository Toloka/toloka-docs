...
1. To modify the template, use the **Config** section:
    ...
    - The **Paste link to a sample image** field contains the link to some [web storage](https://toloka.ai/en/docs/guide/concepts/cloud-storage) where you uploaded your image. Make sure the link is publicly accessible, otherwise Tolokers will not see it.
...
- [Image classification preset](/docs-new/template-builder/templates/image-classification)
- [Hand gesture classification preset](/docs-new/template-builder/templates/video-moderation)
- [Object recognition & detection preset](/docs-new/template-builder/templates/object-recognition)
