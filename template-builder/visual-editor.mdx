...
1. To modify the template, use the **Config** section:
    ...
    - The **Paste link to a sample image** field contains the link to some [web storage](/docs-new/guide/cloud-storage) where you uploaded your image. Make sure the link is publicly accessible, otherwise Tolokers will not see it.
