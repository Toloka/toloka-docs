...
The device coordinates are sent using the [data.location](/docs-new/template-builder/reference/data.location) component. You can use it without `condition.distance` if you need to read a Toloker's device coordinates without comparing them to the specified ones.
