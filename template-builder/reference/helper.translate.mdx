...
Component for translating interface elements to other languages. More details in [Translating the task interface](/docs-new/guide/project-languages#interface-translate).
