...
date: "2023-02-10T09:15:31.164292"
author: ["Toloka Team"]
...
If you need all conditions to be met, use the [condition.all](/docs-new/template-builder/reference/condition.all) component. You can also combine these components.
