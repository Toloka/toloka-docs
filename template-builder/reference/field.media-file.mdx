...
This component is convenient when using mobile devices. To upload files from a computer, it's better to use [field.file](/docs-new/template-builder/reference/field.file) for a more flexible configuration of the file types.
