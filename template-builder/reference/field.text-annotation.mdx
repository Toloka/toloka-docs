...
date: "2023-02-10T09:15:33.948810"
author: ["Toloka Team"]
...
You can use [plugin.field.text-annotation.hotkeys](/docs-new/template-builder/reference/plugin.field.text-annotation.hotkeys) to assign keyboard shortcuts for selecting categories.
