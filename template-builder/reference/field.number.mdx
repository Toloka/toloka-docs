...
date: "2023-02-10T09:15:32.966929"
author: ["Toloka Team"]
...
You can also set up validation, for example, disable negative or fractional numbers. [Learn more](/docs-new/template-builder/operations/components-for-numbers).
