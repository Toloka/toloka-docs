...
Some components have properties with the type ref or something similar, like [action.open-close](/docs-new/template-builder/reference/action.open-close). In such cases, that property is a pointer to a specific interface element.
...
The [helper.transform](/docs-new/template-builder/reference/helper.transform) component lets you convert one array into another. This is useful if you don't know the number of elements in the array, or the array is very big.
