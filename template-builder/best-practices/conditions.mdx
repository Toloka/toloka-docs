...
Some conditions work only with certain [components](/docs-new/glossary#component). For example, [condition.link-opened](/docs-new/template-builder/reference/condition.link-opened) works only with `view.link`.
