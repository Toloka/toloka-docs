...
For more information on how to add a quotation mark `"`, backslash `\`, line break, or tab to the object in the input data, see [If you're not familiar with JSON](/docs-new/template-builder/quickstart). For more information about escaping in TSV files, see the [documentation](/docs-new/guide/pool_csv).
