---
title: "Read and write | Template Builder"
...
For more information on how to add a quotation mark `"`, backslash `\`, line break, or tab to the object in the input data, see [If you're not familiar with JSON](../quickstart). For more information about escaping in TSV files, see the [documentation](https://toloka.ai/en/docs/guide/concepts/pool_csv).
...
```
Example of the question display in the [view.text](/docs-new/template-builder/reference/view.text) component:
```json
{
  "type": "view.text",
...
```
Example of writing a response using the [field.radio-group](/docs-new/template-builder/reference/field.radio-group) component:
```json
{
...
If the array length is unknown or very large, you can get all the array values using the [helper.transform](/docs-new/template-builder/reference/helper.transform) component.

For example, you can convert an array of image links to an array of [view.image](/docs-new/template-builder/reference/view.image) components to display them in the interface.
