...
To clear the entered values, use the [action.set](/docs-new/template-builder/reference/action.set) action and the `{ "$empty": true }` structure. You can call this action using a [button](/docs-new/template-builder/reference/view.action-button) or [trigger](/docs-new/template-builder/reference/plugin.trigger).
