...
Project settings in Toloka must include specifications for the [input and output data](/docs-new/glossary#input-output-data). If you use Template Builder in the Toloka interface, the specification is created automatically by default.
...
- If you edit a required field, the changes apply only to new task [pools](/docs-new/glossary#pool). For example, if you need to fix an error in a project, [clone the pool](/docs-new/guide/pool-main) or [create a new one](/docs-new/guide/pool-main). Existing task pools will continue using the previous version of the project.
