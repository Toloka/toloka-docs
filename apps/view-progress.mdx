...
import PauseIcon from './view-progress/pause-icon.svg';
...
- **Rejected** — [Errors found](../quickstart#errors).
- **Archived** — Archived.
...
1. Open the project.
1. Click <img style={{ marginBottom: -2 }} src={PauseIcon} /> on the right, next to the project name.
