...
A bespoke solution is an example of a standard task that you can solve using Toloka. Unlike [self-service project](https://toloka.ai/en/docs/guide/concepts/overview#project) templates, you don't have to set up everything yourself.
