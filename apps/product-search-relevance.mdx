---
title: "Product search relevance | Toloka apps"
...
This feature is disabled by default. [Contact our support team](/docs-new/apps/support) to get access to it.
...
You may [ask to add more features](/docs-new/apps/support) to the project:
...
---------- | ---------------------------
Up to 10,000 | <Formula withoutContainer={true} content="$0.25
10,001 - 100,000 | $"/>0.20
100,001 - 500,000 | $0.17
Over 500,000 | [Contact support](/docs-new/apps/support) to get special offer.
