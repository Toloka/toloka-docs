...
import JsonTab from './product-search-relevance/subcomponents/psr-json-tab.mdx';
import XlsxTab from './product-search-relevance/subcomponents/psr-xlsx-tab.mdx';
import CsvTab from './product-search-relevance/subcomponents/psr-csv-tab.mdx';
import TsvTab from './product-search-relevance/subcomponents/psr-tsv-tab.mdx';

import JsonTab2 from './product-search-relevance/subcomponents/psr-json-tab-2.mdx';
import XlsxTab2 from './product-search-relevance/subcomponents/psr-xlsx-tab-2.mdx';
import CsvTab2 from './product-search-relevance/subcomponents/psr-csv-tab-2.mdx';
import TsvTab2 from './product-search-relevance/subcomponents/psr-tsv-tab-2.mdx';
