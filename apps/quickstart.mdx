...
date: "2023-02-03T19:18:58.533109"
author: ["Toloka Team"]
...
Before uploading task items to a batch, you need to upload them to photo hosting or cloud storage. Learn more in the [Where to store data](https://toloka.ai/en/docs/guide/concepts/cloud-storage) section.
...
If you need help with setting up your project, [contact us](/docs-new/apps/support).

</Note>

## What's next {#whats-next}

- [Download the labeling results](/docs-new/apps/download-results)

- [Upload more items to the batch or create a new one](/docs-new/apps/add-task)

- [Rename the batch](/docs-new/apps/add-task#rename)

## Troubleshooting {#troubleshooting}

<Cut title="I didn't find a suitable bespoke solution">

If you can't find a solution that fits your goals, [contact us](/docs-new/apps/support).
