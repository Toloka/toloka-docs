...
date: "2023-06-20T13:47:18.974414"
author: ["Toloka Team"]
...
`toloka.client.TolokaClient.get_webhook_subscriptions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L3561)
...
* **Yield type:**
  ...
  Generator\[[WebhookSubscription](/docs/toloka-kit/reference/toloka.client.webhook_subscription.WebhookSubscription), None, None\]