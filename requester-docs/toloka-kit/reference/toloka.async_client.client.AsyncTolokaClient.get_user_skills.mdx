---
title: "get_user_skills — Toloka-Kit | Toloka documentation"
date: "2023-06-20T13:46:48.613895"
...
`toloka.async_client.client.AsyncTolokaClient.get_user_skills` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L0)
...
If you need to sort Toloker's skills use the [find_user_skills](/docs/toloka-kit/reference/toloka.client.TolokaClient.find_user_skills) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[UserSkill](/docs/toloka-kit/reference/toloka.client.user_skill.UserSkill), None\]
