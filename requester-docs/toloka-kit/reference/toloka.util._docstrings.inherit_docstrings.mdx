...
date: "2023-06-20T13:47:14.174119"
...
`toloka.util._docstrings.inherit_docstrings` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/util/_docstrings.py#L31)
