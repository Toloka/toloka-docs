...
date: "2023-02-27T17:42:22.065738"
author: ["Toloka Team"]
...
# EventType
`toloka.client.webhook_subscription.WebhookSubscription.EventType` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/webhook_subscription.py#L22)
