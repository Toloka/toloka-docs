...
date: "2023-02-27T17:42:41.099724"
author: ["Toloka Team"]
...
# AutoQuality
`toloka.autoquality.optimizer.AutoQuality` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/autoquality/optimizer.py#L212)
...
| Method | Description |
| :------| :-----------|
[archive_autoquality_pools](/docs/toloka-kit/reference/toloka.autoquality.optimizer.AutoQuality.archive_autoquality_pools)| Archive all pools created by `AutoQuality.setup_pools`
[create_tasks](/docs/toloka-kit/reference/toloka.autoquality.optimizer.AutoQuality.create_tasks)| Add tasks to autoquality pools.
[run](/docs/toloka-kit/reference/toloka.autoquality.optimizer.AutoQuality.run)| Run autoquality process.
[setup_pools](/docs/toloka-kit/reference/toloka.autoquality.optimizer.AutoQuality.setup_pools)| Create autoquality pools with sampled quality control parameters.