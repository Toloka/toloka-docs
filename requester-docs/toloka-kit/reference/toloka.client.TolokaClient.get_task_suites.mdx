...
date: "2023-02-27T17:42:44.197198"
author: ["Toloka Team"]
...
# get_task_suites
`toloka.client.TolokaClient.get_task_suites` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L2655)
