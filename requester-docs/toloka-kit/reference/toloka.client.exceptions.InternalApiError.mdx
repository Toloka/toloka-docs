...
date: "2023-08-28T10:25:35.896760"
...
`toloka.client.exceptions.InternalApiError` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.1/src/client/exceptions.py#L110)
