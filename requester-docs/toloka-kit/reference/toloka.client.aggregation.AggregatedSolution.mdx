...
date: "2023-02-27T17:42:25.408099"
author: ["Toloka Team"]
...
# AggregatedSolution
`toloka.client.aggregation.AggregatedSolution` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/aggregation.py#L85)
