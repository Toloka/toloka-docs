...
date: "2023-02-27T17:42:27.904574"
author: ["Toloka Team"]
...
# Pipeline
`toloka.streaming.pipeline.Pipeline` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/streaming/pipeline.py#L80)
