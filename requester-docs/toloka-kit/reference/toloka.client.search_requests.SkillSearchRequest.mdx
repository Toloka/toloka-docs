...
date: "2023-02-27T17:42:58.711180"
author: ["Toloka Team"]
...
# SkillSearchRequest
`toloka.client.search_requests.SkillSearchRequest` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/search_requests.py#L325)
