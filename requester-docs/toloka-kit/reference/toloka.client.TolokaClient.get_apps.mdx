...
date: "2023-02-27T17:42:26.708093"
author: ["Toloka Team"]
...
# get_apps
`toloka.client.TolokaClient.get_apps` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L3705)
