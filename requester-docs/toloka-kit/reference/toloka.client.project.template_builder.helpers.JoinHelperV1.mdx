...
date: "2023-02-27T17:42:25.560514"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[Union\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), List\[Union\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), str\]\]\]\]**|<p>Array of strings to join.</p>
