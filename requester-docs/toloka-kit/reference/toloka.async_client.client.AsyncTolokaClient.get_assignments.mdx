...
date: "2023-06-20T13:47:36.250467"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.get_assignments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L0)
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Assignment](/docs/toloka-kit/reference/toloka.client.assignment.Assignment), None\]
