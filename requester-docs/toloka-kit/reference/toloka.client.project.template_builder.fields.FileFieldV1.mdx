...
date: "2023-02-27T17:42:25.996666"
author: ["Toloka Team"]
...
`multiple`|**Optional\[Union\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), bool\]\]**|<p>Determines whether multiple files can be uploaded:</p> <ul> <li>`False` (default) — forbidden.</li> <li>`True` — allowed.</li> </ul>
