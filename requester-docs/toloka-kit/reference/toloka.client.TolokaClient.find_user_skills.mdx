...
date: "2023-02-27T17:42:23.565745"
author: ["Toloka Team"]
...
# find_user_skills
`toloka.client.TolokaClient.find_user_skills` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L3265)
