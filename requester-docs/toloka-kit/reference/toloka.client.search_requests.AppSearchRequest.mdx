...
date: "2023-08-28T10:25:59.230269"
...
`toloka.client.search_requests.AppSearchRequest` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.1/src/client/search_requests.py#L1029)
