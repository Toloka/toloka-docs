...
date: "2023-06-20T13:46:47.368684"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.create_tasks_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L0)
