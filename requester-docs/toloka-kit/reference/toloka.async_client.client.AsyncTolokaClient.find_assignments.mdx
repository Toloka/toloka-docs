...
date: "2023-06-20T13:47:17.905552"
...
`toloka.async_client.client.AsyncTolokaClient.find_assignments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L0)
...
To iterate over all matching assignments you may use the [get_assignments](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_assignments) method.
...
`sort`|**Union\[List\[str\], [AssignmentSortItems](/docs/toloka-kit/reference/toloka.client.search_requests.AssignmentSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [AssignmentSearchResult](/docs/toloka-kit/reference/toloka.client.search_results.AssignmentSearchResult)
