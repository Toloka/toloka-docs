---
title: "get_webhook_subscriptions — Toloka-Kit | Toloka documentation"
date: "2023-02-27T17:42:36.840879"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.get_webhook_subscriptions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L0)
...
If you need to sort webhook subscriptions use the [find_webhook_subscriptions](/docs/toloka-kit/reference/toloka.client.TolokaClient.find_webhook_subscriptions) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[WebhookSubscription](/docs/toloka-kit/reference/toloka.client.webhook_subscription.WebhookSubscription), None\]