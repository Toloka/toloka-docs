...
date: "2023-02-27T17:42:35.771896"
author: ["Toloka Team"]
...
# get_app_batches
`toloka.client.TolokaClient.get_app_batches` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L3891)
