...
date: "2023-06-20T13:46:35.791055"
...
`toloka.async_client.client.AsyncTolokaClient.archive_training_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/async_client/client.py#L0)
