...
date: "2023-06-20T13:46:38.550074"
author: ["Toloka Team"]
...
`toloka.client.search_requests.TrainingSearchRequest` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/search_requests.py#L274)
