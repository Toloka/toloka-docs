...
date: "2023-02-27T17:42:56.421948"
author: ["Toloka Team"]
...
# get_pools
`toloka.async_client.client.AsyncTolokaClient.get_pools` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L0)
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Pool](/docs/toloka-kit/reference/toloka.client.pool.Pool), None\]
