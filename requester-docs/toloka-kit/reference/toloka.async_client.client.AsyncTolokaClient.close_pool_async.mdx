...
date: "2023-06-20T13:47:15.553602"
...
`toloka.async_client.client.AsyncTolokaClient.close_pool_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/async_client/client.py#L0)
