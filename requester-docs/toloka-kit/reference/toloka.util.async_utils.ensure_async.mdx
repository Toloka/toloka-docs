...
date: "2023-06-20T13:47:30.308352"
author: ["Toloka Team"]
...
`toloka.util.async_utils.ensure_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/util/async_utils.py#L76)
