...
date: "2023-02-27T17:43:03.425362"
author: ["Toloka Team"]
...
# ensure_async
`toloka.util.async_utils.ensure_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/util/async_utils.py#L76)
