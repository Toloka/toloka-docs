...
date: "2023-02-27T17:42:41.968495"
author: ["Toloka Team"]
...
# get_user_skills
`toloka.client.TolokaClient.get_user_skills` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L3313)
...
* **Yield type:**
  ...
  Generator\[[UserSkill](/docs/toloka-kit/reference/toloka.client.user_skill.UserSkill), None, None\]
