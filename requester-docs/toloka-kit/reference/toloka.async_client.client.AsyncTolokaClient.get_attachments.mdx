...
date: "2023-08-28T10:25:28.876388"
...
`toloka.async_client.client.AsyncTolokaClient.get_attachments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.1/src/client/__init__.py#L0)
...
If you need to sort attachments use the [find_attachments](/docs/toloka-kit/reference/toloka.client.TolokaClient.find_attachments) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Attachment](/docs/toloka-kit/reference/toloka.client.attachment.Attachment), None\]
