...
date: "2023-02-27T17:42:58.751265"
author: ["Toloka Team"]
...
`toloka.client.actions.RejectAllAssignments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/actions.py#L183)
