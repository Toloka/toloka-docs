...
date: "2023-06-20T13:47:26.764527"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.find_user_restrictions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L0)
...
To iterate over all matching Toloker restrictions you may use the [get_user_restrictions](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_user_restrictions) method.
...
`sort`|**Union\[List\[str\], [UserRestrictionSortItems](/docs/toloka-kit/reference/toloka.client.search_requests.UserRestrictionSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [UserRestrictionSearchResult](/docs/toloka-kit/reference/toloka.client.search_results.UserRestrictionSearchResult)
