...
date: "2023-08-28T10:26:38.202983"
...
`toloka.client.TolokaClient.get_skills` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.1/src/client/__init__.py#L2273)
