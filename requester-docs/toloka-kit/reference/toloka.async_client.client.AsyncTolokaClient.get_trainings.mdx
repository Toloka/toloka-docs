...
date: "2023-06-20T13:47:09.338630"
...
`toloka.async_client.client.AsyncTolokaClient.get_trainings` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/__init__.py#L0)
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Training](/docs/toloka-kit/reference/toloka.client.training.Training), None\]
