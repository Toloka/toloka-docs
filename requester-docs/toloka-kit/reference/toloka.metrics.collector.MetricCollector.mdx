...
date: "2023-06-20T13:46:51.567796"
...
`toloka.metrics.collector.MetricCollector` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/metrics/collector.py#L18)
