...
date: "2023-06-20T13:47:12.736637"
...
`toloka.util._managing_headers.add_headers` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/util/_managing_headers.py#L48)
