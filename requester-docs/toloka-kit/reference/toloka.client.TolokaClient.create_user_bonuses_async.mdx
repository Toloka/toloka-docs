...
date: "2023-08-28T10:26:37.817623"
...
`toloka.client.TolokaClient.create_user_bonuses_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.1/src/client/__init__.py#L3177)
