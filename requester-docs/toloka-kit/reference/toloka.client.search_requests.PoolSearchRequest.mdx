...
date: "2023-06-20T13:46:31.994445"
author: ["Toloka Team"]
...
`toloka.client.search_requests.PoolSearchRequest` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0/src/client/search_requests.py#L223)
