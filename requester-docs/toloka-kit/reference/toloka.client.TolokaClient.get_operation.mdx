...
date: "2023-02-27T17:42:22.026051"
author: ["Toloka Team"]
...
# get_operation
`toloka.client.TolokaClient.get_operation` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L2730)
