...
date: "2023-02-27T17:42:19.096715"
author: ["Toloka Team"]
...
* [Get the value](/docs/template-builder/operations/work-with-data) from your data.
* Refer to another element using `$ref`.
* Use [helpers](/docs/template-builder/reference/helpers) and
  [conditions](/docs/template-builder/reference/conditions) to get the value.
