...
Toloka-Kit is an open source Python library allowing you to access [Toloka API](/docs/api/).
...
* Install Python 3.7+
* [Register](/docs/guide/access) as a requester in Toloka or in the Sandbox — the Toloka testing environment.
* [Top up your account](/docs/guide/refill). You can also test your pipelines in the Sandbox for free.
