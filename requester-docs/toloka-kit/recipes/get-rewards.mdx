---
title: "Get list of all bonuses issued — Toloka-Kit | Toloka documentation"
...
- _[get_user_bonuses()](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_user_bonuses) method_
