...
Before you can start using Toloka-Kit, you need to [register with Toloka](/docs/guide/access), [get an API key](/docs/toloka-kit/registration), and [install the Toloka-Kit](/docs/toloka-kit/quick-start) Python library. After that, you can create projects, pools, upload tasks, and get results.
...
<DocsRecipeCards cards={[
  ...
  {
    title: 'Filter Tolokers with confirmed language knowledge',
    description: 'Use pool filters to filter the Tolokers with various languages for which they passed the language test',
    steps: '4 steps',
    link: '/docs/toloka-kit/recipes/filter-tolokers-languages'
  },
  {
...
<DocsRecipeCards cards={[
  {
    title: 'Ban Tolokers',
    description: 'Restrict the access to tasks for Tolokers',
    steps: '4 steps',
    link: '/docs/toloka-kit/recipes/ban-tolokers'
  },
  {
    title: 'Get list of bans',
    description: 'Get the list of all the Toloker bans',
    steps: '3 steps',
    link: '/docs/toloka-kit/recipes/get-restrictions'
  },
  {
    title: 'Remove ban from Toloker',
    description: 'Remove restriction from Tolokers and restore their access to tasks',
    steps: '3 steps',
    link: '/docs/toloka-kit/recipes/delete-restriction'
  },
]} />
