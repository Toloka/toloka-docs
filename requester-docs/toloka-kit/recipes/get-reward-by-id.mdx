...
[Find out](/docs/toloka-kit/recipes/get-rewards) the ID of the reward for which you want to get the detailed information. Then get this info calling the `get_user_bonus()` method.
