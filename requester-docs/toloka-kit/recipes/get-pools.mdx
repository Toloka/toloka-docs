...
[Find out](/docs/toloka-kit/recipes/get-projects) the ID of the project for which you want to get all the pools with the `CLOSED` status. Then iterate through all the pools calling the `get_pools()` method.
...
- _[get_pools()](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_pools) method_
