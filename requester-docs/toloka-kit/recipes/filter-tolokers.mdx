...
- **Citizenship** ([Citizenship](/docs/toloka-kit/reference/toloka.client.filter.Citizenship) filter class): The tasks will be shown only to the Tolokers from the countries specified in the filter.
...
- **Education** ([Education](/docs/toloka-kit/reference/toloka.client.filter.Education) filter class): The pool tasks will be available to the Tolokers with the specified education level.
...
- **Languages** ([Languages](/docs/toloka-kit/reference/toloka.client.filter.Languages) filter class): The pool tasks will be available to the Tolokers with the specified languages.
...
<Image width="700px" withBackground imageId="1675425503583" alt="Filters used for pool" />
...
- _[Education](/docs/toloka-kit/reference/toloka.client.filter.Education) class_
