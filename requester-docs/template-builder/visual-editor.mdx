...
<Image width="700px" withBackground imageId="1675425370325" alt="Visual editor interface" />
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-visual-editor">Contact support</Button>
