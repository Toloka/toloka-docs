...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/XE6YjRFh3ttCWx">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-operations-set-plugin-toloka">Contact support</Button>