---
title: "Configuring task display — Template Builder | Toloka documentation"
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-operations-set-plugin-toloka">Contact support</Button>
