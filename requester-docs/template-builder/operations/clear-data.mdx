...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/0Ho2_pzu3ttAor">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/jknPjrTl3ttAqw">View example</Button>

<p></p>

<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-operations-clear-data">Contact support</Button>
