...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/11ypBlCg42Qp6o">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-helper-replace">Contact support</Button>