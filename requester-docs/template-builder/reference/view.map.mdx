...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/sVwUCmig3tz5fk">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-view-map">Contact support</Button>