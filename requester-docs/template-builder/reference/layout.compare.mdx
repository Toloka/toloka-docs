...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/MwYMw5-q3x7Lrs">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-layout-compare">Contact support</Button>