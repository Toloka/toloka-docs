...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/8DLgvKE644n8C6">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-layout-sidebar">Contact support</Button>