...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/bpPoA9v93xPPKA">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-condition-empty">Contact support</Button>