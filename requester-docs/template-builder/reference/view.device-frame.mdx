...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/7awTef7848KrmX">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-view-device-frame">Contact support</Button>