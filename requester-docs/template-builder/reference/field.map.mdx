...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/CtOG5R413tz9Dj">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-field-map">Contact support</Button>