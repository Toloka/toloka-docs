...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/wf2xSzVO3twkui">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-helper-entries2object">Contact support</Button>