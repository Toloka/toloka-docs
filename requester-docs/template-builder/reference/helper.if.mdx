...
date: "2023-03-29T11:05:12.021207"
...
The If...Then...Else operator. Allows you to execute either one block of code or another, depending on the condition. If you need more options, use [helper.switch](/docs/template-builder/reference/helper.switch).
...
To learn more about conditions, see the [List of conditions](/docs/template-builder/reference/conditions).
...
- [field.text](/docs/template-builder/reference/field.text): A field for entering a short text, not more than a line.
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-helper-if">Contact support</Button>