...
date: "2023-03-29T11:05:03.711680"
...
Used to set hotkeys for the [field.image-annotation](/docs/template-builder/reference/field.image-annotation) component.
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-plugin-field-image-annotation-hotkeys">Contact support</Button>