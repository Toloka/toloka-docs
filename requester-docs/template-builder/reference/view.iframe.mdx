...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/MQwwYlAL4Nq7n7">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-view-iframe">Contact support</Button>