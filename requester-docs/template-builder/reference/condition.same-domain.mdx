...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/Up5Km-i53vwDif">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-reference-condition-same-domain">Contact support</Button>