...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/YYGrysCn3ttAe3">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/sUY1_L-A3ttEvD">View example</Button>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-best-practices-reuse">Contact support</Button>
