...
- [view.action-button](/docs/template-builder/reference/view.action-button): Adds a button that calls an action.
  ...
  In this example, clicking the button calls [@yandex-toloka/data.location](/docs/template-builder/reference/data.location) which sends the coordinates of the Toloker's device.
