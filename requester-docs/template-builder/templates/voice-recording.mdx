...
<Button themeColor="light" view="default" size="l" type="link" url="https://ya.cc/t/XgN35IUF3xqvGy">View example</Button>
...
<Button themeColor="light" view="default" size="l" type="link" url="https://ya.cc/t/a5j6lIKx3zL3nz">View example</Button>
...
<Button themeColor="light" view="default" size="l" type="link" url="https://ya.cc/t/3bZ9nXUi3zLAZC">View example</Button>
...
<Button themeColor="light" view="default" size="l" type="link" url="https://ya.cc/t/3VRy3mKj3zvPcB">View example</Button>

<p></p>

<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-templates-voice-recording">Contact support</Button>
