...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/h0PX65GS3ttDRj">View example</Button>
...
- To [check](/docs/template-builder/best-practices/conditions) whether a Toloker watched videos up to the end, replace the [condition.played](/docs/template-builder/reference/condition.played) component with [condition.played-fully](/docs/template-builder/reference/condition.played-fully).
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/gIJRfreg3ttDTG">View example</Button>
...
- To add a detailed description to the task, use the [view.text](/docs/template-builder/reference/view.text) component.
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/izMU-u7x3ttDUS">View example</Button>
...
- To let Tolokers leave comments about the task or their response, add a text field using [field.textarea](/docs/template-builder/reference/field.textarea).
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/X-T_nb_K3ttDVR">View example</Button>
...
To enhance Toloker's experience, you can highlight different types of data with colors using [view.alert](/docs/template-builder/reference/view.alert). In this example, the source text is highlighted with a blue border, and the buttons are highlighted with a yellow one.
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/7YaPTOBr3ttDWf">View example</Button>

<p></p>

<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-templates-sbs-video">Contact support</Button>
