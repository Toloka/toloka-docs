...
- [view.video](/docs/template-builder/reference/view.video): A video player.
...
- [layout.columns](/docs/template-builder/reference/layout.columns): Arranges videos side by side.
...
- To [check](/docs/template-builder/best-practices/conditions) whether a Toloker watched videos up to the end, replace the [condition.played](/docs/template-builder/reference/condition.played) component with [condition.played-fully](/docs/template-builder/reference/condition.played-fully).
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-templates-sbs-video">Contact support</Button>
