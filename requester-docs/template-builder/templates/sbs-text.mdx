...
<Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/VJLQqpaa3ttDLT">View example</Button>
...
- To add a detailed description to the task, use the [view.text](/docs/template-builder/reference/view.text) component.
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/7QbNavYu3ttDMv">View example</Button>
...
- To let Tolokers leave comments about the task or their response, add a text field using [field.textarea](/docs/template-builder/reference/field.textarea).
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/5rZCBcs33ttDPF">View example</Button>
...
To enhance Toloker's experience, you can highlight different types of data with colors using [view.alert](/docs/template-builder/reference/view.alert). In this example, the source text is highlighted with a blue border, and the buttons are highlighted with a yellow one.
  ...
  <Button view="defaultInverse" size="l" type="link" url="https://ya.cc/t/dfyAF6qL3ttDQQ">View example</Button>

<p></p>

<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=template-builder-templates-sbs-text">Contact support</Button>
