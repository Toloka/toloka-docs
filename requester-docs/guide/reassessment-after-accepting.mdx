...
date: "2023-07-26T19:02:22.603219"
...
- Resend rejected assignments for re-completion to other Tolokers.
    ...
    If you rejected an assignment, you may want it to be completed by another Toloker instead of the one whose [task suite response](/docs/glossary#response) you rejected. To do this, you can increase the [overlap](/docs/glossary#overlap) for this assignment only. This is especially helpful if you have the overlap value set to 1.
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-reassessment-after-accepting">Contact support</Button>