...
Learn more about task review [here](/docs/guide/offline-accept) and [here](/docs/guide/accept).
...
- [Toloka API: Editing pool](/docs/api/edit-pool)
- [Toloka API: Changing pool priority](/docs/api/set-priority-pool)
