1. [Fill in the refund form](/docs/guide/troubleshooting/support?form-topic1=money&form-topic3=refund&form-payer=business_nonrf&form-payment_method=transfer&form-source=guide-refund)
