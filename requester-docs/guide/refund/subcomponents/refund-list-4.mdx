1. [Fill in the refund form](/docs/guide/troubleshooting/support?form-topic1=money&form-topic3=refund&form-payer=business_nonrf&form-payment_method=card&form-answer_choices_51622059=57944124&form-source=guide-refund)
