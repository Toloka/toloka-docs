...
date: "2023-05-05T10:12:18.440920"
author: ["Toloka Team"]
...
- **Toloka support**
    ...
    If you need help with setting up pools or projects, give [Toloka support](/docs/guide/troubleshooting/support?form-source=guide-multiple-access) temporary view-only access to your account to get recommendations. Access will be automatically revoked in 7 days. If necessary, you can revoke access earlier.
