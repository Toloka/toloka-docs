...
- Make sure that different [task response](/docs/glossary#task-response) options have about the same frequency in your test.
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-how-to-use-exams">Contact support</Button>