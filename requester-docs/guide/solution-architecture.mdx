...
date: "2023-02-15T15:15:21.870404"
author: ["Toloka Team"]
...
For example, in the [Business information (example with decomposition)](/docs/tutorials/data-collection) section, the task can be divided into four projects:
...
<img style="max-width:100%;" src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425186344/1675425186344_original_svg.svg" alt="" />
...
- You can assign a skill to Tolokers in one project and filter Tolokers by this [skill](/docs/glossary#skill) in another project.
...
- You can set up a separate project where other Tolokers check responses in submitted assignments. For example, if you want to create a project titled “Find similar products”, enable [manual review](/docs/glossary#assignment-review) in this project and create a separate project with the “Are these items similar?” task to review responses, reject incorrect responses, and avoid paying for them.
    ...
    In the assignments review, specify the [review period](/docs/glossary#review-period) after which the tasks are accepted automatically. You need to make sure that this timeframe allows enough time to complete the project for checking responses and then reject tasks in the general task project.
