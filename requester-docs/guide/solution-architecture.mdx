...
- [Project 3. Does the item found look similar to the original?](/docs/tutorials/item_look_similar) — Checking the [task responses](/docs/glossary#task-response).

- [Project 4. Which of the found items is most similar to the original?](/docs/tutorials/item_more_similar) — Choosing the best task response.
