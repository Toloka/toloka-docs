...
To switch modes, click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425172020/1675425172020_original_svg.svg" alt="" />. Examples of fields:

#### Examples of fields:

<Cut title="Text in different formats">

- <Term term="String"><TolokaRequesterSourceString/></Term> of a certain length
...
- <Term term="Integer"><TolokaRequesterSourceInteger/></Term> from the specified range:
...
- <Term term="Fractional"><TolokaRequesterSourceFloat/></Term> number:
...
- A number with 0, 1, or 2 decimal places.
    ...
    To do this, choose the <Term term="string"><TolokaRequesterSourceString/></Term> type and use regular expression for validation. Note that the decimal separator is a comma:
