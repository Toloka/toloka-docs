...
Make the hints clear. Explain which [task response](/docs/glossary#task-response) should be chosen and why.
...
1. Create a control or a training task from another type of task clicking the appropriate button.
    ...
    <Image width="700px" withBackground imageId="1680169942389" alt="Create control or training tasks" />
...
<Image width="700px" withBackground imageId="1680169948345" alt="" />
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-task-markup-by-yourself">Contact support</Button>