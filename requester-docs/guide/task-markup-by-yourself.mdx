...
1. Click either **Control tasks** or **Training tasks** indicator of the **Tasks** block on the pool page.
    ...
    <Image width="400px" withBackground imageId="1680169167354" alt="Click Control or Training tasks" />

1. Create a control or a training task from another type of task clicking the appropriate button.

    <Image withBackground imageId="1680169171609" alt="Create control or training tasks" />
...
<Image withBackground imageId="1680169178507" alt="" />
