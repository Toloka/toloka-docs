...
import CloudStorageList4 from './cloud-storage/subcomponents/cloud-storage-list-4.mdx'
...
[Yandex Object Storage](/docs/guide/use-object-storage) | 60 days | 5 TB | $50 | [Trial period](https://cloud.yandex.com/en-ru/docs/free-trial/)
...
<Tabs tabs={[
  ...
  { title: 'Yandex Object Storage', value: <CloudStorageList4/> },
]}/>
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-cloud-storage">Contact support</Button>