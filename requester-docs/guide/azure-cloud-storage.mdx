...
1. Open the Azure [main page](https://portal.azure.com/?quickstart=true#home) and click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425173788/1675425173788_original_svg.svg" alt="" /> in the top left corner.

1. Select **Storage accounts**.

1. On the top panel, click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425173354/1675425173354_original_svg.svg" alt="" /> **Create**.
...
1. Select the region closest to your Tolokers. For example, for Tolokers from Germany: **Region → (Europe) West Central Germany**.
    ...
    <Image width="700px" withBackground imageId="1675425955797" alt="" />
...
1. On the top panel, click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425173354/1675425173354_original_svg.svg" alt="" /> **Container**.
...
1. On the top panel, click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425958460/1675425958460_original_png.png" alt="" /> **Send**.
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-azure-cloud-storage">Contact support</Button>
