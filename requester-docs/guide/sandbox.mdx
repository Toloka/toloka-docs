...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-topic1=sandbox&form-source=guide-sandbox">Contact support</Button>