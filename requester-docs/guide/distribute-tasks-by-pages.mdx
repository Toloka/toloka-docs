...
date: "2023-02-22T17:52:37.449813"
author: ["Toloka Team"]
...
Enter the number of tasks per suite. The order of tasks depends on the [**Keep task order**](/docs/guide/pool-main) pool setting.
...
<Image withBackground imageId="12e402debc201730207644d464edc346" alt="" />
...
- If there aren't enough general tasks and the **Assign partial page** option is set, the Toloker is given an [incomplete task suite](/docs/glossary#incomplete-task-suite). Please note that the number of control and training tasks in this case must be complete.
...
- [Toloka API: Task suites](/docs/api/task-suite)
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-distribute-tasks-by-pages">Contact support</Button>
