...
date: "2023-06-26T17:55:35.520388"
author: ["Toloka Team"]
...
Majority vote is a [quality control](/docs/glossary#quality-control) method based on matching responses from the majority of Tolokers who complete the same [task](/docs/glossary#task). For example, if a task has an [overlap](/docs/glossary#overlap) of “5” and three Tolokers selected the same answer, this is considered indirect confirmation of the correct response.
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-mvote">Contact support</Button>