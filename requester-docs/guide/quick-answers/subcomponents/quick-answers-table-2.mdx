...
- **accept all assignments from this Toloker in the pool** — Requires the [manual review](/docs/guide/offline-accept) option to be set.<br/><br/>    Useful if the Toloker completes most tasks well. Example: The Toloker completed more than 80% of the tasks correctly and you're satisfied with this result. The rule will work automatically and accept all responses in the pool.
