...
Tasks are uploaded to the [pool](/docs/guide/pool-main) in [the tasks file](/docs/glossary#tsv).

Download the file template for your [project](/docs/glossary#project) on the [pool](/docs/glossary#pool) page. Use the template to create your own task file and upload it to the pool.
...
- [Upload tasks to the pool](/docs/guide/task_upload).
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-pool-csv">Contact support</Button>
