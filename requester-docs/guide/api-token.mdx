...
date: "2023-05-24T15:06:01.861999"
author: ["Toloka Team"]
...
1. Go to **Profile → Integrations** (or click [this link](https://platform.toloka.ai/requester/profile/integration)). Click **<img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425166901/1675425166901_original_svg.svg" alt="Plus sign" /> Generate token**:

    <Image withBackground imageId="1607657d66218b0c6c251dcd523e3057" alt="Generate token" />
...
1. Enter a unique name or description for the token. Uniqueness is not required, but it will allow you to distinguish this token in case you have several ones. Click **Generate**:
    ...
    <Image withBackground imageId="5ac72a4928a0d17cd416a55460a6522f" alt="Enter token name" />

1. A new token will be generated. Click **Copy and close** to copy the token into the clipboard and close the dialog window:

    <Image withBackground imageId="c5e71330b80ad2f81ea629b43959826c" alt="Copy and close" />
...
1. Your newly generated token will be added to the list of the tokens associated with your account:
    ...
    <Image withBackground imageId="e12badf3c4c7296d99750b5ba887635a" alt="List of tokens" />
