...
After you login to the platform using [social authorization](/docs/guide/access#social-auth) or [single sign-on](/docs/guide/sso/sso/authentication) (SSO) authentication method, you can generate new keys. You can use them for API requests or for the integration applications. We recommend that you generate new keys as the previously generated tokens will be deprecated with time.
