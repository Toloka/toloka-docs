...
Now you can create projects, pools, and upload tasks. You can also [generate API keys](/docs/guide/api-token) for your applications.

## What's next `{#what-next}`

- [Generate API keys](/docs/guide/api-token)

<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-sso-authentication">Contact support</Button>