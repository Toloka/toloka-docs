...
date: "2023-03-10T16:13:41.797524"
author: ["Toloka Team"]
...
- You need to register as a company, not as an individual, and have a created company in Toloka platform. Please [contact our support team](/docs/guide/troubleshooting/support.md?form-topic1=other) to learn how you can do this.
...
Now you can create projects, pools, and upload tasks. You can also [generate API tokens](/docs/guide/sso/api-token) for your applications.

## What's next {#what-next}

- [Generate API tokens](/docs/guide/sso/api-token)
