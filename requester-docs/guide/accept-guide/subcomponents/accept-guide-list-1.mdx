...
<Cut title="Online review statistics">
...
1. Open the [file with responses](/docs/guide/result-of-eval).
    ...
    **Explanation**
    ...
    - `ACCEPT:comment` — Comments for Tolokers if responses were rejected (for example, specify which part of the [instructions](/docs/glossary#instructions) wasn't followed).
...
Place a separate task for Tolokers to review the responses. To learn how to do it, see the [last project](/docs/tutorials/image-segmentation-project3) in the [Selecting an image area](/docs/tutorials/image-segmentation-overview). It implements manual review with the help of Tolokers.
