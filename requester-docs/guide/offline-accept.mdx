...
Manual review is a [pool](/docs/glossary#pool) setting that allows you to check responses and not pay for poorly completed tasks.
...
Learn more about this in the [**Review results**](/docs/guide/reviewing-assignments) rule settings.
