...
date: "2023-04-11T17:39:47.573168"
author: ["Toloka Team"]
...
Manual review is a [pool](/docs/glossary#pool) setting that allows you to check responses and not pay for poorly completed [tasks](/docs/glossary#task).

You can find the [Review methods](/docs/guide/accept#acception) in the **Working with results → Reviewing Tolokers' responses** section.
