1. Download the template and replace the sample data in it with [your own data](/docs/guide/pool_csv).

1. Click **Select prepared dataset** and choose your [file with tasks](/docs/glossary#tsv).
