...
Using markup, you can add correct responses and hints to tasks, as well as change task types. You can turn a general task into a [control task](/docs/glossary#control-task) by adding the correct answer, or into a [training task](/docs/glossary#training-task) by adding the correct answer and a hint.
