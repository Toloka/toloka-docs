...
If you're looking to select MacOS, Windows, and Linux, the most popular operating systems for PCs, add the **Operating system** filter. Use the `=` operator to set the value as `Windows`. Use the <img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675425170178/1675425170178_original_svg.svg" alt="Button Add" /> button to add the second value, `MacOS`. Then click <img src="https://tlk-infra-front.azureedge.net/portal-static/uploaded/images/1675425170178/1675425170178_original_svg.svg" alt="Button Add" /> again and set the third value, `Linux`.
