...
1. Select a skill. We recommend to select a skill calculated as the percentage of [correct responses in control tasks](/docs/guide/goldenset). This will give you the most accurate aggregation results.
