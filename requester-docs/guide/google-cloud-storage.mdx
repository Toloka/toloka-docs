...
1. Click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425971337/1675425971337_original_png.png" alt="" /> **Create project**.
...
1. Select a project and click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425971337/1675425971337_original_png.png" alt="" /> **Create bucket**.

   <Image width="700px" withBackground imageId="1675426004273" alt="" />
...
1. In **Choose how to control access to objects**, disable the option **Enforce public access prevention on this bucket**.
   ...
   <Image width="700px" withBackground imageId="1675426008754" alt="" />

1. Click **Create**.

1. To make objects accessible by link, on the **Permissions** tab click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425986210/1675425986210_original_png.png" alt="" /> **Add**.
...
1. Select **Cloud Storage → Storage Object Viewer**.
    ...
    <Image width="700px" withBackground imageId="1675425983011" alt="" />
...
<Image width="700px" withBackground imageId="1675426000434" alt="" />
...
1. Choose the file you uploaded and click **Copy URL** in the **Public access** column.
   ...
   <Image width="700px" withBackground imageId="1675426007349" alt="" />
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=guide-google-cloud-storage">Contact support</Button>
