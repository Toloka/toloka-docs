---
title: "Add response options — Tutorials | Toloka documentation"
date: "2023-02-14T11:23:09.300740"
coverId: F_bIcOYF9yjrxkPZrXc3
docsMenu: "tutorialsMenu"
---

import AdvancedFeaturesInputSelectorList1 from './advanced-features-input-selector/subcomponents/advanced-features-input-selector-list-1.mdx'
import AdvancedFeaturesInputSelectorList2 from './advanced-features-input-selector/subcomponents/advanced-features-input-selector-list-2.mdx'
import AdvancedFeaturesInputSelectorList3 from './advanced-features-input-selector/subcomponents/advanced-features-input-selector-list-3.mdx'
...
<Cut title="See how it looks in the example of the “Photos of product and price tag” template">

Before:

<Image width="700px" withBackground imageId="1675426226851" alt="" />

After:

<Image width="700px" withBackground imageId="1675426254901" alt="" />
...
<Tabs tabs={[
  { title: 'Add a checkbox', value: <AdvancedFeaturesInputSelectorList1/> },
  { title: 'Add a radio button', value: <AdvancedFeaturesInputSelectorList2/> },
  { title: 'Add a drop-down list', value: <AdvancedFeaturesInputSelectorList3/> },
]}/>

<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=tutorials-advanced-features-input-selector">Contact support</Button>
