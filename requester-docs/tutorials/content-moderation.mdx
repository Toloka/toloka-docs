...
date: "2023-03-10T16:55:52.197621"
...
1. <TutorialsAddNameDescription/>
    ...
    <Image width="700px" withBackground imageId="1675426344555" alt="Create a project. Step 1" />
...
1. In the **Task interface** section, set up what your tasks will look like. This preset has a task template with validation, keyboard shortcuts, and task layout pre-configured.
    ...
    1. Write the first question Tolokers will see in your task. All tasks in a project use the same question.
        ...
        <Image width="700px" withBackground imageId="1675426346969" alt="Create a project. Config question" />
    ...
    1. Set answer options. In the `options` list, replace the sample answers with your values in the following properties:
        ...
        <Image width="700px" withBackground imageId="1675426334500" alt="Create a project. Config answer options" />
    ...
    1. When a Toloker selects an option which requires additional information, the second question with checkboxes appears. You can change the condition under which the additional question becomes visible. To to that, replace the value of the `to` propertу with one of the values you’ve already specified in the `value` properties in the previous step:
        ...
        <Image width="700px" withBackground imageId="1675426325873" alt="Create a project. Config answer options" />

    1. Configure the text and the answer options for the additional question:

        <Image width="700px" withBackground imageId="1675426337283" alt="Create a project. Config condition" />

    1. In the **Input data example** section, add a sample text. It is only used to display the task interface preview on the right.

        <Image width="700px" withBackground imageId="1675426380350" alt="Create a project. Input data example" />
...
1. <TolokaRequesterSourceAudienceSettings/>
    ...
    1. <TolokaRequesterSourceFilters/>
        ...
        <Image width="700px" withBackground imageId="1675426339594" alt="Create a pool. Languages filter" />
...
1. <TutorialsQualityControl/>
    ...
    1. To filter out Tolokers who complete tasks too fast, edit the pre-configured **Fast responses** rule. Specify the following values:
        ...
        <Image width="700px" withBackground imageId="1675426331505" alt="Create a pool. Fast responses rule" />
    ...
    1. Click **Add a quality control rule → Control tasks**, and enter the following values:
        ...
        <Image width="700px" withBackground imageId="1675426382705" alt="Create a pool. Control tasks rule" />
...
1. <TutorialsUploadTasks/>
    ...
    1. <TolokaRequesterSourceTaskSuits/>
        ...
        <Image width="700px" withBackground imageId="1675426366202" alt="Upload data. Tasks per suite" />
...
1. <TolokaRequesterSourceStartButton/>
    ...
    <Image width="700px" withBackground imageId="1675426368061" alt="Start labeling. Step 2" />
...
1. You can see the labeling progress on the pool page. Wait until the labeling is completed. Refresh the page to check the progress.
    ...
    <Image width="700px" withBackground imageId="1675426359484" alt="See the results. Step 1" />
...
1. When the labeling is complete, click the arrow next to the **Download results** button and choose **Run Dawid-Skene model** from the drop-down menu. Click **Yes** in the pop-up window.
    ...
    <Image width="700px" withBackground imageId="1675426356347" alt="See the results. Step 2" />
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=tutorials-content-moderation">Contact support</Button>
