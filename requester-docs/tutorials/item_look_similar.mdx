...
1. In **Instructions for Tolokers**, enter the [instructions](/docs/glossary#instructions).
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=tutorials-item-look-similar">Contact support</Button>
