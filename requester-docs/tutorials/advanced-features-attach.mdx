...
<Image width="700px" withBackground imageId="1675426273069" alt="" />

After:

<Image width="700px" withBackground imageId="1675426288610" alt="" />
...
- [Button for recording and uploading a video file](/docs/guide/t-components/upload-video)
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=tutorials-advanced-features-attach">Contact support</Button>
