...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=tutorials-advanced-features-attach">Contact support</Button>
