1. Create a template based on the [Checking the selected area](https://ya.cc/t/AKDvkBw44CFb73) example that uses [Component for image labeling](/docs/template-builder/reference/field.image-annotation).
