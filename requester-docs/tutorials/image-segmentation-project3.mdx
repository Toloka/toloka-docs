...
date: "2023-03-06T16:04:38.742587"
author: ["Toloka Team"]
...
1. In the **Instructions for Tolokers** field, enter the [instructions](/docs/glossary#instructions).
...
Since the [manual review](/docs/tutorials/image-segmentation-project2) option is enabled in the pool settings for **project 2**, you should check the Tolokers' responses within the time limit set in the **Review period** field.
...
<Tabs tabs={[
  { title: 'Review assignments in the results file', value: <ImageSegmentationProject3List2/> },
  { title: 'Review assignments in the pool interface', value: <ImageSegmentationProject3List3/> },
]}/>
