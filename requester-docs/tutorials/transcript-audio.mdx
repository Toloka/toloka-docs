...
date: "2023-03-10T16:55:54.248637"
author: ["Toloka Team"]
...
1. <TutorialsAddNameDescription/>
    ...
    <Image width="700px" withBackground imageId="1675425930504" alt="Create a project. Step 1" />
...
1. In the **Task interface** section, set up what your tasks will look like. This preset has a task template with layout and validation pre-configured. The Toloker won't be able to submit the response without listening to the audio recording and adding the text.
    ...
    1. In the **Config** section, you can change the texts Tolokers will see in your task. All tasks in a project use the same texts.
        ...
        <Image width="700px" withBackground imageId="1675425942781" alt="Create a project. Config texts" />
    ...
    1. In the **Input data example** section, add a link to a sample audio. This audio is only used to display the task interface preview on the right.
        ...
        <Image width="700px" withBackground imageId="1675425935217" alt="Create a project. Input data example" />
...
1. <TolokaRequesterSourceAudienceSettings/>
    ...
    1. <TolokaRequesterSourceFilters/>
        ...
        - For example, add the **Languages** filter:
            ...
            <Image width="700px" withBackground imageId="1675425945827" alt="Create a pool. Language filter" />
...
1. <TutorialsQualityControl/>
    ...
    1. Edit the pre-configured **Fast responses** rule to catch bots. This rule filters out Tolokers who complete tasks too fast.
        ...
        <Image width="700px" withBackground imageId="1675425922263" alt="Create a pool. Fast answers filter" />
    ...
    1. For a trial pool, the settings you’ve just made are enough. You can get better results if you set the additional quality control rules.
        ...
        1. Click **Add a quality control rule**, and add the second **Fast responses** rule. It will help detect Tolokers who retype texts carelessly, make mistakes, skip words, or don't take the task seriously enough.
            ...
            <Image width="700px" withBackground imageId="1675425939720" alt="Create a pool. Fast answers control rule" />
        ...
        1. Add the **Results of manual review** quality control rule and enter the following values:
            ...
            <Image width="700px" withBackground imageId="1675425927432" alt="Create a pool. Assignments review control rule" />
        ...
        1. Add the [Processing rejected and accepted assignments](/docs/guide/reassessment-after-accepting) rule:
            ...
            <Image width="700px" withBackground imageId="1675425925495" alt="Create a pool. Processing rejected and accepted assignments control rule" />
...
1. <TutorialsUploadTasks/>
    ...
    1. <TolokaRequesterSourceTaskSuits/>
        ...
        <Image width="700px" withBackground imageId="1675425947924" alt="Upload data. Tasks per suite" />
...
1. <TolokaRequesterSourceStartButton/>
    ...
    <Image width="700px" withBackground imageId="1675425933474" alt="Start labeling. Step 2" />
...
1. Go to the pool, and click **Review assignments**.
    ...
    <Image width="700px" withBackground imageId="1675425919752" alt="See the results. Review assignments" />
...
1. After checking all the assignments, click **Download results**.
    ...
    <Image width="700px" withBackground imageId="1675425937496" alt="See the results. Download results" />
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=tutorials-transcript-audio">Contact support</Button>
