...
<Tabs tabs={[
  ...
  { title: 'Using the Bespoke API', value: <ViewProgressList3/> },
]}/>
...
<Button view="defaultInverse" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=apps-view-progress">Contact support</Button>