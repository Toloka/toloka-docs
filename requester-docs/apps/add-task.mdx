...
date: "2023-05-17T10:24:23.280078"
author: ["Toloka Team"]
...
1. <TolokaAppsUploadData/>
    ...
    - Click **Via API** to use the [API](/docs/api/).
...
1. Next to the batch name, click <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1675425164853/1675425164853_original_svg.svg" alt="Rename" />.

1. Enter a new batch name and click **Save**.

## What's next {#whats-next}

Wait until the labeling is done and [download the results](/docs/apps/download-results).
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=apps-add-task">Contact support</Button>