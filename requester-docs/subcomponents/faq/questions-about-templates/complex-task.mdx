...
[Use](/docs/tutorials/selection) the **Object selection in an image** preset. You can open this preset in the editor and add a drop-down list for labeling the selected object. See how to do this in the editor [description](/docs/guide/t-components/image-annotation#annotation) (**Dropdown list** tab).
