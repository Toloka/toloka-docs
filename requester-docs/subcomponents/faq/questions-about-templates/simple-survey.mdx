...
1. If you need an [extensive](/docs/guide/t-components/text) response, add the required number of text entry components.

1. If you need a [short](/docs/guide/t-components/string) response, add the required number of string entry components.
...
1. Come up with a name for the input field and set the string type for it (see the step-by-step [guide on creating a survey](/docs/tutorials/questionnaire-toloka)).
