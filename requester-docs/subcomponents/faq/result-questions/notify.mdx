...
- Assign them a hidden skill, or use an existing [skill](/docs/guide/nav-assign) linked to the pool.

- Go to **Messages** and click **Contact** → **Group of Tolokers** → **Add filter** → **Choose your skill** → **&lt;skill name&gt;**.
