...
For more information about creating the file, see this [guide](/docs/guide/pool_csv). If there are errors during the upload, look up the error description on this [page](/docs/guide/task_upload#table-with-errors).
