...
Yes, you can do that. In this case, create the first pool based on the [training pool](/docs/glossary#training-pool) and the exam pool based on your main pool. If a pool contains only control and/or training tasks, the price can be set to zero.
