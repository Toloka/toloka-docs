...
For a step-by-step description of the registration process, see [Registration and login](https://toloka.ai/tolokers/docs/web/register.html?lang=en#register).
