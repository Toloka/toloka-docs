...
- Tasks **that collect PII from Tolokers,** such as photos, videos or voice recordings, are allowed if the PII is collected in a lawful manner:
  ...
  - You must follow the [Guidelines on data collection](https://docs.google.com/document/d/1K9QWL2URAP-EdQTvU_UFR_0jmj7e2F7vaLiBfbBw9TQ/edit#heading=h.7wh4ixjk46ik).
...
- **Conducting surveys** on third-party platforms is allowed provided that the following conditions are met:
  ...
  - If you want to collect PII, follow the [Guidelines on data collection](https://docs.google.com/document/d/1K9QWL2URAP-EdQTvU_UFR_0jmj7e2F7vaLiBfbBw9TQ/edit#heading=h.7wh4ixjk46ik).
