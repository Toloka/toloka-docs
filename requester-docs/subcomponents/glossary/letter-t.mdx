...
They can also be used in regular pools as [control tasks](#control-task) with hints. For example, you can track the percentage of correct task responses and [ban Tolokers](#banning-tolokers) who respond poorly. To do this, use the [Control tasks](/docs/guide/goldenset) quality control rule.
