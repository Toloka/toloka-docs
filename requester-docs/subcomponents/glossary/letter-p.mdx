...
A category of [components](#component) used in Template Builder that enable advanced features. For example, `plugin.hotkeys` lets you set up shortcuts. [List of plugins](/docs/template-builder/reference/plugins)
