---
title: "Get item by ID — Apps API | Toloka documentation"
date: "2023-02-06T18:34:34.869823"
author: ["Toloka Team"]
...
import AppProjectsappProjectIditemsitemIdGetTable1 from './app-projectsapp-project-iditemsitem-id-get/subcomponents/app-projectsapp-project-iditemsitem-id-get-table-1.mdx'

# Get item by ID

## Description

Displays the detailed information about the item with the ID specified in the request.
...
method | url
----- | -----
get | <AppProjectsappProjectIditemsitemIdGetTable1/>
...
item_id | path | true | Task item ID.
