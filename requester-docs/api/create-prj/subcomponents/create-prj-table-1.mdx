...
- `AUTOMATED` — The Toloker is assigned a task suite from the pool. You can [configure](/docs/api/create-pool#issue_task_suites_in_creation_order) the order for assigning task suites.
