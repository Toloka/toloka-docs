...
The Toloka API is migrating to the `toloka.dev` domain. Access to the Toloka API is about to change. The current API domain (`toloka.yandex.com`) works in deprecated mode and will be disabled **since May 1, 2023**. You need to update your applications to use the new domain.

<Note mode="restriction" title="Alert">

If you do not change the domain, your requests to the Toloka API will end up with errors starting May 1, 2023.
