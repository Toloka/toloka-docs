...
date: "2023-05-02T16:13:17.075001"
author: ["Toloka Team"]
...
This method won't work if you created a pool using [smart mixing](/docs/guide/distribute-tasks-by-pages#distribute-tasks-by-pages__smart-mixing). When uploading tasks this way, use the [POST /task-suites](https://toloka.ai/docs/api/api-reference/#post-/task-suites) request.
