...
Working with the Toloka API requires an OAuth access token. [Register](/docs/guide/access) in Toloka and get an OAuth token in the requester interface:
...
<Button themeColor="light" view="default" size="l" type="link" url="/docs/guide/troubleshooting/support?form-source=api-access">Contact support</Button>
