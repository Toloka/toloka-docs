...
date: "2023-03-31T13:53:12.522677"
...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_rasa.SegmentationRASA.fit)| Fit the model.
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_rasa.SegmentationRASA.fit_predict)| Fit the model and return the aggregated segmentations.