...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.classification.majority_vote.MajorityVote.fit)| Fit the model.
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.classification.majority_vote.MajorityVote.fit_predict)| Fit the model and return aggregated results.
[fit_predict_proba](/docs/crowd-kit/reference/crowdkit.aggregation.classification.majority_vote.MajorityVote.fit_predict_proba)| Fit the model and return probability distributions on labels for each task.
