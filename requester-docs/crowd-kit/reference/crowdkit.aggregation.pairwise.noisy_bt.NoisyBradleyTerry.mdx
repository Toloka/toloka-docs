...
This model is a modification of the [Bradley-Terry model](/docs/crowd-kit/reference/crowdkit.aggregation.pairwise.bradley_terry.BradleyTerry)
...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.pairwise.noisy_bt.NoisyBradleyTerry.fit)| None
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.pairwise.noisy_bt.NoisyBradleyTerry.fit_predict)| None
