...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.classification.zero_based_skill.ZeroBasedSkill.fit)| Fit the model.
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.classification.zero_based_skill.ZeroBasedSkill.fit_predict)| Fit the model and return aggregated results.
[fit_predict_proba](/docs/crowd-kit/reference/crowdkit.aggregation.classification.zero_based_skill.ZeroBasedSkill.fit_predict_proba)| Fit the model and return probability distributions on labels for each task.
[predict](/docs/crowd-kit/reference/crowdkit.aggregation.classification.zero_based_skill.ZeroBasedSkill.predict)| Infer the true labels when the model is fitted.
[predict_proba](/docs/crowd-kit/reference/crowdkit.aggregation.classification.zero_based_skill.ZeroBasedSkill.predict_proba)| Return probability distributions on labels for each task when the model is fitted.
