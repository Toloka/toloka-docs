...
date: "2023-02-06T17:36:10.066193"
author: ["Toloka Team"]
...
# fit_predict_scores
`crowdkit.aggregation.texts.text_rasa.TextRASA.fit_predict_scores` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.2.0/crowdkit/aggregation/texts/text_rasa.py#L65)
