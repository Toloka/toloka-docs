...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.embeddings.closest_to_average.ClosestToAverage.fit)| Fits the model.
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.embeddings.closest_to_average.ClosestToAverage.fit_predict)| Fit the model and return the aggregated results.
[fit_predict_scores](/docs/crowd-kit/reference/crowdkit.aggregation.embeddings.closest_to_average.ClosestToAverage.fit_predict_scores)| Fit the model and return the estimated scores.
