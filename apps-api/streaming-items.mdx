...
date: "2023-02-06T18:34:33.801611"
author: ["Toloka Team"]
...
**Key**|**Overview**
----- | -----
**items**|**array of objects**<br/><br/>Array of task items according to the `input_spec` value of the bespoke solution.<br/><br/>You can upload an array from a single task item or from several task items within a single request.
...
When you upload items without a batch, processing starts immediately. You can learn about the completion of processing from each item's [status](/docs-new/apps-api/quickstart-api#check-items).
