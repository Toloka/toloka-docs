---
title: "Get batch by ID — Apps API | Toloka documentation"
date: "2023-02-06T18:34:34.675719"
author: ["Toloka Team"]
...
import AppProjectsappProjectIdbatchesbatchIdGetTable1 from './app-projectsapp-project-idbatchesbatch-id-get/subcomponents/app-projectsapp-project-idbatchesbatch-id-get-table-1.mdx'

# Get batch by ID

## Description

Returns the detailed information about the batch with the ID specified in the request.
...
method | url
----- | -----
get | <AppProjectsappProjectIdbatchesbatchIdGetTable1/>
