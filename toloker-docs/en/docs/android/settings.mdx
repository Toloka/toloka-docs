...
- Turn on [geotags in the camera settings](#camera) if you plan to complete field projects.
...
1. Tap <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1676448795481/1676448795481_original_svg.svg" alt="" /> to go to projects on the map.
...
## Gallery `{#google}`
In some field projects, you need to attach several photos at once (for example, the front of a building and the sign). If **Gallery** doesn't support choosing multiple photos, install the [Google Photos](https://play.google.com/store/apps/details?id=com.google.android.apps.photos) app.
