...
Toloka lets you withdraw money using: Payoneer, Papara.

You can add only one account of each type.

<Note mode="restriction" title="Important update: Changes to withdrawal methods">

PayPal will no longer be available. Please choose a different withdrawal method.
