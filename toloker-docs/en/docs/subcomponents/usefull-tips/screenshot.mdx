import ScreenshotList1 from './screenshot/screenshot-list-1.mdx'
import ScreenshotList2 from './screenshot/screenshot-list-2.mdx'
import ScreenshotList3 from './screenshot/screenshot-list-3.mdx'
import ScreenshotList4 from './screenshot/screenshot-list-4.mdx'
...
2. Use the keyboard shortcut **Ctrl + V** or click **Paste** in the top menu of the application (for Windows 7 and above).
    ...
    <Image width="700px" withBackground imageId="1682078409159" alt="" />
...
3. Click **File → Save** as or press <img src="https://tlkfrontprod.azureedge.net/portal-production/static/uploaded/images/1682078389947/1682078389947_original_png.png" alt="" />.
    ...
    <Image width="700px" withBackground imageId="1682078413781" alt="" />
