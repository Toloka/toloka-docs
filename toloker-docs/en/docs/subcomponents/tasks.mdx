...
Sometimes, you need advice to complete tasks efficiently and use the platform correctly. If you need clarification on a task, contact the requester via [personal messages](https://we.toloka.ai/messages). If you have a question about using the platform, or something doesn't work, contact support.
