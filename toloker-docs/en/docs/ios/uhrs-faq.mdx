...
Within 24 hours, UHRS transfers money to Toloka account. These funds are initially unavailable for withdrawals as the tasks undergo review. It might take up to 7 days. Until that moment, the bonus is indicated as grey in the **Profile** section. If you face any difficulties with bonuses please contact our [support service](../troubleshooting/support?form-source=uhrs-faq#contact).
