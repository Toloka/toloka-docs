...
Within 24 hours, UHRS transfers money to Toloka account. These funds are initially unavailable for withdrawals as the tasks undergo review. It might take up to 7 days. Until that moment, the reward is indicated as gray in the upper right corner of the account. If you face any difficulties with rewards please contact our [support service](../troubleshooting/support.md#contact).
