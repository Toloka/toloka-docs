...
1. Open the [Projects](https://we.toloka.ai/tasks) page and click the **Connect** button in the banner. If you accidentally closed the banner, refresh the page in the browser.
