...
- `SET_SKILL_FROM_OUTPUT_FIELD` — Set the "percentage of correct responses" as the skill value (used in [control tasks](/docs/api/goldenset) and [majority vote](/docs/api/mv) rules).<br/><br/>    You can use the skill value for filtering Tolokers.
