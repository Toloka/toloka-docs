...
date: "2023-02-03T19:53:26.390604"
author: ["Toloka Team"]
...
In the `pool_id` query parameter, replace `<pool id>` with the ID of the pool you want to get responses for (the ID received in response to the [add pool request](/docs-new/api/qs-placement#pool)).
...
- [HTTP methods used for processing Toloker responses](/docs-new/api/get-response)
- [HTTP methods used for processing files in Toloker responses](/docs-new/api/attachments)
- [Response aggregation](/docs-new/api/aggregated-solutions)
- [Using libraries](/docs-new/api/libraries)