...
- `$TOLOKA_ASSETS/js/image-annotation.js` — Image labeling interface (more information about [image with area selection](https://toloka.ai/en/docs/guide/concepts/t-components/image-annotation.md/)).
