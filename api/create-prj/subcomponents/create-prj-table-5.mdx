...
- `$TOLOKA_ASSETS/js/image-annotation.js` — Image labeling interface (more information about [image with area selection](/docs-new/guide/t-components/image-annotation.md/)).
