**string \| required**<br/><br/>Type of action:

- `RESTRICTION` — Ban access to projects or pools.
- `SET_SKILL_FROM_OUTPUT_FIELD` — Set the "percentage of correct responses" as the skill value (used in [control tasks](/docs-new/api/goldenset) and [majority vote](/docs-new/api/mv) rules).<br/><br/>    You can use the skill value for filtering Tolokers.
