---
title: "Register a proxy server | Toloka API"
date: "2023-02-06T14:48:34.870281"
author: ["Toloka Team"]
...
To get the full URL for accessing data on the created server, use the `getProxyUrl(path)` method (see the [Task class](https://toloka.ai/en/docs/guide/concepts/js/task) section).
