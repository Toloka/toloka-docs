...
1. Check access to the API with the following Python script.
    ...
    - Imports the package.
    - Asks to enter the [OAuth token](/docs-new/toloka-kit/registration#oauth-token).
...
- Complete one of the [tutorials](https://toloka.ai/en/docs/guide/tutorials/usecases) to get acquainted with Toloka web interface.

- Create your [first project](/docs-new/toloka-kit/recipes/learn-basics) using Toloka-Kit.

- Try [Toloka-Kit usage examples](/docs-new/toloka-kit/recipes/use-cases).

- Read the package reference starting with [TolokaClient](/docs-new/toloka-kit/reference/toloka.client.TolokaClient).

- Study [Toloka API documentation](/docs-new/api/).

- See other features in [Toloka documentation](https://toloka.ai/en/docs/guide/concepts/overview).
