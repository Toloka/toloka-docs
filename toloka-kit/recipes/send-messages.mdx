---
title: "Send messages | Toloka-Kit"
...
The `compose_message_thread()` request will return the [MessageThread](/docs-new/toloka-kit/reference/toloka.client.message_thread.MessageThread) class object. You can use its attributes to print the information you need.
...
- _[compose_message_thread()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.compose_message_thread) method_
