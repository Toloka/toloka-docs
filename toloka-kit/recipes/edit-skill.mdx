...
[Find out](/docs-new/toloka-kit/recipes/get-skills) the ID of the skill which you want to modify. Then create a local copy of the project object calling the `get_skill()` method.
...
Specify a new private comment for the skill. You can choose to change some other skill data. Refer to the [Skill](/docs-new/toloka-kit/reference/toloka.client.skill.Skill) class to see what other attributes it has.
...
The `update_skill()` request will return the [Skill](/docs-new/toloka-kit/reference/toloka.client.skill.Skill) class object. You can use its attributes to print the information you need.
...
- _[update_skill()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.update_skill) method_
...
- [Get skills](/docs-new/toloka-kit/recipes/get-skills)
- [Toloka-Kit: Skill class](/docs-new/toloka-kit/reference/toloka.client.skill.Skill)
