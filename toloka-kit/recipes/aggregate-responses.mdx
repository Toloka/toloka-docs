---
title: "Aggregate responses in pool | Toloka-Kit"
...
We recommend that you try our [crowd-kit library](/docs-new/crowd-kit/). It has various aggregation methods and executes on your computer.
...
- _[aggregate_solutions_by_pool()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.aggregate_solutions_by_pool) method_
- _[wait_operation()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.wait_operation) method_
- _[get_aggregated_solutions()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_aggregated_solutions) method_
