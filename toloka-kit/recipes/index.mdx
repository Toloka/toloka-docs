...
Before you can start using Toloka-Kit, you need to [register with Toloka](https://toloka.ai/en/docs/guide/concepts/access), [get an OAuth token](/docs-new/toloka-kit/registration), and [install the Toloka-Kit](/docs-new/toloka-kit/quick-start) Python library. After that, you can create projects, pools, upload tasks, and get results.
...
<DocsRecipeCards cards={[
  ...
  },
  {
    ...
    steps: '9 steps',
    link: '/docs-new/toloka-kit/recipes/use-quality-control-rules'
  },
]} />
...
<DocsRecipeCards cards={[
  {
    ...
    steps: '3 steps',
    link: '/docs-new/toloka-kit/recipes/get-skills'
  },
  {
    title: 'Create skill',
    description: 'Create a skill that you can assign to Tolokers',
    steps: '4 steps',
    link: '/docs-new/toloka-kit/recipes/create-skill'
  },
  {
    title: 'Assign skill to Toloker',
    description: 'Assign an existing skill to Tolokers an set its level',
    steps: '4 steps',
    link: '/docs-new/toloka-kit/recipes/assign-skill'
  },
  {
    title: 'Edit skill',
    description: 'Modify an existing skill',
    steps: '6 steps',
    link: '/docs-new/toloka-kit/recipes/edit-skill'
  },
  {
...
<DocsRecipeCards cards={[
  {
    title: 'Issue rewards to Tolokers',
    description: 'Additionally reward Tolokers who completed their tasks better than others',
    steps: '4 steps',
    link: '/docs-new/toloka-kit/recipes/assign-reward'
  },
  {
    title: 'Get list of all rewards issued',
    description: 'Get all the rewards you issued in Toloka',
    steps: '3 steps',
    link: '/docs-new/toloka-kit/recipes/get-rewards'
  },
  {
    title: 'Get reward details',
    description: 'Get the detailed information about the reward with the ID specified in the request',
    steps: '4 steps',
    link: '/docs-new/toloka-kit/recipes/get-reward-by-id'
  },
]} />
...
<DocsRecipeCards cards={[
  {
    ...
    steps: '4 steps',
    link: '/docs-new/toloka-kit/recipes/send-messages'
  },
  {
    ...
    steps: '3 steps',
    link: '/docs-new/toloka-kit/recipes/get-message-threads'
  },
  {
    title: 'Reply to message thread',
    description: 'Send a reply to a message thread in Toloka',
    steps: '4 steps',
    link: '/docs-new/toloka-kit/recipes/reply-to-message-thread'
  },
]} />
...
- [your first complete project](/docs-new/toloka-kit/recipes/learn-basics)
