...
Before you can start using Toloka-Kit, you need to [register with Toloka](/docs-new/guide/access), [get an OAuth token](/docs-new/toloka-kit/registration), and [install the Toloka-Kit](/docs-new/toloka-kit/quick-start) Python library. After that, you can create projects, pools, upload tasks, and get results.
