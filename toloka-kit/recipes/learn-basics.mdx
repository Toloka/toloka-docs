...
A [project](/docs-new/guide/overview#project) is a top-level object. It contains instructions, task interface settings, input and output data specification, and default quality control rules for this project pools. Projects make it easier for you to post similar tasks in the future, because you don't have to re-configure the interface.
...
- [Input and output data specification](/docs-new/guide/incoming)
- [Task interface settings](/docs-new/guide/spec)
- [Instructions for Tolokers](/docs-new/guide/instruction)
...
- [HTML/CSS/JS editor](/docs-new/guide/spec#interface-section)
...
The first thing the Tolokers see when they select a task are the [instructions](/docs-new/guide/instruction) that you wrote. Describe what needs to be done in simple and clear language, and give examples.
...
A [pool](/docs-new/guide/overview#pool) is a set of tasks that share common pricing, start date, selection of Tolokers, overlap, and quality control configurations. All task in a pool are processed in parallel. One project can have several pools. You can add new tasks to a pool at any time, as well as open or stop it.
...
A [task suite](/docs-new/guide/overview#tasks-page) is a set of tasks that are shown on a single page.
...
[Filters](/docs-new/guide/filters) help you select Tolokers for your project.
...
[Quality control rules](/docs-new/guide/check-performers) regulate task completion and Toloker access.

Quality control lets you get more accurate responses and restrict access to tasks for cheating users. All rules work independently. Learn more about [settting up quality control](/docs-new/guide/qa-pool-settings).
...
A [task](/docs-new/guide/overview#task) is the smallest portion of data you need to mark up.
...
You should run the [results aggregation](/docs-new/guide/result-aggregation) only if you set the overlap for the tasks to 2 or higher.

The [majority vote](/docs-new/guide/mvote) method is a quality control method based on matching responses from the majority of Tolokers who complete the same task. For example, if 2 out of 3 Tolokers selected the `cat` label, then the final label for this task will be `cat`.
