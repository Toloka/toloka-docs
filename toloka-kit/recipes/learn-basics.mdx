...
- [Register](/docs-new/toloka-kit/registration) in the web version of Toloka.
- [Top up](/docs-new/toloka-kit/registration#top-up) your account.
- [Install Toloka-Kit](/docs-new/toloka-kit/quick-start).
...
Now, create a [Toloka client](/docs-new/toloka-kit/reference/toloka.client.TolokaClient) instance. All API calls will go through it:
...
- _[get_requester()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_requester) method_
...
A [project](https://toloka.ai/en/docs/guide/concepts/overview#project) is a top-level object. It contains instructions, task interface settings, input and output data specification, and default quality control rules for this project pools. Projects make it easier for you to post similar tasks in the future, because you don't have to re-configure the interface.
...
- _[Project](/docs-new/toloka-kit/reference/toloka.client.project.Project) class_

</Note>

The code above creates an object in your device memory. This is not all, the project must also contain:

- [Input and output data specification](https://toloka.ai/en/docs/guide/concepts/incoming)
- [Task interface settings](https://toloka.ai/en/docs/guide/concepts/spec)
- [Instructions for Tolokers](https://toloka.ai/en/docs/guide/concepts/instruction)
...
- _[UrlSpec](/docs-new/toloka-kit/reference/toloka.client.project.field_spec.UrlSpec) class_
- _[StringSpec](/docs-new/toloka-kit/reference/toloka.client.project.field_spec.StringSpec) class_
...
- [HTML/CSS/JS editor](https://toloka.ai/en/docs/guide/concepts/spec#interface-section)
- [Template Builder](/docs-new/template-builder/)
...
- _[ImageViewV1](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.view.ImageViewV1) class_
- _[InputData](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.data.InputData) class_
- _[RadioGroupFieldV1](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.fields.RadioGroupFieldV1) class_
- _[OutputData](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.data.OutputData) class_
- _[GroupFieldOption](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.fields.GroupFieldOption) class_
- _[RequiredConditionV1](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.conditions.RequiredConditionV1) class_
- _[TolokaPluginV1](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.plugins.TolokaPluginV1) class_
- _[TemplateBuilderViewSpec](/docs-new/toloka-kit/reference/toloka.client.project.view_spec.TemplateBuilderViewSpec) class_
- _[TaskSpec](/docs-new/toloka-kit/reference/toloka.client.project.task_spec.TaskSpec) class_

</Note>

#### Instructions

The first thing the Tolokers see when they select a task are the [instructions](https://toloka.ai/en/docs/guide/concepts/instruction) that you wrote. Describe what needs to be done in simple and clear language, and give examples.
...
- _[create_project()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.create_project) method_
...
1. In the upper-right corner of the project page click <img src="https://toloka.ai/en/docs/guide/_images/drop-down.svg" alt="Project actions" /> → **<img src="https://toloka.ai/en/docs/guide/_images/preview.svg" alt="Preview" /> Preview**:
...
A [pool](https://toloka.ai/en/docs/guide/concepts/overview#pool) is a set of tasks that share common pricing, start date, selection of Tolokers, overlap, and quality control configurations. All task in a pool are processed in parallel. One project can have several pools. You can add new tasks to a pool at any time, as well as open or stop it.
...
- _[Defaults](/docs-new/toloka-kit/reference/toloka.client.pool.Pool.Defaults) class_

</Note>

#### Task suite

A [task suite](https://toloka.ai/en/docs/guide/concepts/overview#tasks-page) is a set of tasks that are shown on a single page.
...
- _[set_mixer_config](/docs-new/toloka-kit/reference/toloka.client.pool.codegen_setter_for_mixer_config) setter for the [Pool](/docs-new/toloka-kit/reference/toloka.client.pool.Pool) class_

</Note>

#### Filters

[Filters](https://toloka.ai/en/docs/guide/concepts/filters) help you select Tolokers for your project.
...
[Quality control rules](https://toloka.ai/en/docs/guide/concepts/check-performers) regulate task completion and Toloker access.

Quality control lets you get more accurate responses and restrict access to tasks for cheating users. All rules work independently. Learn more about [settting up quality control](https://toloka.ai/en/docs/guide/concepts/qa-pool-settings).
...
- _[set_captcha_frequency](/docs-new/toloka-kit/reference/toloka.client.pool.codegen_setter_for_quality_control_captcha_frequency) setter for the [Pool](/docs-new/toloka-kit/reference/toloka.client.pool.Pool) class_
- _[Captcha](/docs-new/toloka-kit/reference/toloka.client.collectors.Captcha) class_
...
A [task](https://toloka.ai/en/docs/guide/concepts/overview#task) is the smallest portion of data you need to mark up.
...
- _[create_tasks()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.create_pool) method_
...
- _[get_analytics()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_analytics) method_
- _[CompletionPercentagePoolAnalytics](/docs-new/toloka-kit/reference/toloka.client.analytics_request.CompletionPercentagePoolAnalytics) class_
- _[wait_operation()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.wait_operation) method_
...
- _[get_assignments_df()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_assignments_df) method_
...
You should run the [results aggregation](https://toloka.ai/en/docs/guide/concepts/result-aggregation) only if you set the overlap for the tasks to 2 or higher.

The [majority vote](https://toloka.ai/en/docs/guide/concepts/mvote) method is a quality control method based on matching responses from the majority of Tolokers who complete the same task. For example, if 2 out of 3 Tolokers selected the `cat` label, then the final label for this task will be `cat`.

Majority vote is easily implemented, but you can also use our crowdsourcing [Crowd-Kit library](/docs-new/crowd-kit/). It contains a lot of new aggregation methods.
...
- _[fit_predict()](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.majority_vote.MajorityVote.fit_predict) method of the Crowd-Kit [MajorityVote](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.majority_vote.MajorityVote) class_
...
- [Toloka-Kit recipe list](/docs-new/toloka-kit/recipes/use-cases)
- [Toloka documentation](https://toloka.ai/en/docs/)
- [Toloka API documentation](/docs-new/api/)
