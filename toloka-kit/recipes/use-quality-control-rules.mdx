---
title: "Use quality control rules | Toloka-Kit"
...
Set up the **Fast responses** quality control rule using the [add_action()](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl.add_action) method to create the [AssignmentSubmitTime](/docs-new/toloka-kit/reference/toloka.client.collectors.AssignmentSubmitTime) collector class object with the appropriate conditions and actions.
...
Refer to the [Fast responses](https://toloka.ai/en/docs/guide/concepts/quick-answers) section for more information on how to set up the **Fast responses** quality control rule and what parameters it should have for the correct settings.

### 5. Add 'Majority vote' quality control rule {#step-five}

Set up the **Majority votes** quality control rule using the [add_action()](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl.add_action) method to create the [MajorityVote](/docs-new/toloka-kit/reference/toloka.client.collectors.MajorityVote) collector class object with the appropriate conditions and actions.
...
Refer to the [Majority vote](https://toloka.ai/en/docs/guide/concepts/mvote) section for more information on how to set up the **Majority vote** quality control rule and what parameters it should have for the correct settings.

### 6. Add 'Skipped assignments' quality control rule {#step-six}

Set up the **Skipped assignments** quality control rule using the [add_action()](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl.add_action) method to create the [SkippedInRowAssignments](/docs-new/toloka-kit/reference/toloka.client.collectors.SkippedInRowAssignments) collector class object with the appropriate conditions and actions.
...
Refer to the [Skipped assignments](https://toloka.ai/en/docs/guide/concepts/skipped-assignments) section for more information on how to set up the **Skipped assignments** quality control rule and what parameters it should have for the correct settings.

### 7. Add 'Control tasks' quality control rule {#step-seven}

Set up the **Control tasks** quality control rule using the [add_action()](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl.add_action) method to create the [GoldenSet](/docs-new/toloka-kit/reference/toloka.client.collectors.GoldenSet) collector class object with the appropriate conditions and actions.
...
Refer to the [Control tasks](https://toloka.ai/en/docs/guide/concepts/goldenset) section for more information on how to set up the **Control tasks** quality control rule and what parameters it should have for the correct settings.

<Note mode="tip" title="Tip">

See the [Collectors](/docs-new/toloka-kit/reference/toloka.client.collectors.AcceptanceRate) section of the Toloka-Kit reference for the complete list of the available collectors used to create quality control rules and their possible values.
...
- _[add_action()](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl.add_action) method_
- _[AssignmentSubmitTime](/docs-new/toloka-kit/reference/toloka.client.collectors.AssignmentSubmitTime) collector class_
- _[FastSubmittedCount](/docs-new/toloka-kit/reference/toloka.client.conditions.FastSubmittedCount) condition class_
- _[RestrictionV2](/docs-new/toloka-kit/reference/toloka.client.actions.RestrictionV2) action class_
- _[MajorityVote](/docs-new/toloka-kit/reference/toloka.client.collectors.MajorityVote) collector class_
- _[TotalAnswersCount](/docs-new/toloka-kit/reference/toloka.client.conditions.TotalAnswersCount) condition class_
- _[CorrectAnswersRate](/docs-new/toloka-kit/reference/toloka.client.conditions.CorrectAnswersRate) condition class_
- _[RejectAllAssignments](/docs-new/toloka-kit/reference/toloka.client.actions.RejectAllAssignments) action class_
- _[SkippedInRowAssignments](/docs-new/toloka-kit/reference/toloka.client.collectors.SkippedInRowAssignments) collector class_
- _[SkippedInRowCount](/docs-new/toloka-kit/reference/toloka.client.conditions.SkippedInRowCount) condition class_
- _[GoldenSet](/docs-new/toloka-kit/reference/toloka.client.collectors.GoldenSet) collector class_
- _[GoldenSetCorrectAnswersRate](/docs-new/toloka-kit/reference/toloka.client.conditions.GoldenSetCorrectAnswersRate) condition class_
- _[GoldenSetAnswersCount](/docs-new/toloka-kit/reference/toloka.client.conditions.GoldenSetAnswersCount) condition class_
- _[ApproveAllAssignments](/docs-new/toloka-kit/reference/toloka.client.actions.ApproveAllAssignments) action class_
...
- [Majority vote](https://toloka.ai/en/docs/guide/concepts/mvote)
- [Skipped assignments](https://toloka.ai/en/docs/guide/concepts/skipped-assignments)
- [Control tasks](https://toloka.ai/en/docs/guide/concepts/goldenset)
