---
title: "Reject responses from Tolokers | Toloka-Kit"
...
[Find out](/docs-new/toloka-kit/recipes/get-responses) the ID of the Toloker response that your want to reject and use the [reject_assignment()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.reject_assignment) method to reject the response and leave a comment.
...
The `reject_assignment()` request will return the [Assignment](/docs-new/toloka-kit/reference/toloka.client.assignment.Assignment) class object. You can use its attributes to print the information you need.
...
- _[reject_assignment()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.reject_assignment) method_
