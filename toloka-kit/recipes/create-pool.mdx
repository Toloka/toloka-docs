...
- the ID of the project in which the pool is created, [find it out](/docs-new/toloka-kit/recipes/get-projects) before creating the pool
...
You can choose your own values or have your own set of the pool parameters. Refer to the [Pool](/docs-new/toloka-kit/reference/toloka.client.pool.Pool) class page for more details.
