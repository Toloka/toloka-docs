...
[Find out](/docs-new/toloka-kit/recipes/get-projects) the ID of the project which you want to modify. Then create a local copy of the project object calling the `get_project()` method.
...
Specify a new public name that the Tolokers will see. You can choose to change some other project data. Refer to the [Project](/docs-new/toloka-kit/reference/toloka.client.project.Project) class to see what other attributes it has.
...
The `update_project()` request will return the [Project](/docs-new/toloka-kit/reference/toloka.client.project.Project) class object. You can use its attributes to print the information you need.
...
- _[get_project()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_project) method_
- _[update_project()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.update_project) method_
...
- [Toloka-Kit: Project class](/docs-new/toloka-kit/reference/toloka.client.project.Project)
