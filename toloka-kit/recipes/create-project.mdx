...
Normally, it's more convenient to create a project using [Toloka interface](/docs-new/guide/project). Nevertheless, it's still possible to create a project, write instructions, set up input and output data fields, and configure the task interface via Toloka-Kit.
...
Configure the task interface using the `view_spec` parameter of the [TaskSpec](/docs-new/toloka-kit/reference/toloka.client.project.task_spec.TaskSpec) class, define input and output data. See comments in the code below and the [Task interface](/docs-new/guide/spec) section for more information.
