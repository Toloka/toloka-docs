---
title: "Create project | Toloka-Kit"
...
Normally, it's more convenient to create a project using [Toloka interface](https://toloka.ai/en/docs/guide/concepts/project). Nevertheless, it's still possible to create a project, write instructions, set up input and output data fields, and configure the task interface via Toloka-Kit.
...
Configure the task interface using the `view_spec` parameter of the [TaskSpec](/docs-new/toloka-kit/reference/toloka.client.project.task_spec.TaskSpec) class, define input and output data. See comments in the code below and the [Task interface](https://toloka.ai/en/docs/guide/concepts/spec) section for more information.
...
The `create_project()` request will return the [Project](/docs-new/toloka-kit/reference/toloka.client.project.Project) class object. You can use its attributes to print the information you need.
...
- _[ClassicViewSpec](/docs-new/toloka-kit/reference/toloka.client.project.view_spec.ClassicViewSpec) class_
