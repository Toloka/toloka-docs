...
In this recipe we create a control task first. The main difference between a control and general task in Toloka is that a control task has a known answer to it. For this answer, the `known_solutions` parameter of the [Task](/docs-new/toloka-kit/reference/toloka.client.task.Task) class object is used.

[Find out](/docs-new/toloka-kit/recipes/get-pools) the ID of the pool where you want to upload the created tasks. For control tasks, set `infinite_overlap` to `True`.
...
You need to know what values are allowed for the output data (`output_values`). You set the output data when you [create a project](/docs-new/toloka-kit/recipes/create-project#step-three).
...
The `create_tasks()` request will return the [TaskBatchCreateResult](/docs-new/toloka-kit/reference/toloka.client.batch_create_results.TaskBatchCreateResult) class object. You can use its attributes to print the information you need.
...
- _[BaseTask](/docs-new/toloka-kit/reference/toloka.client.task.BaseTask) class_
- _[KnownSolution](/docs-new/toloka-kit/reference/toloka.client.task.BaseTask.KnownSolution) class_
- _[create_task()](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.create_task) method_
...
- [Toloka-Kit: TaskBatchCreateResult class](/docs-new/toloka-kit/reference/toloka.client.batch_create_results.TaskBatchCreateResult)
