...
* Install Python 3.7+
* [Register](/docs-new/guide/access) as a requester in Toloka or in the Sandbox — the Toloka testing environment.
* [Top up your account](/docs-new/guide/refill). You can also test your pipelines in the Sandbox for free.
