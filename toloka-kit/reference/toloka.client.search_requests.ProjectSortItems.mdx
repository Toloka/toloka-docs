...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[SortItem](/docs-new/toloka-kit/reference/toloka.client.search_requests.ProjectSortItems.SortItem)\]\]**|<p>A list of sorting keys. Supported values:</p> <ul> <li>`&#x27;id&#x27;` — A project ID.</li> <li>`&#x27;created&#x27;` — A project creation date.</li> <li>`&#x27;public_name&#x27;` — A project name.</li> <li>`&#x27;private_comment&#x27;` — A project private comment.</li> </ul>
