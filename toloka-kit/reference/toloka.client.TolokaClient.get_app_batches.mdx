...
date: "2023-02-07T15:41:47.400723"
author: ["Toloka Team"]
...
# get_app_batches
`toloka.client.TolokaClient.get_app_batches` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L3876)
...
* **Yield type:**
  ...
  Generator\[[AppBatch](/docs-new/toloka-kit/reference/toloka.client.app.AppBatch), None, None\]
