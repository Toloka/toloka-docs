...
To create several tasks at once use the [create_tasks](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.create_tasks) method.

## Parameters Description

| Parameters | Type | Description |
| :----------| :----| :-----------|
`task`|**[Task](/docs-new/toloka-kit/reference/toloka.client.task.Task)**|<p>The task to be created.</p>
