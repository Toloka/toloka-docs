...
| :----------| :----| :-----------|
`status`|**Optional\[List\[[Assignment.Status](/docs-new/toloka-kit/reference/toloka.client.assignment.Assignment.Status)\]\]**|<p>Assignment status or a list of statuses. Refer to the [Assignment.Status](/docs-new/toloka-kit/reference/toloka.client.assignment.Assignment.Status) page for more information on the available `status` values.</p>
