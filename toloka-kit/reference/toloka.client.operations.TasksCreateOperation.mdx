...
date: "2023-02-07T15:41:47.511082"
author: ["Toloka Team"]
...
`toloka.client.operations.TasksCreateOperation` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/operations.py#L267)
...
`parameters`|**Optional\[[Parameters](/docs-new/toloka-kit/reference/toloka.client.operations.TasksCreateOperation.Parameters)\]**|<p>Operation parameters (depending on the operation type).</p>
