...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[WebhookSubscription](/docs-new/toloka-kit/reference/toloka.client.webhook_subscription.WebhookSubscription)\]\]**|<p>A list with found subscriptions.</p>
