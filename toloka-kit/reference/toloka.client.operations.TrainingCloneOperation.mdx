...
date: "2023-02-07T15:42:13.841965"
author: ["Toloka Team"]
...
`toloka.client.operations.TrainingCloneOperation` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/operations.py#L213)
...
`parameters`|**Optional\[[TrainingOperation.Parameters](/docs-new/toloka-kit/reference/toloka.client.operations.TrainingOperation.Parameters)\]**|<p>Operation parameters (depending on the operation type).</p>
`details`|**Optional\[[Details](/docs-new/toloka-kit/reference/toloka.client.operations.TrainingCloneOperation.Details)\]**|<p>Details of the operation completion.</p>
