...
* Task interface. To learn how to define the appearance of tasks, see [Task interface](/docs/guide/spec).
...
`task_spec`|**Optional\[[TaskSpec](/docs/toloka-kit/reference/toloka.client.project.task_spec.TaskSpec)\]**|<p>Parameters for input and output data and the task interface.</p>
`assignments_issuing_type`|**[AssignmentsIssuingType](/docs/toloka-kit/reference/toloka.client.project.Project.AssignmentsIssuingType)**|<p>How to assign tasks. The default value is AUTOMATED.</p>
...
`quality_control`|**Optional\[[QualityControl](/docs/toloka-kit/reference/toloka.client.quality_control.QualityControl)\]**|<p>The quality control rule.</p>
`metadata`|**Optional\[Dict\[str, List\[str\]\]\]**|<p>Additional information about project.</p>
`status`|**Optional\[[ProjectStatus](/docs/toloka-kit/reference/toloka.client.project.Project.ProjectStatus)\]**|<p>Project status.</p>
...
| Method | Description |
| :------| :-----------|
[add_requester_translation](/docs/toloka-kit/reference/toloka.client.project.Project.add_requester_translation)| Add new translations to other language.
[set_default_language](/docs/toloka-kit/reference/toloka.client.project.Project.set_default_language)| Sets the source language used in the fields public_name, public_description, and public_instructions.
