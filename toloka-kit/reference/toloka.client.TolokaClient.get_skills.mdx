...
date: "2023-02-07T15:42:17.613112"
author: ["Toloka Team"]
...
# get_skills
`toloka.client.TolokaClient.get_skills` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L2128)
...
* **Yield type:**
  ...
  Generator\[[Skill](/docs-new/toloka-kit/reference/toloka.client.skill.Skill), None, None\]
