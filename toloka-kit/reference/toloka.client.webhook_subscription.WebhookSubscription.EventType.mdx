...
date: "2023-02-07T15:41:36.173906"
author: ["Toloka Team"]
...
# EventType
`toloka.client.webhook_subscription.WebhookSubscription.EventType` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/webhook_subscription.py#L22)
