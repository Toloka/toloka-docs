...
date: "2023-02-07T15:41:35.687773"
author: ["Toloka Team"]
...
# create_task_suites
`toloka.async_client.client.AsyncTolokaClient.create_task_suites` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
* **Return type:**
  ...
  [TaskSuiteBatchCreateResult](/docs-new/toloka-kit/reference/toloka.client.batch_create_results.TaskSuiteBatchCreateResult)
