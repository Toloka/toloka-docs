---
title: "get_assignments_df | Toloka-Kit"
date: "2023-02-07T15:41:43.550887"
author: ["Toloka Team"]
...
# get_assignments_df
`toloka.async_client.client.AsyncTolokaClient.get_assignments_df` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
`status`|**Optional\[List\[[GetAssignmentsTsvParameters.Status](/docs-new/toloka-kit/reference/toloka.client.assignment.GetAssignmentsTsvParameters.Status)\]\]**|<p>Statuses of assignments to download.</p>
...
`field`|**Optional\[List\[[GetAssignmentsTsvParameters.Field](/docs-new/toloka-kit/reference/toloka.client.assignment.GetAssignmentsTsvParameters.Field)\]\]**|<p>Names of `Assignment` fields to be downloaded. Fields other then from `Assignment` class are always downloaded.</p>
