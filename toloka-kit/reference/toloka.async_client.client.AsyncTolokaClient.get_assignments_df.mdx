...
date: "2023-02-27T17:42:31.236095"
author: ["Toloka Team"]
...
# get_assignments_df
`toloka.async_client.client.AsyncTolokaClient.get_assignments_df` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L0)
