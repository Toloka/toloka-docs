...
| :----------| :----| :-----------|
`payload`|**Optional\[Union\[[BaseComponent](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), [Payload](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.actions.NotifyActionV1.Payload)\]\]**|<p>Parameters for the message.</p>
