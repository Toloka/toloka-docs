...
date: "2023-02-07T15:41:44.746595"
author: ["Toloka Team"]
...
# WebhookSubscription
`toloka.client.webhook_subscription.WebhookSubscription` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/webhook_subscription.py#L11)
...
`event_type`|**Optional\[[EventType](/docs-new/toloka-kit/reference/toloka.client.webhook_subscription.WebhookSubscription.EventType)\]**|<p>Event type.</p>
