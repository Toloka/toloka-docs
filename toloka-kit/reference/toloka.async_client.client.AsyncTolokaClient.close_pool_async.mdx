...
date: "2023-02-07T15:42:05.900367"
author: ["Toloka Team"]
...
# close_pool_async
`toloka.async_client.client.AsyncTolokaClient.close_pool_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/async_client/client.py#L0)
...
* **Return type:**
  ...
  Optional\[[PoolCloseOperation](/docs-new/toloka-kit/reference/toloka.client.operations.PoolCloseOperation)\]
