...
date: "2023-02-07T15:42:16.349149"
author: ["Toloka Team"]
...
To iterate over all matching task suites you may use the [get_task_suites](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_task_suites) method.
...
`sort`|**Union\[List\[str\], [TaskSuiteSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.TaskSuiteSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [TaskSuiteSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.TaskSuiteSearchResult)
