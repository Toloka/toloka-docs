...
date: "2023-02-27T17:42:40.771261"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`key`|**Optional\[Union\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), str\]\]**|<p>The key for a text property that you will translate to other languages.</p>