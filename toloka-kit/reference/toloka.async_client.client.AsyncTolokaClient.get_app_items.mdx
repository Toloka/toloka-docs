...
date: "2023-02-07T15:42:00.705779"
author: ["Toloka Team"]
...
# get_app_items
`toloka.async_client.client.AsyncTolokaClient.get_app_items` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
If you need to sort items use the [find_app_items](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_app_items) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[AppItem](/docs-new/toloka-kit/reference/toloka.client.app.AppItem), None\]
