...
date: "2023-02-27T17:42:59.123250"
author: ["Toloka Team"]
...
# get_attachments
`toloka.client.TolokaClient.get_attachments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L830)
...
* **Yield type:**
  ...
  Generator\[[Attachment](/docs/toloka-kit/reference/toloka.client.attachment.Attachment), None, None\]
