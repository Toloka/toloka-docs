...
date: "2023-02-07T15:41:48.534356"
author: ["Toloka Team"]
...
# find_app_batches
`toloka.async_client.client.AsyncTolokaClient.find_app_batches` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
To iterate over all matching batches you may use the [get_app_batches](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_app_batches) method.
...
`sort`|**Union\[List\[str\], [AppBatchSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.AppBatchSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [AppBatchSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.AppBatchSearchResult)
