---
title: "TaskCursor | Toloka-Kit"
date: "2023-02-07T15:42:07.691571"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`toloka_client`|**Union\[[TolokaClient](/docs-new/toloka-kit/reference/toloka.client.TolokaClient), [AsyncTolokaClient](/docs-new/toloka-kit/reference/toloka.async_client.client.AsyncTolokaClient)\]**|<p>TolokaClient object that is being used to search tasks.</p>
`request`|**[TaskSearchRequest](/docs-new/toloka-kit/reference/toloka.client.search_requests.TaskSearchRequest)**|<p>Base request to search tasks by.</p>
