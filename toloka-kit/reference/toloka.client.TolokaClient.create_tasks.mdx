...
date: "2023-02-07T15:41:47.806080"
author: ["Toloka Team"]
...
Note that pools must be configured before accepting new tasks. For example, [mixer configuration](/docs-new/toloka-kit/reference/toloka.client.pool.mixer_config.MixerConfig) must be set.
...
* **Return type:**
  ...
  [TaskBatchCreateResult](/docs-new/toloka-kit/reference/toloka.client.batch_create_results.TaskBatchCreateResult)
