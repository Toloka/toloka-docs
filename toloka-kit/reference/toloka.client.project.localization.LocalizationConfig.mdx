...
`additional_languages`|**Optional\[List\[[AdditionalLanguage](/docs/toloka-kit/reference/toloka.client.project.localization.AdditionalLanguage)\]\]**|<p>List of translations into other languages. One element - one translation.</p>
