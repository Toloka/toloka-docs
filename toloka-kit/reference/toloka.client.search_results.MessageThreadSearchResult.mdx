...
date: "2023-02-07T15:41:38.026067"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[MessageThread](/docs-new/toloka-kit/reference/toloka.client.message_thread.MessageThread)\]\]**|<p>A list with found message threads.</p>
