...
date: "2023-02-07T15:42:15.747457"
author: ["Toloka Team"]
...
To iterate over all matching projects you may use the [get_projects](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_projects) method.
...
`sort`|**Union\[List\[str\], [ProjectSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.ProjectSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [ProjectSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.ProjectSearchResult)
