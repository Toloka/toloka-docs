...
date: "2023-02-07T15:41:50.547335"
author: ["Toloka Team"]
...
`toloka.client.TolokaClient.get_aggregated_solutions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L587)
...
* **Yield type:**
  ...
  Generator\[[AggregatedSolution](/docs-new/toloka-kit/reference/toloka.client.aggregation.AggregatedSolution), None, None\]
