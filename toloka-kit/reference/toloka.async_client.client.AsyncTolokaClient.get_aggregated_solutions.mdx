---
title: "get_aggregated_solutions | Toloka-Kit"
date: "2023-02-07T15:41:37.494354"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.get_aggregated_solutions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)

Finds all aggregated responses that match certain criteria.

Pass to the `get_aggregated_solutions` the ID of the operation started by the [aggregate_solutions_by_pool](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.aggregate_solutions_by_pool) method.
...
If you need to sort aggregated responses use the [find_aggregated_solutions](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_aggregated_solutions) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[AggregatedSolution](/docs-new/toloka-kit/reference/toloka.client.aggregation.AggregatedSolution), None\]
