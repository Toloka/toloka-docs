...
Class that implements interaction with [Toloka API](/docs/api/).
...
| :----------| :----| :-----------|
`token`|**str**|<p>Your OAuth token for Toloka. You can learn more about how to get it [here](/docs/api/access#token)</p>
...
[add_message_thread_to_folders](/docs/toloka-kit/reference/toloka.client.TolokaClient.add_message_thread_to_folders)| Adds a message chain to one or more folders ("unread", "important" etc.)
...
[archive_project](/docs/toloka-kit/reference/toloka.client.TolokaClient.archive_project)| Sends project to archive
[archive_project_async](/docs/toloka-kit/reference/toloka.client.TolokaClient.archive_project_async)| Sends project to archive, asynchronous version
...
[clone_project](/docs/toloka-kit/reference/toloka.client.TolokaClient.clone_project)| Synchronously clones the project, all pools and trainings
...
[compose_message_thread](/docs/toloka-kit/reference/toloka.client.TolokaClient.compose_message_thread)| Sends a message to a Toloker.
...
[create_project](/docs/toloka-kit/reference/toloka.client.TolokaClient.create_project)| Creates a new project
...
[create_user_bonus](/docs/toloka-kit/reference/toloka.client.TolokaClient.create_user_bonus)| Issues payments directly to a Toloker.
[create_user_bonuses](/docs/toloka-kit/reference/toloka.client.TolokaClient.create_user_bonuses)| Creates rewards for Tolokers.
[create_user_bonuses_async](/docs/toloka-kit/reference/toloka.client.TolokaClient.create_user_bonuses_async)| Issues payments directly to Tolokers, asynchronously creates many `UserBonus` instances.
[delete_user_restriction](/docs/toloka-kit/reference/toloka.client.TolokaClient.delete_user_restriction)| Unlocks existing restriction
[delete_user_skill](/docs/toloka-kit/reference/toloka.client.TolokaClient.delete_user_skill)| Drop specific UserSkill
[delete_webhook_subscription](/docs/toloka-kit/reference/toloka.client.TolokaClient.delete_webhook_subscription)| Drop specific webhook-subscription
[download_attachment](/docs/toloka-kit/reference/toloka.client.TolokaClient.download_attachment)| Downloads specific attachment
...
[find_user_bonuses](/docs/toloka-kit/reference/toloka.client.TolokaClient.find_user_bonuses)| Finds Tolokers' rewards that match certain criteria.
...
[get_analytics](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_analytics)| Sends analytics queries, for example, to estimate the percentage of completed tasks in the pool
...
[get_operation](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_operation)| Reads information about operation
[get_operation_log](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_operation_log)| Reads information about validation errors and which task (or task suites) were created
[get_operations](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_operations)| Finds all operations that match certain rules and returns them in an iterable object
...
[get_project](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_project)| Reads one specific project
...
[get_requester](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_requester)| Reads information about the customer and the account balance
[get_skill](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_skill)| Reads one specific skill
...
[get_task_suite](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_task_suite)| Reads one task suite.
...
[get_user](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_user)| Gets Toloker metadata by `user_id`.
[get_user_bonus](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_user_bonus)| Gets information about a Toloker's reward.
[get_user_bonuses](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_user_bonuses)| Finds all Tolokers' rewards that match certain rules and returns them in an iterable object
...
[get_webhook_subscription](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_webhook_subscription)| Get one specific webhook-subscription
...
[patch_app_batch](/docs/toloka-kit/reference/toloka.client.TolokaClient.patch_app_batch)| Updates an App batch name.
...
[patch_task_suite_overlap_or_min](/docs/toloka-kit/reference/toloka.client.TolokaClient.patch_task_suite_overlap_or_min)| Stops issuing the task suites
[reject_assignment](/docs/toloka-kit/reference/toloka.client.TolokaClient.reject_assignment)| Rejects an assignment.
[remove_message_thread_from_folders](/docs/toloka-kit/reference/toloka.client.TolokaClient.remove_message_thread_from_folders)| Deletes a message chain from one or more folders ("unread", "important" etc.)
[reply_message_thread](/docs/toloka-kit/reference/toloka.client.TolokaClient.reply_message_thread)| Replies to a message in thread
...
[update_project](/docs/toloka-kit/reference/toloka.client.TolokaClient.update_project)| Makes changes to the project
[update_skill](/docs/toloka-kit/reference/toloka.client.TolokaClient.update_skill)| Makes changes to the skill
...
[upsert_webhook_subscriptions](/docs/toloka-kit/reference/toloka.client.TolokaClient.upsert_webhook_subscriptions)| Creates (upsert) many webhook-subscriptions.
[wait_operation](/docs/toloka-kit/reference/toloka.client.TolokaClient.wait_operation)| Waits for the operation to complete, and return it
