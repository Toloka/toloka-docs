...
| :----------| :----| :-----------|
`cases`|**Optional\[Union\[[BaseComponent](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), List\[Union\[[BaseComponent](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), [Case](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.helpers.SwitchHelperV1.Case)\]\]\]\]**|<p>An array of objects consisting of condition and result property pairs.</p>
