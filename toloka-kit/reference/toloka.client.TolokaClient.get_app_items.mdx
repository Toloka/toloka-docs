...
date: "2023-02-07T15:42:11.408968"
author: ["Toloka Team"]
...
# get_app_items
`toloka.client.TolokaClient.get_app_items` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L3765)
...
* **Yield type:**
  ...
  Generator\[[AppItem](/docs-new/toloka-kit/reference/toloka.client.app.AppItem), None, None\]
