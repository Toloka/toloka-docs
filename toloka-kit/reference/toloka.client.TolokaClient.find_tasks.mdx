...
date: "2023-02-07T15:41:44.668670"
author: ["Toloka Team"]
...
# find_tasks
`toloka.client.TolokaClient.find_tasks` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L2338)
...
To iterate over all matching tasks you may use the [get_tasks](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_tasks) method.
...
`sort`|**Union\[List\[str\], [TaskSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.TaskSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [TaskSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.TaskSearchResult)
