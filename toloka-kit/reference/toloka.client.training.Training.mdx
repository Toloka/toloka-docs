...
date: "2023-02-07T15:42:11.841584"
author: ["Toloka Team"]
...
[Pool](/docs-new/toloka-kit/reference/toloka.client.pool.Pool).[quality_control](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl).[training_requirement](/docs-new/toloka-kit/reference/toloka.client.quality_control.QualityControl.TrainingRequirement)
parameter.

For more information, see [Adding a training](/docs-new/guide/train).
...
`owner`|**Optional\[[Owner](/docs-new/toloka-kit/reference/toloka.client.owner.Owner)\]**|<p>The training owner.</p>
`id`|**Optional\[str\]**|<p>The ID of the training. Read-only field.</p>
`status`|**Optional\[[Status](/docs-new/toloka-kit/reference/toloka.client.training.Training.Status)\]**|<p>The training status. Read-only field.</p>
`last_close_reason`|**Optional\[[CloseReason](/docs-new/toloka-kit/reference/toloka.client.training.Training.CloseReason)\]**|<p>A reason why the training was closed last time. Read-only field.</p>
...
| Method | Description |
| :------| :-----------|
[is_archived](/docs-new/toloka-kit/reference/toloka.client.training.Training.is_archived)| None
[is_closed](/docs-new/toloka-kit/reference/toloka.client.training.Training.is_closed)| None
[is_locked](/docs-new/toloka-kit/reference/toloka.client.training.Training.is_locked)| None
[is_open](/docs-new/toloka-kit/reference/toloka.client.training.Training.is_open)| None
[set_owner](/docs-new/toloka-kit/reference/toloka.client.training.codegen_setter_for_owner)| A shortcut setter for owner
