...
date: "2023-02-27T17:42:20.199899"
author: ["Toloka Team"]
...
# get_assignments_df
`toloka.client.TolokaClient.get_assignments_df` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L3497)
