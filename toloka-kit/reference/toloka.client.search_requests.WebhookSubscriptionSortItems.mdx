...
date: "2023-02-07T15:41:42.123084"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[SortItem](/docs-new/toloka-kit/reference/toloka.client.search_requests.WebhookSubscriptionSortItems.SortItem)\]\]**|<p>A list of sorting keys. Supported values:</p> <ul> <li>`&#x27;id&#x27;` — A subscription ID.</li> <li>`&#x27;created&#x27;` — The creation date of a subscription.</li> </ul>
