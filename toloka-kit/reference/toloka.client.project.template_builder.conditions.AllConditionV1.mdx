...
date: "2023-02-07T15:41:41.682901"
author: ["Toloka Team"]
...
# AllConditionV1
`toloka.client.project.template_builder.conditions.AllConditionV1` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/project/template_builder/conditions.py#L45)
...
| :----------| :----| :-----------|
`conditions`|**Optional\[Union\[[BaseComponent](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), List\[[BaseComponent](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent)\]\]\]**|<p>A set of conditions that must be met.</p>
