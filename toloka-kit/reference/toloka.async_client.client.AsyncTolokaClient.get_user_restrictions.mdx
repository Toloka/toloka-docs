...
date: "2023-02-07T15:41:58.801821"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.get_user_restrictions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
If you need to sort Toloker restrictions use the [find_user_restrictions](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_user_restrictions) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[UserRestriction](/docs-new/toloka-kit/reference/toloka.client.user_restriction.UserRestriction), None\]
