...
| :----------| :----| :-----------|
`folder`|**Optional\[List\[[Folder](/docs-new/toloka-kit/reference/toloka.client.message_thread.Folder)\]\]**|<p>A folder where to search threads or a list of folders. Refer to the [Folder](/docs-new/toloka-kit/reference/toloka.client.message_thread.Folder) page for more information on the available `folder` values.</p>
`folder_ne`|**Optional\[List\[[Folder](/docs-new/toloka-kit/reference/toloka.client.message_thread.Folder)\]\]**|<p>A folder to skip or a list of folders. Supported values are the same as for `folder`.</p>
