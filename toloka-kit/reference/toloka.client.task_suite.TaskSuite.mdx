...
date: "2023-02-27T17:42:24.582802"
author: ["Toloka Team"]
...
# TaskSuite
`toloka.client.task_suite.TaskSuite` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/task_suite.py#L20)
...
`mixed`|**Optional\[bool\]**|<p>[The way of grouping tasks](/docs/guide/distribute-tasks-by-pages) to create the task suite.</p> <ul> <li>`True` — The tasks are mixed automatically using the smart mixing approach.</li> <li>`False` — The tasks are grouped manually.</li> </ul> <p></p><p>Default value: `False`.</p>
...
`automerged`|**Optional\[bool\]**|<ul> <li>`True` — The task suite was created after [merging tasks](/docs/api/tasks#task-merge).</li> <li>`False` — There are no merged tasks in the task suite.</li> </ul>
