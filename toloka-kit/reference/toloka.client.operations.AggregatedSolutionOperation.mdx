...
`parameters`|**Optional\[[Parameters](/docs-new/toloka-kit/reference/toloka.client.operations.AggregatedSolutionOperation.Parameters)\]**|<p>Operation parameters (depending on the operation type).</p>
