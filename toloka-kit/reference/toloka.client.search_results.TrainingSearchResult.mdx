...
date: "2023-02-07T15:41:33.580171"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[Training](/docs-new/toloka-kit/reference/toloka.client.training.Training)\]\]**|<p>A list with found training pools.</p>
