...
| :----------| :----| :-----------|
`conditions`|**Optional\[Union\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), List\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent)\]\]\]**|<p>A set of conditions, at least one of which must be met.</p>
