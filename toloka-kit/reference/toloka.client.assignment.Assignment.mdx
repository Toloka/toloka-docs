---
title: "Assignment | Toloka-Kit"
date: "2023-02-07T15:41:50.494525"
author: ["Toloka Team"]
...
# Assignment
`toloka.client.assignment.Assignment` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/assignment.py#L20)
...
`tasks`|**Optional\[List\[[Task](/docs-new/toloka-kit/reference/toloka.client.task.Task)\]\]**|<p>Data for the tasks.</p>
...
`owner`|**Optional\[[Owner](/docs-new/toloka-kit/reference/toloka.client.owner.Owner)\]**|<p>Properties of Requester.</p>
