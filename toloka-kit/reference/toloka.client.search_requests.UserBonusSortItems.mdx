...
date: "2023-02-07T15:41:55.034186"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[SortItem](/docs-new/toloka-kit/reference/toloka.client.search_requests.UserBonusSortItems.SortItem)\]\]**|<p>A list of sorting keys. Supported values:</p> <ul> <li>`&#x27;id&#x27;` — The ID of a reward.</li> <li>`&#x27;created&#x27;` — The date of granting a reward.</li> </ul>
