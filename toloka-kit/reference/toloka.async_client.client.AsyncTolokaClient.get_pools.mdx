...
date: "2023-02-07T15:42:06.851830"
author: ["Toloka Team"]
...
# get_pools
`toloka.async_client.client.AsyncTolokaClient.get_pools` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
If you need to sort pools use the [find_pools](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_pools) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Pool](/docs-new/toloka-kit/reference/toloka.client.pool.Pool), None\]
