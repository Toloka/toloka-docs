...
date: "2023-02-07T15:41:58.012006"
author: ["Toloka Team"]
...
# find_trainings
`toloka.async_client.client.AsyncTolokaClient.find_trainings` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
To iterate over all matching trainings you may use the [get_trainings](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_trainings) method.
...
`sort`|**Union\[List\[str\], [TrainingSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.TrainingSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [TrainingSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.TrainingSearchResult)
