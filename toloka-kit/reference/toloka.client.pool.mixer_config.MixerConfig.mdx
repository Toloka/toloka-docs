...
date: "2023-02-07T15:42:10.514598"
author: ["Toloka Team"]
...
`golden_task_distribution_function`|**Optional\[[TaskDistributionFunction](/docs-new/toloka-kit/reference/toloka.client.task_distribution_function.TaskDistributionFunction)\]**|<p>Customizing the number of control tasks in a task suite depending on completed tasks by a Toloker.</p>
`training_task_distribution_function`|**Optional\[[TaskDistributionFunction](/docs-new/toloka-kit/reference/toloka.client.task_distribution_function.TaskDistributionFunction)\]**|<p>Customizing the number of training tasks in a task suite depending on completed tasks by a Toloker.</p>
