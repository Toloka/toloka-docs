...
date: "2023-02-07T15:41:51.558912"
author: ["Toloka Team"]
...
# get_assignments
`toloka.client.TolokaClient.get_assignments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L700)
...
* **Yield type:**
  ...
  Generator\[[Assignment](/docs-new/toloka-kit/reference/toloka.client.assignment.Assignment), None, None\]
