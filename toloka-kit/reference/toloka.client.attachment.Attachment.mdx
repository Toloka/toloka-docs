...
`details`|**Optional\[[Details](/docs/toloka-kit/reference/toloka.client.attachment.Attachment.Details)\]**|<p>Information about the pool, the task, and the Toloker who uploaded the file.</p>
