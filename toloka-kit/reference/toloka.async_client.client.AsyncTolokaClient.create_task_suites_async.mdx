---
title: "create_task_suites_async | Toloka-Kit"
date: "2023-02-07T15:42:05.515342"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.create_task_suites_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
See also the [create_task_suites](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.create_task_suites) method.

## Parameters Description

| Parameters | Type | Description |
| :----------| :----| :-----------|
`task_suites`|**List\[[TaskSuite](/docs-new/toloka-kit/reference/toloka.client.task_suite.TaskSuite)\]**|<p>A list of task suites to be created.</p>
...
* **Return type:**
  ...
  [TaskSuiteCreateBatchOperation](/docs-new/toloka-kit/reference/toloka.client.operations.TaskSuiteCreateBatchOperation)
