...
date: "2023-02-27T17:43:02.010700"
author: ["Toloka Team"]
...
# IfHelperV1
`toloka.client.project.template_builder.helpers.IfHelperV1` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/project/template_builder/helpers.py#L75)
...
| :----------| :----| :-----------|
`condition`|**Optional\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent)\]**|<p>Condition to check.</p>
