...
date: "2023-02-07T15:42:16.148046"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[SortItem](/docs-new/toloka-kit/reference/toloka.client.search_requests.TaskSortItems.SortItem)\]\]**|<p>A list of sorting keys. Supported values:</p> <ul> <li>`&#x27;id&#x27;` — The ID of a task.</li> <li>`&#x27;created&#x27;` — The creation date of a task.</li> </ul>
