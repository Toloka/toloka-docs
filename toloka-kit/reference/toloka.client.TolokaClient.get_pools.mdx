...
date: "2023-02-07T15:42:15.459543"
author: ["Toloka Team"]
...
# get_pools
`toloka.client.TolokaClient.get_pools` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L1573)
...
* **Yield type:**
  ...
  Generator\[[Pool](/docs-new/toloka-kit/reference/toloka.client.pool.Pool), None, None\]
