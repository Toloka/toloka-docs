...
date: "2023-02-07T15:41:34.536091"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[UserSkill](/docs-new/toloka-kit/reference/toloka.client.user_skill.UserSkill)\]\]**|<p>A list with found skills.</p>
