...
To iterate over all matching Tolokers' rewards you may use the [get_user_bonuses](/docs/toloka-kit/reference/toloka.client.TolokaClient.get_user_bonuses) method.
