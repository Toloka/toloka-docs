...
date: "2023-02-27T17:43:01.673369"
author: ["Toloka Team"]
...
# get_tasks
`toloka.async_client.client.AsyncTolokaClient.get_tasks` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/__init__.py#L0)
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Task](/docs/toloka-kit/reference/toloka.client.task.Task), None\]
