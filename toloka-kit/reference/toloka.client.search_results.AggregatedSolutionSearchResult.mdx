...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[AggregatedSolution](/docs-new/toloka-kit/reference/toloka.client.aggregation.AggregatedSolution)\]\]**|<p>A list with found aggregated responses.</p>
