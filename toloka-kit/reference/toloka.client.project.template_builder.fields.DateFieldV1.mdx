...
date: "2023-02-07T15:41:32.804598"
author: ["Toloka Team"]
...
`block_list`|**Optional\[Union\[[BaseComponent](/docs-new/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent), List\[Any\]\]\]**|<p>List of dates that the Toloker cannot select.</p> <ul> <li>block_list[]: Date that the Toloker cannot select.</li> </ul>
