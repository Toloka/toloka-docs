...
| :----------| :----| :-----------|
`toloka_client`|**Union\[[TolokaClient](/docs/toloka-kit/reference/toloka.client.TolokaClient), [AsyncTolokaClient](/docs/toloka-kit/reference/toloka.async_client.client.AsyncTolokaClient)\]**|<p>TolokaClient object that is being used to search assignments.</p>
`request`|**[AssignmentSearchRequest](/docs/toloka-kit/reference/toloka.client.search_requests.AssignmentSearchRequest)**|<p>Base request to search assignments by.</p>
