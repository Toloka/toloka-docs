---
title: "AssignmentCursor — Toloka-Kit | Toloka documentation"
date: "2023-02-07T15:41:37.291223"
author: ["Toloka Team"]
...
# AssignmentCursor
`toloka.streaming.cursor.AssignmentCursor` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/streaming/cursor.py#L217)
...
| :----------| :----| :-----------|
`toloka_client`|**Union\[[TolokaClient](/docs-new/toloka-kit/reference/toloka.client.TolokaClient), [AsyncTolokaClient](/docs-new/toloka-kit/reference/toloka.async_client.client.AsyncTolokaClient)\]**|<p>TolokaClient object that is being used to search assignments.</p>
`request`|**[AssignmentSearchRequest](/docs-new/toloka-kit/reference/toloka.client.search_requests.AssignmentSearchRequest)**|<p>Base request to search assignments by.</p>
