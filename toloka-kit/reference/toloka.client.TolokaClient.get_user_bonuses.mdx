...
date: "2023-02-07T15:41:33.072973"
author: ["Toloka Team"]
...
`get_user_bonuses` returns a generator. You can iterate over all found Tolokers' rewards using the generator. Several requests to the Toloka server are possible while iterating.
 ...
 If you need to sort rewards use the [find_user_bonuses](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_user_bonuses) method.
