...
date: "2023-02-07T15:42:02.127269"
author: ["Toloka Team"]
...
`parameters`|**Optional\[[Parameters](/docs-new/toloka-kit/reference/toloka.client.operations.TaskSuiteCreateBatchOperation.Parameters)\]**|<p>Operation parameters (depending on the operation type).</p>
