...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[SortItem](/docs-new/toloka-kit/reference/toloka.client.search_requests.UserSkillSortItems.SortItem)\]\]**|<p>A list of sorting keys. Supported values:</p> <ul> <li>`&#x27;id&#x27;` — The ID of a skill.</li> <li>`&#x27;created&#x27;` — The date when a skill was created.</li> <li>`&#x27;modified&#x27;` — The date when a skill was modified.</li> </ul>
