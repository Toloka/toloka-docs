...
date: "2023-02-07T15:42:09.726465"
author: ["Toloka Team"]
...
`toloka.client.TolokaClient.close_training_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L1778)
...
* **Return type:**
  ...
  Optional\[[TrainingCloseOperation](/docs-new/toloka-kit/reference/toloka.client.operations.TrainingCloseOperation)\]
