...
| :----------| :----| :-----------|
`items`|**Optional\[List\[[UserRestriction](/docs-new/toloka-kit/reference/toloka.client.user_restriction.UserRestriction)\]\]**|<p>A list with found Toloker restrictions.</p>
