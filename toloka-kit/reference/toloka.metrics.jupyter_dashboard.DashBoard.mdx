---
title: "DashBoard | Toloka-Kit"
date: "2023-02-07T15:41:36.044872"
author: ["Toloka Team"]
...
# DashBoard
`toloka.metrics.jupyter_dashboard.DashBoard` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/metrics/jupyter_dashboard.py#L184)
...
| :----------| :----| :-----------|
`metrics`|**List\[Union\[[BaseMetric](/docs-new/toloka-kit/reference/toloka.metrics.metrics.BaseMetric), [Chart](/docs-new/toloka-kit/reference/toloka.metrics.jupyter_dashboard.Chart)\]\]**|<p>List of metrics or charts, that will be displayed on the dashboard. Each element will be displayed in a separate chart (coordinates). If you want to draw several metrics in one coordinates, wrap it into an instance of the class Chart.</p>
...
| Method | Description |
| :------| :-----------|
[run_dash](/docs-new/toloka-kit/reference/toloka.metrics.jupyter_dashboard.DashBoard.run_dash)| Starts dashboard. Starts server for online updating charts.
[stop_dash](/docs-new/toloka-kit/reference/toloka.metrics.jupyter_dashboard.DashBoard.stop_dash)| Stops server. And stops updating dashboard.
[update_charts](/docs-new/toloka-kit/reference/toloka.metrics.jupyter_dashboard.DashBoard.update_charts)| Redraws all charts on each iteration
