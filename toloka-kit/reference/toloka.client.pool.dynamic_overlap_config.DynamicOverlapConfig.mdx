...
Learn more about the [Dynamic overlap](/docs-new/guide/dynamic-overlap) in the guide.

## Parameters Description

| Parameters | Type | Description |
| :----------| :----| :-----------|
`type`|**Optional\[[Type](/docs-new/toloka-kit/reference/toloka.client.pool.dynamic_overlap_config.DynamicOverlapConfig.Type)\]**|<p>The dynamic overlap algorithm.</p>
...
`fields`|**Optional\[List\[[Field](/docs-new/toloka-kit/reference/toloka.client.pool.dynamic_overlap_config.DynamicOverlapConfig.Field)\]\]**|<p>A list of output data fields used for aggregating responses. For the best results, each field must have a limited number of response options. Don&#x27;t specify fields in the list together if they depend on each other.</p>
