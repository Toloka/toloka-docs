...
date: "2023-02-07T15:41:40.080532"
author: ["Toloka Team"]
...
`toloka.async_client.client.AsyncTolokaClient.archive_training_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/async_client/client.py#L0)
...
* **Return type:**
  ...
  Optional\[[TrainingArchiveOperation](/docs-new/toloka-kit/reference/toloka.client.operations.TrainingArchiveOperation)\]
