...
date: "2023-02-07T15:42:00.240946"
author: ["Toloka Team"]
...
If you need to sort message threads use the [find_message_threads](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_message_threads) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[MessageThread](/docs-new/toloka-kit/reference/toloka.client.message_thread.MessageThread), None\]
