...
date: "2023-02-07T15:42:04.594683"
author: ["Toloka Team"]
...
# find_apps
`toloka.client.TolokaClient.find_apps` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L3661)
...
To iterate over all matching solutions you may use the [get_apps](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_apps) method.
...
`sort`|**Union\[List\[str\], [AppSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.AppSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [AppSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.AppSearchResult)
