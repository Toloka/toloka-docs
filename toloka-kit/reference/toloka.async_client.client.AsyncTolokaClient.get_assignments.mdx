...
date: "2023-02-07T15:42:17.438773"
author: ["Toloka Team"]
...
# get_assignments
`toloka.async_client.client.AsyncTolokaClient.get_assignments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
If you need to sort assignments use the [find_assignments](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_assignments) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Assignment](/docs-new/toloka-kit/reference/toloka.client.assignment.Assignment), None\]
