...
date: "2023-02-07T15:41:36.287842"
author: ["Toloka Team"]
...
# find_attachments
`toloka.client.TolokaClient.find_attachments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L771)
...
To iterate over all matching attachments you may use the [get_attachments](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_attachments) method.
...
`sort`|**Union\[List\[str\], [AttachmentSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.AttachmentSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [AttachmentSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.AttachmentSearchResult)
