---
title: "Pipeline | Toloka-Kit"
date: "2023-02-07T15:41:41.035925"
author: ["Toloka Team"]
...
# Pipeline
`toloka.streaming.pipeline.Pipeline` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/streaming/pipeline.py#L80)
...
`storage`|**Optional\[[BaseStorage](/docs-new/toloka-kit/reference/toloka.streaming.storage.BaseStorage)\]**|<p>Optional storage object to save pipeline&#x27;s state. Allow to recover from previous state in case of failure.</p>
`iteration_mode`|**[IterationMode](/docs-new/toloka-kit/reference/toloka.streaming.pipeline.IterationMode)**|<p>When to start new iteration. Default is `FIRST_COMPLETED`</p>
...
| Method | Description |
| :------| :-----------|
[observers_iter](/docs-new/toloka-kit/reference/toloka.streaming.pipeline.Pipeline.observers_iter)| Iterate over registered observers.
[register](/docs-new/toloka-kit/reference/toloka.streaming.pipeline.Pipeline.register)| Register given observer.
[run](/docs-new/toloka-kit/reference/toloka.streaming.pipeline.Pipeline.run)| None
[run_manually](/docs-new/toloka-kit/reference/toloka.streaming.pipeline.Pipeline.run_manually)| None
