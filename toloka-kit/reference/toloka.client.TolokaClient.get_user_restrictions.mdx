...
date: "2023-02-07T15:41:55.777164"
author: ["Toloka Team"]
...
`toloka.client.TolokaClient.get_user_restrictions` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L3156)
...
* **Yield type:**
  ...
  Generator\[[UserRestriction](/docs-new/toloka-kit/reference/toloka.client.user_restriction.UserRestriction), None, None\]
