...
date: "2023-02-27T17:42:42.252891"
author: ["Toloka Team"]
...
# MessageThread
`toloka.client.message_thread.MessageThread` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.4/src/client/message_thread.py#L77)
...
`interlocutors`|**Optional\[List\[[Interlocutor](/docs/toloka-kit/reference/toloka.client.message_thread.Interlocutor)\]\]**|<p>Information about the sender and recipients, sorted by IDs.</p>
...
`messages`|**Optional\[List\[[Message](/docs/toloka-kit/reference/toloka.client.message_thread.MessageThread.Message)\]\]**|<p>Messages in the thread. Sorted by creation date (new first).</p>
`meta`|**Optional\[[Meta](/docs/toloka-kit/reference/toloka.client.message_thread.MessageThread.Meta)\]**|<p>Meta</p>
...
`folders`|**Optional\[List\[[Folder](/docs/toloka-kit/reference/toloka.client.message_thread.Folder)\]\]**|<p>Folders where the thread is located.</p>
`compose_details`|**Optional\[[ComposeDetails](/docs/toloka-kit/reference/toloka.client.message_thread.MessageThread.ComposeDetails)\]**|<p>For messages that you sent: details of the POST request for creating the message.</p>
