...
| :----------| :----| :-----------|
`condition`|**Optional\[[BaseComponent](/docs/toloka-kit/reference/toloka.client.project.template_builder.base.BaseComponent)\]**|<p>The condition for which the inverse is returned.</p>
