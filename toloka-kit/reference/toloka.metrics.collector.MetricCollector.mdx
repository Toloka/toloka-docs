...
| Method | Description |
| :------| :-----------|
[create_async_tasks](/docs-new/toloka-kit/reference/toloka.metrics.collector.MetricCollector.create_async_tasks)| None
[run](/docs-new/toloka-kit/reference/toloka.metrics.collector.MetricCollector.run)| Starts collecting metrics. And never stops.
