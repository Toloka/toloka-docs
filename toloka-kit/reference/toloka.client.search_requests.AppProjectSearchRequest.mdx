...
`scope`|**Optional\[[Scope](/docs/toloka-kit/reference/toloka.client.search_requests.AppProjectSearchRequest.Scope)\]**|<p>Values:</p> <ul> <li>`&#x27;MY&#x27;` — Projects created by you.</li> <li>`&#x27;COMPANY&#x27;` — Projects created by requesters from your company.</li> <li>`&#x27;REQUESTER_LIST&#x27;` — Projects created by requesters in the `requester_ids` list.</li> </ul>
