...
date: "2023-02-07T15:42:12.308298"
author: ["Toloka Team"]
...
# clone_pool_async
`toloka.async_client.client.AsyncTolokaClient.clone_pool_async` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/async_client/client.py#L0)
...
* **Return type:**
  ...
  [PoolCloneOperation](/docs-new/toloka-kit/reference/toloka.client.operations.PoolCloneOperation)
