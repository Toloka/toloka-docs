...
date: "2023-02-07T15:41:57.466825"
author: ["Toloka Team"]
...
# get_task_suites
`toloka.async_client.client.AsyncTolokaClient.get_task_suites` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
If you need to sort task suites use the [find_task_suites](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_task_suites) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[TaskSuite](/docs-new/toloka-kit/reference/toloka.client.task_suite.TaskSuite), None\]
