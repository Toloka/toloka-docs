...
date: "2023-02-07T15:42:09.407237"
author: ["Toloka Team"]
...
# get_skills
`toloka.async_client.client.AsyncTolokaClient.get_skills` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
If you need to sort skills use the [find_skills](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_skills) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Skill](/docs-new/toloka-kit/reference/toloka.client.skill.Skill), None\]
