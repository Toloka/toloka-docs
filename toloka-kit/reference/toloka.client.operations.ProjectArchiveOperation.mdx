...
date: "2023-02-07T15:42:08.964919"
author: ["Toloka Team"]
...
`toloka.client.operations.ProjectArchiveOperation` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/operations.py#L250)
...
`parameters`|**Optional\[[Parameters](/docs-new/toloka-kit/reference/toloka.client.operations.ProjectArchiveOperation.Parameters)\]**|<p>Operation parameters (depending on the operation type).</p>
