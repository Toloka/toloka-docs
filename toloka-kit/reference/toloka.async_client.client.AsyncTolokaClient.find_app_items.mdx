...
To iterate over all matching items you may use the [get_app_items](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_app_items) method.
...
`status`|**Optional\[[AppItem.Status](/docs-new/toloka-kit/reference/toloka.client.app.AppItem.Status)\]**|<p>App task item status. Refer to the [AppItem.Status](/docs-new/toloka-kit/reference/toloka.client.app.AppItem.Status) page for more information on the available `status` values.</p>
...
`sort`|**Union\[List\[str\], [AppItemSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.AppItemSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [AppItemSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.AppItemSearchResult)
