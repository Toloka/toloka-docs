...
date: "2023-02-07T15:41:38.481305"
author: ["Toloka Team"]
...
# get_attachments
`toloka.async_client.client.AsyncTolokaClient.get_attachments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[Attachment](/docs-new/toloka-kit/reference/toloka.client.attachment.Attachment), None\]
