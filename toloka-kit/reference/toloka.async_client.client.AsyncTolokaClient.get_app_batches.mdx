...
If you need to sort batches use the [find_app_batches](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.find_app_batches) method.
...
* **Yield type:**
  ...
  [AsyncGenAdapter](/docs-new/toloka-kit/reference/toloka.util.async_utils.AsyncGenAdapter)\[[AppBatch](/docs-new/toloka-kit/reference/toloka.client.app.AppBatch), None\]
