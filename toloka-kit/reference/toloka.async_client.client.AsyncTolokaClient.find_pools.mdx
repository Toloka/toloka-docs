...
date: "2023-02-07T15:41:40.463276"
author: ["Toloka Team"]
...
# find_pools
`toloka.async_client.client.AsyncTolokaClient.find_pools` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.3/src/client/__init__.py#L0)
...
To iterate over all matching pools you may use the [get_pools](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.get_pools) method.

## Parameters Description

| Parameters | Type | Description |
| :----------| :----| :-----------|
`status`|**Optional\[[Pool.Status](/docs-new/toloka-kit/reference/toloka.client.pool.Pool.Status)\]**|<p>Pool status. Refer to the [Pool.Status](/docs-new/toloka-kit/reference/toloka.client.pool.Pool.Status) page for more information on the available `status` values.</p>
...
`sort`|**Union\[List\[str\], [PoolSortItems](/docs-new/toloka-kit/reference/toloka.client.search_requests.PoolSortItems), None\]**|<p>Sorting options. Default: `None`.</p>
...
* **Return type:**
  ...
  [PoolSearchResult](/docs-new/toloka-kit/reference/toloka.client.search_results.PoolSearchResult)
