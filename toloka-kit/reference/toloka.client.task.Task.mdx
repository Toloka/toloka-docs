...
date: "2023-02-07T15:41:53.825158"
author: ["Toloka Team"]
...
Tasks are grouped into [TaskSuites](/docs-new/toloka-kit/reference/toloka.client.task_suite.TaskSuite).
...
`baseline_solutions`|**Optional\[List\[[BaselineSolution](/docs-new/toloka-kit/reference/toloka.client.task.Task.BaselineSolution)\]\]**|<p>Preliminary responses for dynamic overlap and aggregation of results by skill. They are used to calculate a confidence level of the first responses from Toloker.</p>
...
See more complex example in the description of the [create_tasks](/docs-new/toloka-kit/reference/toloka.client.TolokaClient.create_tasks) method.
