...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.embeddings.rasa.RASA.fit)| Fit the model.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.embeddings.rasa.RASA.fit_predict)| Fit the model and return aggregated outputs.
[fit_predict_scores](/docs-new/crowd-kit/reference/crowdkit.aggregation.embeddings.rasa.RASA.fit_predict_scores)| Fit the model and return scores.
