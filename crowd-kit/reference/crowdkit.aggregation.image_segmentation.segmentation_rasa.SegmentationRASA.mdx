---
title: "SegmentationRASA — Crowd-Kit | Toloka documentation"
date: "2023-02-06T17:36:12.100134"
author: ["Toloka Team"]
...
to the current answer estimation. The distance is considered as <Formula withoutContainer={true} content="$1 - IOU$"/>. Modification of the RASA method
for texts.
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_rasa.SegmentationRASA.fit)| Fit the model.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_rasa.SegmentationRASA.fit_predict)| Fit the model and return the aggregated segmentations.
