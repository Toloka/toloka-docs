...
date: "2023-02-06T17:36:13.669245"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`aggregator`|**[BaseClassificationAggregator](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseClassificationAggregator)**|<p>aggregator instance to be cloned</p>
