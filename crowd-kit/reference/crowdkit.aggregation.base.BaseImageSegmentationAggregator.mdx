...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseImageSegmentationAggregator.fit)| None
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseImageSegmentationAggregator.fit_predict)| None
