...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.fit)| Estimate the workers' skills.
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.fit_predict)| Fit the model and return aggregated results.
[fit_predict_proba](/docs/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.fit_predict_proba)| Fit the model and return probability distributions on labels for each task.
[predict](/docs/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.predict)| Infer the true labels when the model is fitted.
[predict_proba](/docs/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.predict_proba)| Return probability distributions on labels for each task when the model is fitted.
