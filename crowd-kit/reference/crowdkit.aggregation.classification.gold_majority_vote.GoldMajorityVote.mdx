...
date: "2023-02-06T17:36:14.316752"
author: ["Toloka Team"]
...
# GoldMajorityVote
`crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.2.0/crowdkit/aggregation/classification/gold_majority_vote.py#L12)
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.fit)| Estimate the workers' skills.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.fit_predict)| Fit the model and return aggregated results.
[fit_predict_proba](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.fit_predict_proba)| Fit the model and return probability distributions on labels for each task.
[predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.predict)| Infer the true labels when the model is fitted.
[predict_proba](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.gold_majority_vote.GoldMajorityVote.predict_proba)| Return probability distributions on labels for each task when the model is fitted.
