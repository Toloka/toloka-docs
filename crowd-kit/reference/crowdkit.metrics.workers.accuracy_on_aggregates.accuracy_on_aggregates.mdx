...
date: "2023-02-06T17:36:09.471886"
author: ["Toloka Team"]
...
`aggregator`|**Optional\[[BaseClassificationAggregator](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseClassificationAggregator)\]**|<p>aggregation algorithm. default: MajorityVote</p>
