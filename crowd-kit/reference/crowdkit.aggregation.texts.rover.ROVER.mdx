---
title: "ROVER | Crowd-Kit"
date: "2023-02-06T17:36:12.646331"
author: ["Toloka Team"]
...
# ROVER
`crowdkit.aggregation.texts.rover.ROVER` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.2.0/crowdkit/aggregation/texts/rover.py#L31)
...
<Image withBackground imageId="47d3fcf1163a876cb225f4411be51181" alt="ROVER WTN scheme" />
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.texts.rover.ROVER.fit)| Fits the model. The aggregated results are saved to the `texts_` attribute.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.texts.rover.ROVER.fit_predict)| Fit the model and return the aggregated texts.
