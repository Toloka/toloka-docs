---
title: "NoisyBradleyTerry — Crowd-Kit | Toloka documentation"
date: "2023-02-06T17:36:11.393052"
author: ["Toloka Team"]
...
This model is a modification of the [Bradley-Terry model](/docs-new/crowd-kit/reference/crowdkit.aggregation.pairwise.bradley_terry.BradleyTerry)
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.pairwise.noisy_bt.NoisyBradleyTerry.fit)| None
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.pairwise.noisy_bt.NoisyBradleyTerry.fit_predict)| None
