---
title: "OneCoinDawidSkene | Crowd-Kit"
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.dawid_skene.OneCoinDawidSkene.fit)| Fit the model through the EM-algorithm.
