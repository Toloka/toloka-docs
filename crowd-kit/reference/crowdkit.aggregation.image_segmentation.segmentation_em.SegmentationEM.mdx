---
title: "SegmentationEM — Crowd-Kit | Toloka documentation"
date: "2023-02-06T17:36:11.311352"
author: ["Toloka Team"]
...
# SegmentationEM
`crowdkit.aggregation.image_segmentation.segmentation_em.SegmentationEM` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.2.0/crowdkit/aggregation/image_segmentation/segmentation_em.py#L13)
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_em.SegmentationEM.fit)| Fit the model.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_em.SegmentationEM.fit_predict)| Fit the model and return the aggregated segmentations.
