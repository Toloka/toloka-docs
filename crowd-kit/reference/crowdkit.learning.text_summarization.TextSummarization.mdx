...
date: "2023-02-06T17:36:12.974735"
author: ["Toloka Team"]
...
`permutation_aggregator`|**Optional\[[BaseTextsAggregator](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseTextsAggregator)\]**|<p>Text aggregation method to use for aggregating outputs of multiple input permutations if `use_permutations` flag is set. </p><p>Default value: `None`.</p>
...
| Method | Description |
| :------| :-----------|
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.learning.text_summarization.TextSummarization.fit_predict)| Run the aggregation and return the aggregated texts.
