...
| Method | Description |
| :------| :-----------|
[fit](/docs/crowd-kit/reference/crowdkit.aggregation.classification.mace.MACE.fit)| Fits the MACE model.
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.classification.mace.MACE.fit_predict)| Fits the MACE model and returns the labels.
[fit_predict_proba](/docs/crowd-kit/reference/crowdkit.aggregation.classification.mace.MACE.fit_predict_proba)| Fits the MACE model and returns the label probability distributions.
