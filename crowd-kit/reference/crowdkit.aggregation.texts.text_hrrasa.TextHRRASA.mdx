---
title: "TextHRRASA — Crowd-Kit | Toloka documentation"
date: "2023-02-06T17:36:14.047947"
author: ["Toloka Team"]
...
# TextHRRASA
`crowdkit.aggregation.texts.text_hrrasa.TextHRRASA` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.2.0/crowdkit/aggregation/texts/text_hrrasa.py#L11)
...
| Method | Description |
| :------| :-----------|
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.texts.text_hrrasa.TextHRRASA.fit_predict)| Fit the model and return aggregated texts.
[fit_predict_scores](/docs-new/crowd-kit/reference/crowdkit.aggregation.texts.text_hrrasa.TextHRRASA.fit_predict_scores)| Fit the model and return scores.
