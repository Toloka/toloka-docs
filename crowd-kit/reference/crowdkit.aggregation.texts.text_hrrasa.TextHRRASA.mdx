...
| Method | Description |
| :------| :-----------|
[fit_predict](/docs/crowd-kit/reference/crowdkit.aggregation.texts.text_hrrasa.TextHRRASA.fit_predict)| Fit the model and return aggregated texts.
[fit_predict_scores](/docs/crowd-kit/reference/crowdkit.aggregation.texts.text_hrrasa.TextHRRASA.fit_predict_scores)| Fit the model and return scores.
