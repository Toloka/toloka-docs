...
date: "2023-02-06T17:36:10.945940"
author: ["Toloka Team"]
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_majority_vote.SegmentationMajorityVote.fit)| Fit the model.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.image_segmentation.segmentation_majority_vote.SegmentationMajorityVote.fit_predict)| Fit the model and return the aggregated segmentations.
