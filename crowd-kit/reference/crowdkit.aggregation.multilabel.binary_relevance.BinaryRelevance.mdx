---
title: "BinaryRelevance | Crowd-Kit"
date: "2023-02-06T17:36:11.758006"
author: ["Toloka Team"]
...
| :----------| :----| :-----------|
`base_aggregator`|**[BaseClassificationAggregator](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseClassificationAggregator)**|<p>Aggregator instance that will be used for each binary classification. All class parameters will be copied, except for the results of previous fit.</p>
...
`aggregators_`|**Dict\[str, [BaseClassificationAggregator](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BaseClassificationAggregator)\]**|<p>Labels&#x27; aggregators matched to classes. A dictionary that matches aggregators to classes. The key is the class found in the source data, and the value is the aggregator used for this class. The set of keys is all the classes that are in the input data.</p>
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.multilabel.binary_relevance.BinaryRelevance.fit)| Fit the aggregators.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.multilabel.binary_relevance.BinaryRelevance.fit_predict)| Fit the model and return aggregated results.
