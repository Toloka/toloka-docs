---
title: "BradleyTerry | Crowd-Kit"
date: "2023-02-06T17:36:14.127628"
author: ["Toloka Team"]
...
# BradleyTerry
`crowdkit.aggregation.pairwise.bradley_terry.BradleyTerry` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.2.0/crowdkit/aggregation/pairwise/bradley_terry.py#L15)
...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.pairwise.bradley_terry.BradleyTerry.fit)| None
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.pairwise.bradley_terry.BradleyTerry.fit_predict)| None
