...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BasePairwiseAggregator.fit)| None
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.base.BasePairwiseAggregator.fit_predict)| None
