...
| Method | Description |
| :------| :-----------|
[fit](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.glad.GLAD.fit)| Fit the model through the EM-algorithm.
[fit_predict](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.glad.GLAD.fit_predict)| Fit the model and return aggregated results.
[fit_predict_proba](/docs-new/crowd-kit/reference/crowdkit.aggregation.classification.glad.GLAD.fit_predict_proba)| Fit the model and return probability distributions on labels for each task.
