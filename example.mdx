...
<Image
  withBackground
  imageId="IKgtk9aJvIvHdVU0VwX5"
  caption="Three Muskateers"
/>
...
<Tabs
  tabs={[
    {
      title: "Tab 1",
      value: `A task suite is a group of several tasks given to a Toloker to submit all at once. For example, you can show four images on the same page.
