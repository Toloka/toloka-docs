...
A category of [components](#component) that arrange the interface elements, such as in columns or side-by-side. [List of layout options](/docs/template-builder/reference/layouts)
