...
Side-by-side comparison type of projects. Toloka has several presets to compare objects side-by-side: [images](./guide/tutorials/side-by-side), video and audio files.
