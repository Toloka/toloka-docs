...
To find Tolokers by skill, use [filters](/docs-new/glossary#filters):
...
Filters for selecting Tolokers work the same way as in the pool. To learn more, see the [Filters](/docs-new/guide/filters) section.
