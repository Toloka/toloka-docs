...
<Image withBackground imageId="1675426611582" alt="" />
...
To find Tolokers by skill, use [filters](https://toloka.ai/en/docs/glossary#filters):
...
Filters for selecting Tolokers work the same way as in the pool. To learn more, see the [Filters](https://toloka.ai/en/docs/guide/concepts/filters) section.
