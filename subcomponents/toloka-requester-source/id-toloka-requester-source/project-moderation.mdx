...
Before launching the project, see the [What tasks can't be placed in Toloka?](/docs-new/guide/unwanted) page.
...
Use the recommendations to fix the task content and let us know when it's ready to check. If everything is OK, your project will be approved, and Tolokers will be able to start your tasks. If not, we'll tell you what else you need to do. Also you can [clone](/docs-new/guide/project#clone) the rejected project, make changes and launch it again.