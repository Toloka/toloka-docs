...
- **Exam**: A pool that contains only [control tasks](https://toloka.ai/en/docs/glossary#control-task).

- **Training**: A main pool that consists only of [training tasks](https://toloka.ai/en/docs/glossary#training-task) and can have zero cost. Use it to train Tolokers before performing real tasks if the [training pool](https://toloka.ai/en/docs/guide/concepts/train) doesn't work well for your project.
