...
We recommend adding at least 1% of [control tasks](https://toloka.ai/en/docs/glossary#control-task) in the pool. And for small pools — 5–10%.
...
To filter out Tolokers, use the [Control tasks](https://toloka.ai/en/docs/guide/concepts/control) quality control rule. To rank Tolokers by the quality of responses in control tasks, use a [skill](https://toloka.ai/en/docs/guide/concepts/nav).
