...
An exam pool contains only control tasks. It's usually small and used for checking how well Tolokers learned to do your tasks after they read the instructions and completed the [training](/docs-new/guide/additionals-q#selection). Unlike your main pool, you already know the correct responses for every task in this pool. You can set the price to zero.
