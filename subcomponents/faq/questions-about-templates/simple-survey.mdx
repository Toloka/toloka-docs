...
1. If you need an [extensive](https://toloka.ai/en/docs/guide/concepts/t-components/text) response, add the required number of text entry components.

1. If you need a [short](https://toloka.ai/en/docs/guide/concepts/t-components/string) response, add the required number of string entry components.
...
1. Come up with a name for the input field and set the string type for it (see the step-by-step [guide on creating a survey](https://toloka.ai/en/docs/guide/tutorials/questionnaire-toloka)).
