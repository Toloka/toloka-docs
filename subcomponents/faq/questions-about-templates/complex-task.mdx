...
[Use](https://toloka.ai/en/docs/guide/tutorials/selection) the **Object selection in an image** preset. You can open this preset in the editor and add a drop-down list for labeling the selected object. See how to do this in the editor [description](https://toloka.ai/en/docs/guide/concepts/t-components/image-annotation#annotation) (**Dropdown list** tab).
