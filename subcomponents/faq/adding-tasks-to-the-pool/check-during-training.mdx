...
Besides the training, be sure to add quality control rules and [control tasks](/docs-new/guide/control) to your main pools. This way you can ensure the quality throughout the task performance process.
