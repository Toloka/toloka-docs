...
For more information about creating the file, see the [Guide](/docs-new/guide/pool_csv). If there are errors during the upload, look up the error description on this [page](/docs-new/guide/task_upload).
