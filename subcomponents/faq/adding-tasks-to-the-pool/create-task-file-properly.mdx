...
For more information about creating the file, see the [Guide](https://toloka.ai/en/docs/guide/concepts/pool_csv). If there are errors during the upload, look up the error description on this [page](https://toloka.ai/en/docs/guide/concepts/task_upload).
