...
[Learn more about the task price](https://toloka.ai/en/docs/guide/concepts/dynamic-pricing).

If you need help setting up pricing for your project, [contact](https://toloka.ai/en/docs/guide/troubleshooting/support) us.
